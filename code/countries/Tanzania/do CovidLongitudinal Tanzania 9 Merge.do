...
log using "log CovidLongitudinal Tanzania 9 Merge.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Tanzania 9 Merge.do"
...
** input data files: "`model' Tanzania error.dta"

** output data files: "ALL MODELS Tanzania error.dta" with all date
*                     "ALL MODELS Tanzania error - only models across error measures.dta", replace
*                     "ALL MODELS Tanzania error - only error measures across models.dta", replace

* output data dictionary files: "ALL MODELS Tanzania error data dictionary.csv"
*                               "ALL MODELS Tanzania error - only models across error measures data dictionary.csv"
*                               "ALL MODELS Tanzania error - only error measures across models data dictionary.csv"


** Graphs:
* "graph 03 Tanzania ALL MODELS C19 daily deaths error.pdf"
* "graph 04 Tanzania ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 05 Tanzania ALL MODELS C19 daily deaths percent error.pdf"
* "graph 06 Tanzania ALL MODELS C19 daily deaths absolute percent error.pdf"

* "graph 07a1 Tanzania ALL MODELS C19 daily deaths average median error.pdf"
* "graph 07a2 Tanzania ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 08a1 Tanzania ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 08a2 Tanzania ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 09a1 Tanzania ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 09a2 Tanzania ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10a1 Tanzania ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10a2 Tanzania ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"

****** graph each same error measure across models:
* "graph 12a Tanzania ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 12b Tanzania ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 12c Tanzania ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 12d Tanzania ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"

****** graph all models across error measures:
* "graph 13a Tanzania ALL MODELS C19 daily deaths, models across error measures.pdf"

****** graph all error measures across models:
* "graph 13b Tanzania ALL MODELS C19 daily deaths, error measures across models.pdf"
...
legend(position(6) order(4 "DELP" 1 "IMPE" 16 "LANL") ///
...
save "ALL MODELS Tanzania error.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Tanzania error data dictionary.csv", replace 
...
use "ALL MODELS Tanzania error.dta", clear

save "ALL MODELS Tanzania error - only models across error measures.dta", replace
...
save "CovidLongitudinal Tanzania merge temp.dta", replace 
...
qui graph export "graph 13a Tanzania ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Tanzania error - only models across error measures data dictionary.csv", replace 
...
use "CovidLongitudinal Tanzania merge temp.dta", clear 
...
save "ALL MODELS Tanzania error - only error measures across models.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Tanzania error - only error measures across models data dictionary.csv", replace 
...
view "log CovidLongitudinal Tanzania 9 Merge.smcl"
