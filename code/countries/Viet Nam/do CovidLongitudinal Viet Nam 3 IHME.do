...
log using "log CovidLongitudinal Viet Nam 3 IHME.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Viet Nam 3 IHME.do"
...
* input data files: "IHME Viet Nam.dta"
* output data files: "IHME Viet Nam error.dta" (with error measures saved)

* output data dictionary files: "IHME Viet Nam error data dictionary.csv"
...
** graphs:
* "graph 03 Viet Nam IHME C19 daily deaths error.pdf"
* "graph 04 Viet Nam IHME C19 daily deaths absolute error.pdf"
* "graph 05 Viet Nam IHME C19 daily deaths percent error.pdf"
* "graph 06 Viet Nam IHME C19 daily deaths absolute percent error.pdf"

* "graph 07 Viet Nam IHME C19 daily deaths average median error.pdf"
* "graph 08 Viet Nam IHME C19 daily deaths average median absolute error.pdf"
* "graph 09 Viet Nam IHME C19 daily deaths average median percent error.pdf"
* "graph 10 Viet Nam IHME C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Viet Nam IHME C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
qui replace DDErrorIHME`update' = . if date < td(19nov2020) // 19nov2020 is the earliest date of IHME forecasts for Viet Nam
                                                            // <<-- modify 3
...
qui replace DDAbsErrIHME`update' = . if date < td(19nov2020) // 19nov2020 is the earliest date of IHME forecasts for Viet Nam
...
qui replace DDPerErrIHME`update' = . if date < td(19nov2020) // 19nov2020 is the earliest date of IHME forecasts for Viet Nam
...
qui replace DDAbPeErIHME`update' = . if date < td(19nov2020) // 19nov2020 is the earliest date of IHME forecasts for Viet Nam
...
qui replace DDErrorIHME`update'_Med1 = . if date < td(19nov2020) // 19nov2020 is the earliest date of IHME forecasts for Viet Nam
...
qui replace DDAbsErrIHME`update'_Med1 = . if date < td(19nov2020) // 19nov2020 is the earliest date of IHME forecasts for Viet Nam
...
qui replace DDPerErrIHME`update'_Med1 = . if date < td(19nov2020) // 19nov2020 is the earliest date of IHME forecasts for Viet Nam
...
qui replace DDAbPeErIHME`update'_Med1 = . if date < td(19nov2020) // 19nov2020 is the earliest date of IHME forecasts for Viet Nam
...
egen DDErrorIHME_Mean1 = rowmean(DDErrorIHME20221216_Med1-DDErrorIHME20201119_Med1) // <<-- modify 5
...
qui replace DDErrorIHME_Mean1 = . if date < td(19nov2020) // 19nov2020 is the earliest date of IHME forecasts for Viet Nam
...
egen DDAbsErrIHME_Mean1 = rowmean(DDAbsErrIHME20221216_Med1-DDAbsErrIHME20201119_Med1) // <<-- modify 7
...
qui replace DDAbsErrIHME_Mean1 = . if date < td(19nov2020) // 19nov2020 is the earliest date of IHME forecasts for Viet Nam
...
egen DDPerErrIHME_Mean1 = rowmean(DDPerErrIHME20221216_Med1-DDPerErrIHME20201119_Med1) // <<-- modify 9
...
qui replace DDPerErrIHME_Mean1 = . if date < td(19nov2020) // 19nov2020 is the earliest date of IHME forecasts for Viet Nam
...
egen DDAbPeErIHME_Mean1 = rowmean(DDAbPeErIHME20221216_Med1-DDAbPeErIHME20201119_Med1) // <<-- modify 11
...
qui replace DDAbPeErIHME_Mean1 = . if date < td(19nov2020) // 19nov2020 is the earliest date of IHME forecasts for Viet Nam
...
subtitle("Viet Nam, IHME, all updates, forecast only", size(small)) 

qui graph export "graph 03 Viet Nam IHME C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Viet Nam IHME C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Viet Nam IHME C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Viet Nam IHME C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Viet Nam, IHME, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Viet Nam IHME C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Viet Nam IHME C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Viet Nam IHME C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Viet Nam IHME C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Viet Nam, IHME, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Viet Nam IHME C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IHME Viet Nam error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IHME Viet Nam error data dictionary.csv", replace 
...
view "log CovidLongitudinal Viet Nam 3 IHME.smcl"
