...
log using "log CovidLongitudinal Azerbaijan 5 LANL.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Azerbaijan 5 LANL.do"
...
* input data files: "LANL Azerbaijan.dta"
* output data files: "LANL Azerbaijan error.dta" (with error measures saved)

* output data dictionary files: "LANL Azerbaijan error data dictionary.csv"
...
** graphs:
* "graph 03 Azerbaijan LANL C19 daily deaths error.pdf"
* "graph 04 Azerbaijan LANL C19 daily deaths absolute error.pdf"
* "graph 05 Azerbaijan LANL C19 daily deaths percent error.pdf"
* "graph 06 Azerbaijan LANL C19 daily deaths absolute percent error.pdf"

* "graph 07 Azerbaijan LANL C19 daily deaths average median error.pdf"
* "graph 08 Azerbaijan LANL C19 daily deaths average median absolute error.pdf"
* "graph 09 Azerbaijan LANL C19 daily deaths average median percent error.pdf"
* "graph 10 Azerbaijan LANL C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Azerbaijan LANL C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Azerbaijan
                                                            // <<-- modify 3
...
qui replace DDAbsErrLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Azerbaijan
...
qui replace DDPerErrLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Azerbaijan
...
qui replace DDAbPeErLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Azerbaijan
...
qui replace DDErrorLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Azerbaijan
...
qui replace DDAbsErrLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Azerbaijan
...
qui replace DDPerErrLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Azerbaijan
...
qui replace DDAbPeErLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Azerbaijan
...
qui replace DDErrorLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Azerbaijan
...
qui replace DDAbsErrLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Azerbaijan
...
qui replace DDPerErrLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Azerbaijan
...
qui replace DDAbPeErLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Azerbaijan
...
subtitle("Azerbaijan, LANL, all updates, forecast only", size(small)) 

qui graph export "graph 03 Azerbaijan LANL C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Azerbaijan LANL C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Azerbaijan LANL C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Azerbaijan LANL C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Azerbaijan, LANL, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Azerbaijan LANL C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Azerbaijan LANL C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Azerbaijan LANL C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Azerbaijan LANL C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Azerbaijan, LANL, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Azerbaijan LANL C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "LANL Azerbaijan error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "LANL Azerbaijan error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Azerbaijan 5 LANL.smcl"
