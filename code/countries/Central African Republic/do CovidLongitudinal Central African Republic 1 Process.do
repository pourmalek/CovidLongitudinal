...
log using "log CovidLongitudinal Central African Republic 1 Process.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Central African Republic 1 Process.do"
...
**** "do CovidLongitudinal Central African Republic 1 Process.do"
...
** output data files: "`model' Central African Republic.dta"
**                   "ALL MODLES Central African Republic.dta"

** output data dictionary files: "Central African Republic ALL MODELS update dates data dictionary.csv"
**                               "`model' Central African Republic data dictionary.csv"
**                               "ALL MODLES Central African Republic data dictionary.csv"

** graphs:
** "graph 02 Central African Republic `model' C19 daily deaths all updates.pdf"
** "graph 02 Central African Republic ALL MODELS C19 daily deaths all updates.pdf"
...
foreach model of local list {
	...
	di in red "`model'" " Central African Republic absent update_date_block"
	
	qui keep if loc_grand_name == "Central African Republic"
	...
	save "Central African Republic `model' update dates.dta", replace
...
use "Central African Republic DELP update dates.dta", clear 

local list DELP IHME IMPE LANL

foreach model of local list {
	
	append using "Central African Republic `model' update dates.dta"
...
save "Central African Republic ALL MODELS update dates.dta", replace
	
export excel using "Central African Republic ALL MODELS update dates.xlsx", replace firstrow(variables) 
...
preserve
    ...
    export delimited name varlab using "Central African Republic ALL MODELS update dates data dictionary.csv", replace 
...
keep if loc_grand_name == "Central African Republic"

keep date DayDeaMeSmJOHNCAF
...
save "JOHN Central African Republic.dta", replace 




* graph Central African Republic JOHN daily deaths

twoway ///
(line DayDeaMeSmJOHNCAF date, sort lwidth(thick) lcolor(cyan)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, Central African Republic, JOHN", size(medium) color(black)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Central African Republic JOHN C19 daily deaths reported.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "DELP `update' Central African Republic.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "DELP `update' Central African Republic.dta"
...
save "DELP Central African Republic.dta", replace
...
merge m:m date using "JOHN Central African Republic.dta"
...
preserve
    ...
    export delimited name varlab using "DELP Central African Republic data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Central African Republic DELP daily deaths each update 
	...
	subtitle("Central African Republic, forecast only") legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Central African Republic DELP daily deaths update `update'.pdf", replace	
...
* graph Central African Republic DELP daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Central African Republic, DELP, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Central African Republic DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	keep if country == "Central African Republic" 
	...
	* graph Central African Republic IHME daily deaths epoch each update 
	...
	ytitle(Daily deaths) title("C19 daily deaths, Central African Republic, IHME, update `update'", size(medium) color(black)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	...
	*/
	...
	/* qui graph export "graph 00 Central African Republic IHME daily deaths epoch `update'.pdf", replace */
	...
	save "IHME `update' Central African Republic.dta", replace emptyok	
...
foreach update of local list {
	...
	merge m:m date using "IHME `update' Central African Republic.dta"
...
save "IHME Central African Republic.dta", replace
...
merge m:1 date using "JOHN Central African Republic.dta"
...
preserve
    ...
    export delimited name varlab using "IHME Central African Republic data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Central African Republic IHME daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Central African Republic, forecast only") legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Central African Republic IHME daily deaths update `update'.pdf", replace	
...
* graph Central African Republic IHME daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Central African Republic, IHME, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Central African Republic IHME C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only
	...
	save "IMPE `update' Central African Republic.dta", replace emptyok
...
foreach update of local list {
	...
	merge m:m date using "IMPE `update' Central African Republic.dta"
...
save "IMPE Central African Republic.dta", replace
...
preserve
    ...
    export delimited name varlab using "IMPE Central African Republic data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Central African Republic IMPE daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Central African Republic, forecast only") legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Central African Republic IMPE daily deaths update `update'.pdf", replace	
...
* graph Central African Republic IMPE daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Central African Republic, IMPE, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Central African Republic IMPE C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "LANL `update' Central African Republic.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "LANL `update' Central African Republic.dta"
...
save "LANL Central African Republic.dta", replace
...
preserve
    ...
    export delimited name varlab using "LANL Central African Republic data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Central African Republic LANL daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Central African Republic, forecast only") legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Central African Republic LANL daily deaths update `update'.pdf", replace	
...
* graph Central African Republic LANL daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Central African Republic, LANL, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Central African Republic LANL C19 daily deaths all updates.pdf", replace
...
use "DELP Central African Republic.dta", clear

foreach model of local list {

	merge m:m date loc_grand_name using "`model' Central African Republic.dta", force
...
save "ALL MODLES Central African Republic.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODLES Central African Republic data dictionary.csv", replace 
...
* graph Central African Republic ALL MODELS daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Central African Republic, all models, all updates, forecast only", size(medium) color(black)) ///
legend(position(6) order(625 "JOHN" 1 "DELP" 28 "IHME" 3 "IMPE" 25 "LANL") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Central African Republic ALL MODELS C19 daily deaths all updates.pdf", replace
...
view "log CovidLongitudinal Central African Republic 1 Process.smcl"
