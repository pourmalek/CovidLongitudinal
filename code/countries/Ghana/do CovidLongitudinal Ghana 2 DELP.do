...
log using "log CovidLongitudinal Ghana 2 DELP.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Ghana 2 DELP.do"
...
* input data files: "DELP Ghana.dta"
* output data files: "DELP Ghana error.dta" (with error measures saved)

* output data dictionary files: "DELP Ghana error data dictionary.csv"
...
** graphs:
* "graph 03 Ghana DELP C19 daily deaths error.pdf"
* "graph 04 Ghana DELP C19 daily deaths absolute error.pdf"
* "graph 05 Ghana DELP C19 daily deaths percent error.pdf"
* "graph 06 Ghana DELP C19 daily deaths absolute percent error.pdf"

* "graph 07 Ghana DELP C19 daily deaths average median error.pdf"
* "graph 08 Ghana DELP C19 daily deaths average median absolute error.pdf"
* "graph 09 Ghana DELP C19 daily deaths average median percent error.pdf"
* "graph 10 Ghana DELP C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Ghana DELP C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
qui replace DDErrorDELP`update' = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Ghana
                                                            // <<-- modify 3
...
qui replace DDAbsErrDELP`update' = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Ghana
...
qui replace DDPerErrDELP`update' = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Ghana
...
qui replace DDAbPeErDELP`update' = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Ghana
...
qui replace DDErrorDELP`update'_Med1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Ghana
...
qui replace DDAbsErrDELP`update'_Med1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Ghana
...
qui replace DDPerErrDELP`update'_Med1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Ghana
...
qui replace DDAbPeErDELP`update'_Med1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Ghana
...
qui replace DDErrorDELP_Mean1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Ghana
...
qui replace DDAbsErrDELP_Mean1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Ghana
...
qui replace DDPerErrDELP_Mean1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Ghana
...
qui replace DDAbPeErDELP_Mean1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Ghana
...
subtitle("Ghana, DELP, all updates, forecast only", size(small)) 

qui graph export "graph 03 Ghana DELP C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Ghana DELP C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Ghana DELP C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Ghana DELP C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Ghana, DELP, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Ghana DELP C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Ghana DELP C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Ghana DELP C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Ghana DELP C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Ghana, DELP, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Ghana DELP C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "DELP Ghana error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "DELP Ghana error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Ghana 2 DELP.smcl"
