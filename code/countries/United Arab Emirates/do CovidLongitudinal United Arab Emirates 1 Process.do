...
log using "log CovidLongitudinal United Arab Emirates 1 Process.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal United Arab Emirates 1 Process.do"
...
**** "do CovidLongitudinal United Arab Emirates 1 Process.do"
...
** output data files: "`model' United Arab Emirates.dta"
**                   "ALL MODLES United Arab Emirates.dta"

** output data dictionary files: "United Arab Emirates ALL MODELS update dates data dictionary.csv"
**                               "`model' United Arab Emirates data dictionary.csv"
**                               "ALL MODLES United Arab Emirates data dictionary.csv"

** graphs:
** "graph 02 United Arab Emirates `model' C19 daily deaths all updates.pdf"
** "graph 02 United Arab Emirates ALL MODELS C19 daily deaths all updates.pdf"
...
foreach model of local list {
	...
	di in red "`model'" " United Arab Emirates absent update_date_block"
	
	qui keep if loc_grand_name == "United Arab Emirates"
	...
	save "United Arab Emirates `model' update dates.dta", replace
...
use "United Arab Emirates DELP update dates.dta", clear 

local list DELP IHME IMPE LANL UCLA YYGU

foreach model of local list {
	
	append using "United Arab Emirates `model' update dates.dta"
...
save "United Arab Emirates ALL MODELS update dates.dta", replace
	
export excel using "United Arab Emirates ALL MODELS update dates.xlsx", replace firstrow(variables) 
...
preserve
    ...
    export delimited name varlab using "United Arab Emirates ALL MODELS update dates data dictionary.csv", replace 
...
keep if loc_grand_name == "United Arab Emirates"

keep date DayDeaMeSmJOHNARE
...
save "JOHN United Arab Emirates.dta", replace 




* graph United Arab Emirates JOHN daily deaths

twoway ///
(line DayDeaMeSmJOHNARE date, sort lwidth(thick) lcolor(cyan)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, United Arab Emirates, JOHN", size(medium) color(black)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Arab Emirates JOHN C19 daily deaths reported.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "DELP `update' United Arab Emirates.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "DELP `update' United Arab Emirates.dta"
...
save "DELP United Arab Emirates.dta", replace
...
merge m:m date using "JOHN United Arab Emirates.dta"
...
preserve
    ...
    export delimited name varlab using "DELP United Arab Emirates data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph United Arab Emirates DELP daily deaths each update 
	...
	subtitle("United Arab Emirates, forecast only") legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United Arab Emirates DELP daily deaths update `update'.pdf", replace	
...
* graph United Arab Emirates DELP daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Arab Emirates, DELP, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Arab Emirates DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	keep if country == "United Arab Emirates" 
	...
	* graph United Arab Emirates IHME daily deaths epoch each update 
	...
	ytitle(Daily deaths) title("C19 daily deaths, United Arab Emirates, IHME, update `update'", size(medium) color(black)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	...
	*/
	...
	/* qui graph export "graph 00 United Arab Emirates IHME daily deaths epoch `update'.pdf", replace */
	...
	save "IHME `update' United Arab Emirates.dta", replace emptyok	
...
foreach update of local list {
	...
	merge m:m date using "IHME `update' United Arab Emirates.dta"
...
save "IHME United Arab Emirates.dta", replace
...
merge m:1 date using "JOHN United Arab Emirates.dta"
...
preserve
    ...
    export delimited name varlab using "IHME United Arab Emirates data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph United Arab Emirates IHME daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United Arab Emirates, forecast only") legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United Arab Emirates IHME daily deaths update `update'.pdf", replace	
...
* graph United Arab Emirates IHME daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Arab Emirates, IHME, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Arab Emirates IHME C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only
	...
	save "IMPE `update' United Arab Emirates.dta", replace emptyok
...
foreach update of local list {
	...
	merge m:m date using "IMPE `update' United Arab Emirates.dta"
...
save "IMPE United Arab Emirates.dta", replace
...
preserve
    ...
    export delimited name varlab using "IMPE United Arab Emirates data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph United Arab Emirates IMPE daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United Arab Emirates, forecast only") legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United Arab Emirates IMPE daily deaths update `update'.pdf", replace	
...
* graph United Arab Emirates IMPE daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Arab Emirates, IMPE, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Arab Emirates IMPE C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "LANL `update' United Arab Emirates.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "LANL `update' United Arab Emirates.dta"
...
save "LANL United Arab Emirates.dta", replace
...
preserve
    ...
    export delimited name varlab using "LANL United Arab Emirates data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph United Arab Emirates LANL daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United Arab Emirates, forecast only") legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United Arab Emirates LANL daily deaths update `update'.pdf", replace	
...
* graph United Arab Emirates LANL daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Arab Emirates, LANL, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Arab Emirates LANL C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only  
	...
	save "UCLA `update' United Arab Emirates.dta", replace 
	
	/* line DayDeaMeRaUCLA`update' DayDeaMeSmUCLA`update' DayDeaMeFoUCLA`update' date

	qui graph export "UCLA `update' United Arab Emirates.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "UCLA `update' United Arab Emirates.dta"
...
save "UCLA United Arab Emirates.dta", replace
...
preserve
    ...
    export delimited name varlab using "UCLA United Arab Emirates data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph United Arab Emirates UCLA daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United Arab Emirates, forecast only") legend(position(6) order(1 "JOHN" 2 "UCLA forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United Arab Emirates UCLA daily deaths update `update'.pdf", replace	

}
*/


* graph United Arab Emirates UCLA daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Arab Emirates, UCLA, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "UCLA forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Arab Emirates UCLA C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen FORE, that is forecast only 
	...
	save "YYGU `update' United Arab Emirates.dta", replace 
	
	/* line DayDeaMeRaYYGU`update' DayDeaMeSmYYGU`update' DayDeaMeFoYYGU`update' date

	qui graph export "YYGU `update' United Arab Emirates.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "YYGU `update' United Arab Emirates.dta"
...
save "YYGU United Arab Emirates.dta", replace
...
preserve
    ...
    export delimited name varlab using "YYGU United Arab Emirates data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph United Arab Emirates YYGU daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United Arab Emirates, forecast only") legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United Arab Emirates YYGU daily deaths update `update'.pdf", replace	
...
* graph United Arab Emirates YYGU daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Arab Emirates, YYGU, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Arab Emirates YYGU C19 daily deaths all updates.pdf", replace
...
use "DELP United Arab Emirates.dta", clear

foreach model of local list {

	merge m:m date loc_grand_name using "`model' United Arab Emirates.dta", force
...
save "ALL MODLES United Arab Emirates.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODLES United Arab Emirates data dictionary.csv", replace 
...
* graph United Arab Emirates ALL MODELS daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Arab Emirates, all models, all updates, forecast only", size(medium) color(black)) ///
legend(position(6) order(791 "JOHN" 1 "DELP" 65 "IHME" 24 "IMPE" 3 "LANL" 308 "UCLA" 15 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Arab Emirates ALL MODELS C19 daily deaths all updates.pdf", replace
...
view "log CovidLongitudinal United Arab Emirates 1 Process.smcl"
