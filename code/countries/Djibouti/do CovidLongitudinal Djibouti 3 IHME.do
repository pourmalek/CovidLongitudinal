...
log using "log CovidLongitudinal Djibouti 3 IHME.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Djibouti 3 IHME.do"
...
* input data files: "IHME Djibouti.dta"
* output data files: "IHME Djibouti error.dta" (with error measures saved)

* output data dictionary files: "IHME Djibouti error data dictionary.csv"
...
** graphs:
* "graph 03 Djibouti IHME C19 daily deaths error.pdf"
* "graph 04 Djibouti IHME C19 daily deaths absolute error.pdf"
* "graph 05 Djibouti IHME C19 daily deaths percent error.pdf"
* "graph 06 Djibouti IHME C19 daily deaths absolute percent error.pdf"

* "graph 07 Djibouti IHME C19 daily deaths average median error.pdf"
* "graph 08 Djibouti IHME C19 daily deaths average median absolute error.pdf"
* "graph 09 Djibouti IHME C19 daily deaths average median percent error.pdf"
* "graph 10 Djibouti IHME C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Djibouti IHME C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
qui replace DDErrorIHME`update' = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Djibouti
                                                            // <<-- modify 3
...
qui replace DDAbsErrIHME`update' = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Djibouti
...
qui replace DDPerErrIHME`update' = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Djibouti
...
qui replace DDAbPeErIHME`update' = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Djibouti
...
qui replace DDErrorIHME`update'_Med1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Djibouti
...
qui replace DDAbsErrIHME`update'_Med1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Djibouti
...
qui replace DDPerErrIHME`update'_Med1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Djibouti
...
qui replace DDAbPeErIHME`update'_Med1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Djibouti
...
egen DDErrorIHME_Mean1 = rowmean(DDErrorIHME20221024_Med1-DDErrorIHME20200625_Med1) // <<-- modify 5
...
qui replace DDErrorIHME_Mean1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Djibouti
...
egen DDAbsErrIHME_Mean1 = rowmean(DDAbsErrIHME20221024_Med1-DDAbsErrIHME20200625_Med1) // <<-- modify 7
...
qui replace DDAbsErrIHME_Mean1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Djibouti
...
egen DDPerErrIHME_Mean1 = rowmean(DDPerErrIHME20221024_Med1-DDPerErrIHME20200625_Med1) // <<-- modify 9
...
qui replace DDPerErrIHME_Mean1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Djibouti
...
egen DDAbPeErIHME_Mean1 = rowmean(DDAbPeErIHME20221024_Med1-DDAbPeErIHME20200625_Med1) // <<-- modify 11
...
qui replace DDAbPeErIHME_Mean1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Djibouti
...
subtitle("Djibouti, IHME, all updates, forecast only", size(small)) 

qui graph export "graph 03 Djibouti IHME C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Djibouti IHME C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Djibouti IHME C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Djibouti IHME C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Djibouti, IHME, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Djibouti IHME C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Djibouti IHME C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Djibouti IHME C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Djibouti IHME C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Djibouti, IHME, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Djibouti IHME C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IHME Djibouti error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IHME Djibouti error data dictionary.csv", replace 
...
view "log CovidLongitudinal Djibouti 3 IHME.smcl"
