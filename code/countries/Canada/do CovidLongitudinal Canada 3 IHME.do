...
log using "log CovidLongitudinal Canada 3 IHME.smcl", replace
...
qui replace DDErrorIHME`update' = . if date < td(22apr2020) // 22apr2020 is the earliest date of IHME forecasts for Canada
                                                            // <<-- modify 3
...
qui replace DDAbsErrIHME`update' = . if date < td(22apr2020) // 22apr2020 is the earliest date of IHME forecasts for Canada
...
qui replace DDPerErrIHME`update' = . if date < td(22apr2020) // 22apr2020 is the earliest date of IHME forecasts for Canada
...
qui replace DDAbPeErIHME`update' = . if date < td(22apr2020) // 22apr2020 is the earliest date of IHME forecasts for Canada
...
qui replace DDErrorIHME`update'_Med1 = . if date < td(22apr2020) // 22apr2020 is the earliest date of IHME forecasts for Canada
...
qui replace DDAbsErrIHME`update'_Med1 = . if date < td(22apr2020) // 22apr2020 is the earliest date of IHME forecasts for Canada
...
qui replace DDPerErrIHME`update'_Med1 = . if date < td(22apr2020) // 22apr2020 is the earliest date of IHME forecasts for Canada
...
qui replace DDAbPeErIHME`update'_Med1 = . if date < td(22apr2020) // 22apr2020 is the earliest date of IHME forecasts for Canada
...
egen DDErrorIHME_Mean1 = rowmean(DDErrorIHME20221216_Med1-DDErrorIHME20200422_Med1) // <<-- modify 5
...
qui replace DDErrorIHME_Mean1 = . if date < td(22apr2020) // 22apr2020 is the earliest date of IHME forecasts for Canada
...
egen DDAbsErrIHME_Mean1 = rowmean(DDAbsErrIHME20221216_Med1-DDAbsErrIHME20200422_Med1) // <<-- modify 7
...
qui replace DDAbsErrIHME_Mean1 = . if date < td(22apr2020) // 22apr2020 is the earliest date of IHME forecasts for Canada
...
egen DDPerErrIHME_Mean1 = rowmean(DDPerErrIHME20221216_Med1-DDPerErrIHME20200422_Med1) // <<-- modify 9
...
qui replace DDPerErrIHME_Mean1 = . if date < td(22apr2020) // 22apr2020 is the earliest date of IHME forecasts for Canada
...
egen DDAbPeErIHME_Mean1 = rowmean(DDAbPeErIHME20221216_Med1-DDAbPeErIHME20200422_Med1) // <<-- modify 11
...
qui replace DDAbPeErIHME_Mean1 = . if date < td(22apr2020) // 22apr2020 is the earliest date of IHME forecasts for Canada
