...
log using "log CovidLongitudinal Saudi Arabia 5 LANL.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Saudi Arabia 5 LANL.do"
...
* input data files: "LANL Saudi Arabia.dta"
* output data files: "LANL Saudi Arabia error.dta" (with error measures saved)

* output data dictionary files: "LANL Saudi Arabia error data dictionary.csv"
...
** graphs:
* "graph 03 Saudi Arabia LANL C19 daily deaths error.pdf"
* "graph 04 Saudi Arabia LANL C19 daily deaths absolute error.pdf"
* "graph 05 Saudi Arabia LANL C19 daily deaths percent error.pdf"
* "graph 06 Saudi Arabia LANL C19 daily deaths absolute percent error.pdf"

* "graph 07 Saudi Arabia LANL C19 daily deaths average median error.pdf"
* "graph 08 Saudi Arabia LANL C19 daily deaths average median absolute error.pdf"
* "graph 09 Saudi Arabia LANL C19 daily deaths average median percent error.pdf"
* "graph 10 Saudi Arabia LANL C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Saudi Arabia LANL C19 daily deaths Average MAPE over updates and calendar months
...
use "LANL Saudi Arabia.dta", clear 
...
qui replace DDErrorLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Saudi Arabia
                                                            // <<-- modify 3
...
qui replace DDAbsErrLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Saudi Arabia
...
qui replace DDPerErrLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Saudi Arabia
...
qui replace DDAbPeErLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Saudi Arabia
...
qui replace DDErrorLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Saudi Arabia
...
qui replace DDAbsErrLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Saudi Arabia
...
qui replace DDPerErrLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Saudi Arabia
...
qui replace DDAbPeErLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Saudi Arabia
...
qui replace DDErrorLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Saudi Arabia
...
qui replace DDAbsErrLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Saudi Arabia
...
qui replace DDPerErrLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Saudi Arabia
...
qui replace DDAbPeErLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for Saudi Arabia
...
subtitle("Saudi Arabia, LANL, all updates, forecast only", size(small)) 

qui graph export "graph 03 Saudi Arabia LANL C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Saudi Arabia LANL C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Saudi Arabia LANL C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Saudi Arabia LANL C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Saudi Arabia, LANL, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Saudi Arabia LANL C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Saudi Arabia LANL C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Saudi Arabia LANL C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Saudi Arabia LANL C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Saudi Arabia, LANL, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Saudi Arabia LANL C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "LANL Saudi Arabia error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "LANL Saudi Arabia error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Saudi Arabia 5 LANL.smcl"
