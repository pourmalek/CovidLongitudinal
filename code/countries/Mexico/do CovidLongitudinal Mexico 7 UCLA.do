...
log using "log CovidLongitudinal Mexico 7 UCLA.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Mexico 7 UCLA.do"
...
* input data files: "UCLA Mexico.dta"
* output data files: "UCLA Mexico error.dta" (with error measures saved)

* output data dictionary files: "UCLA Mexico error data dictionary.csv"
...
** graphs:
* "graph 03 Mexico UCLA C19 daily deaths error.pdf"
* "graph 04 Mexico UCLA C19 daily deaths absolute error.pdf"
* "graph 05 Mexico UCLA C19 daily deaths percent error.pdf"
* "graph 06 Mexico UCLA C19 daily deaths absolute percent error.pdf"

* "graph 07 Mexico UCLA C19 daily deaths average median error.pdf"
* "graph 08 Mexico UCLA C19 daily deaths average median absolute error.pdf"
* "graph 09 Mexico UCLA C19 daily deaths average median percent error.pdf"
* "graph 10 Mexico UCLA C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Mexico UCLA C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Mexico
                                                            // <<-- modify 3
...
qui replace DDAbsErrUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Mexico
...
qui replace DDPerErrUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Mexico
...
qui replace DDAbPeErUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Mexico
...
qui replace DDErrorUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Mexico
...
qui replace DDAbsErrUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Mexico
...
qui replace DDPerErrUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Mexico
...
qui replace DDAbPeErUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Mexico
...
qui replace DDErrorUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Mexico
...
qui replace DDAbsErrUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Mexico
...
qui replace DDPerErrUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Mexico
...
qui replace DDAbPeErUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Mexico
...
subtitle("Mexico, UCLA, all updates, forecast only", size(small)) 

qui graph export "graph 03 Mexico UCLA C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Mexico UCLA C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Mexico UCLA C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Mexico UCLA C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Mexico, UCLA, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Mexico UCLA C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Mexico UCLA C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Mexico UCLA C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Mexico UCLA C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Mexico, UCLA, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Mexico UCLA C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "UCLA Mexico error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "UCLA Mexico error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Mexico 7 UCLA.smcl"
