...
log using "log CovidLongitudinal Nicaragua 5 LANL.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Nicaragua 5 LANL.do"
...
* input data files: "LANL Nicaragua.dta"
* output data files: "LANL Nicaragua error.dta" (with error measures saved)

* output data dictionary files: "LANL Nicaragua error data dictionary.csv"
...
** graphs:
* "graph 03 Nicaragua LANL C19 daily deaths error.pdf"
* "graph 04 Nicaragua LANL C19 daily deaths absolute error.pdf"
* "graph 05 Nicaragua LANL C19 daily deaths percent error.pdf"
* "graph 06 Nicaragua LANL C19 daily deaths absolute percent error.pdf"

* "graph 07 Nicaragua LANL C19 daily deaths average median error.pdf"
* "graph 08 Nicaragua LANL C19 daily deaths average median absolute error.pdf"
* "graph 09 Nicaragua LANL C19 daily deaths average median percent error.pdf"
* "graph 10 Nicaragua LANL C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Nicaragua LANL C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorLANL`update' = . if date < td(27may2020) // 27may2020 is the earliest date of LANL forecasts for Nicaragua
                                                            // <<-- modify 3
...
qui replace DDAbsErrLANL`update' = . if date < td(27may2020) // 27may2020 is the earliest date of LANL forecasts for Nicaragua
...
qui replace DDPerErrLANL`update' = . if date < td(27may2020) // 27may2020 is the earliest date of LANL forecasts for Nicaragua
...
qui replace DDAbPeErLANL`update' = . if date < td(27may2020) // 27may2020 is the earliest date of LANL forecasts for Nicaragua
...
qui replace DDErrorLANL`update'_Med1 = . if date < td(27may2020) // 27may2020 is the earliest date of LANL forecasts for Nicaragua
...
qui replace DDAbsErrLANL`update'_Med1 = . if date < td(27may2020) // 27may2020 is the earliest date of LANL forecasts for Nicaragua
...
qui replace DDPerErrLANL`update'_Med1 = . if date < td(27may2020) // 27may2020 is the earliest date of LANL forecasts for Nicaragua
...
qui replace DDAbPeErLANL`update'_Med1 = . if date < td(27may2020) // 27may2020 is the earliest date of LANL forecasts for Nicaragua
...
egen DDErrorLANL_Mean1 = rowmean(DDErrorLANL20210926_Med1-DDErrorLANL20200527_Med1) // <<-- modify 5
...
qui replace DDErrorLANL_Mean1 = . if date < td(27may2020) // 27may2020 is the earliest date of LANL forecasts for Nicaragua
...
egen DDAbsErrLANL_Mean1 = rowmean(DDAbsErrLANL20210926_Med1-DDAbsErrLANL20200527_Med1) // <<-- modify 7
...
qui replace DDAbsErrLANL_Mean1 = . if date < td(27may2020) // 27may2020 is the earliest date of LANL forecasts for Nicaragua
...
egen DDPerErrLANL_Mean1 = rowmean(DDPerErrLANL20210926_Med1-DDPerErrLANL20200527_Med1) // <<-- modify 9
...
qui replace DDPerErrLANL_Mean1 = . if date < td(27may2020) // 27may2020 is the earliest date of LANL forecasts for Nicaragua
...
egen DDAbPeErLANL_Mean1 = rowmean(DDAbPeErLANL20210926_Med1-DDAbPeErLANL20200527_Med1) // <<-- modify 11
...
qui replace DDAbPeErLANL_Mean1 = . if date < td(27may2020) // 27may2020 is the earliest date of LANL forecasts for Nicaragua
...
subtitle("Nicaragua, LANL, all updates, forecast only", size(small)) 

qui graph export "graph 03 Nicaragua LANL C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Nicaragua LANL C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Nicaragua LANL C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Nicaragua LANL C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Nicaragua, LANL, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Nicaragua LANL C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Nicaragua LANL C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Nicaragua LANL C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Nicaragua LANL C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Nicaragua, LANL, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Nicaragua LANL C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "LANL Nicaragua error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "LANL Nicaragua error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Nicaragua 5 LANL.smcl"
