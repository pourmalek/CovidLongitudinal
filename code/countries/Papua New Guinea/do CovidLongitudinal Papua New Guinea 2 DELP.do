...
log using "log CovidLongitudinal Papua New Guinea 2 DELP.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Papua New Guinea 2 DELP.do"
...
* input data files: "DELP Papua New Guinea.dta"
* output data files: "DELP Papua New Guinea error.dta" (with error measures saved)

* output data dictionary files: "DELP Papua New Guinea error data dictionary.csv"
...
** graphs:
* "graph 03 Papua New Guinea DELP C19 daily deaths error.pdf"
* "graph 04 Papua New Guinea DELP C19 daily deaths absolute error.pdf"
* "graph 05 Papua New Guinea DELP C19 daily deaths percent error.pdf"
* "graph 06 Papua New Guinea DELP C19 daily deaths absolute percent error.pdf"

* "graph 07 Papua New Guinea DELP C19 daily deaths average median error.pdf"
* "graph 08 Papua New Guinea DELP C19 daily deaths average median absolute error.pdf"
* "graph 09 Papua New Guinea DELP C19 daily deaths average median percent error.pdf"
* "graph 10 Papua New Guinea DELP C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Papua New Guinea DELP C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
qui replace DDErrorDELP`update' = . if date < td(15aug2020) // 15aug2020 is the earliest date of DELP forecasts for Papua New Guinea
                                                            // <<-- modify 3
...
qui replace DDAbsErrDELP`update' = . if date < td(15aug2020) // 15aug2020 is the earliest date of DELP forecasts for Papua New Guinea
...
qui replace DDPerErrDELP`update' = . if date < td(15aug2020) // 15aug2020 is the earliest date of DELP forecasts for Papua New Guinea
...
qui replace DDAbPeErDELP`update' = . if date < td(15aug2020) // 15aug2020 is the earliest date of DELP forecasts for Papua New Guinea
...
qui replace DDErrorDELP`update'_Med1 = . if date < td(15aug2020) // 15aug2020 is the earliest date of DELP forecasts for Papua New Guinea
...
qui replace DDAbsErrDELP`update'_Med1 = . if date < td(15aug2020) // 15aug2020 is the earliest date of DELP forecasts for Papua New Guinea
...
qui replace DDPerErrDELP`update'_Med1 = . if date < td(15aug2020) // 15aug2020 is the earliest date of DELP forecasts for Papua New Guinea
...
qui replace DDAbPeErDELP`update'_Med1 = . if date < td(15aug2020) // 15aug2020 is the earliest date of DELP forecasts for Papua New Guinea
...
egen DDErrorDELP_Mean1 = rowmean(DDErrorDELP20220915_Med1-DDErrorDELP20200815_Med1) // <<-- modify 5
...
qui replace DDErrorDELP_Mean1 = . if date < td(15aug2020) // 15aug2020 is the earliest date of DELP forecasts for Papua New Guinea
...
egen DDAbsErrDELP_Mean1 = rowmean(DDAbsErrDELP20220915_Med1-DDAbsErrDELP20200815_Med1) // <<-- modify 7
...
qui replace DDAbsErrDELP_Mean1 = . if date < td(15aug2020) // 15aug2020 is the earliest date of DELP forecasts for Papua New Guinea
...
egen DDPerErrDELP_Mean1 = rowmean(DDPerErrDELP20220915_Med1-DDPerErrDELP20200815_Med1) // <<-- modify 9
...
qui replace DDPerErrDELP_Mean1 = . if date < td(15aug2020) // 15aug2020 is the earliest date of DELP forecasts for Papua New Guinea
...
egen DDAbPeErDELP_Mean1 = rowmean(DDAbPeErDELP20220915_Med1-DDAbPeErDELP20200815_Med1) // <<-- modify 11
...
qui replace DDAbPeErDELP_Mean1 = . if date < td(15aug2020) // 15aug2020 is the earliest date of DELP forecasts for Papua New Guinea
...
subtitle("Papua New Guinea, DELP, all updates, forecast only", size(small)) 

qui graph export "graph 03 Papua New Guinea DELP C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Papua New Guinea DELP C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Papua New Guinea DELP C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Papua New Guinea DELP C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Papua New Guinea, DELP, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Papua New Guinea DELP C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Papua New Guinea DELP C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Papua New Guinea DELP C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Papua New Guinea DELP C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Papua New Guinea, DELP, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Papua New Guinea DELP C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "DELP Papua New Guinea error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "DELP Papua New Guinea error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Papua New Guinea 2 DELP.smcl"
