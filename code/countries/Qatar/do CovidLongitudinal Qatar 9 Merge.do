...
log using "log CovidLongitudinal Qatar 9 Merge.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Qatar 9 Merge.do"
...
** input data files: "`model' Qatar error.dta"

** output data files: "ALL MODELS Qatar error.dta" with all date
*                     "ALL MODELS Qatar error - only models across error measures.dta", replace
*                     "ALL MODELS Qatar error - only error measures across models.dta", replace

* output data dictionary files: "ALL MODELS Qatar error data dictionary.csv"
*                               "ALL MODELS Qatar error - only models across error measures data dictionary.csv"
*                               "ALL MODELS Qatar error - only error measures across models data dictionary.csv"


** Graphs:
* "graph 03 Qatar ALL MODELS C19 daily deaths error.pdf"
* "graph 04 Qatar ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 05 Qatar ALL MODELS C19 daily deaths percent error.pdf"
* "graph 06 Qatar ALL MODELS C19 daily deaths absolute percent error.pdf"

* "graph 07a1 Qatar ALL MODELS C19 daily deaths average median error.pdf"
* "graph 07a2 Qatar ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 08a1 Qatar ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 08a2 Qatar ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 09a1 Qatar ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 09a2 Qatar ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10a1 Qatar ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10a2 Qatar ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"

****** graph each same error measure across models:
* "graph 12a Qatar ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 12b Qatar ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 12c Qatar ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 12d Qatar ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"

****** graph all models across error measures:
* "graph 13a Qatar ALL MODELS C19 daily deaths, models across error measures.pdf"

****** graph all error measures across models:
* "graph 13b Qatar ALL MODELS C19 daily deaths, error measures across models.pdf"
...
use "DELP Qatar error.dta", clear 

	merge m:m date using "IHME Qatar error.dta"

	drop _merge
	
	merge m:m date using "IMPE Qatar error.dta"
	
	drop _merge
	
	merge m:m date using "LANL Qatar error.dta"	
	
	drop _merge
		
	merge m:m date using "UCLA Qatar error.dta", force
...
subtitle("Qatar, all Models, all updates, forecast only", size(small)) ///
legend(position(6) order(1 "DELP" 28 "IHME" 11 "IMPE" 7 "LANL" 167 "UCLA") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 03 Qatar ALL MODELS C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Qatar ALL MODELS C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Qatar ALL MODELS C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Qatar ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Qatar, all Models, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "UCLA") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 07a1 Qatar ALL MODELS C19 daily deaths average median error.pdf", replace 
...
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths, average median error", size(medium) color(black)) /// 
subtitle("Qatar, all Models, forecast only; smoothed for better viewing", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "UCLA") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 07a2 Qatar ALL MODELS C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 08a1 Qatar ALL MODELS C19 daily deaths average median absolute error.pdf", replace 
...
qui graph export "graph 08a2 Qatar ALL MODELS C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 09a1 Qatar ALL MODELS C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 09a2 Qatar ALL MODELS C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10a1 Qatar ALL MODELS C19 daily deaths average median absolute percent error.pdf", replace 
...
qui graph export "graph 10a2 Qatar ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
subtitle("Over updates and calendar months; forecast only; Qatar", size(small)) /// 
legend(region(lcolor(none))) legend(bexpand) ///
legend(position(6) order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "UCLA") size(small) row(2)) 

qui graph export "graph 12a Qatar ALL MODELS C19 daily deaths Average Mean Error.pdf", replace
...
qui graph export "graph 12b Qatar ALL MODELS C19 daily deaths Average Absolute Error.pdf", replace
...
qui graph export "graph 12c Qatar ALL MODELS C19 daily deaths Average Percent Error.pdf", replace
...
qui graph export "graph 12d Qatar ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf", replace
...
save "ALL MODELS Qatar error.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Qatar error data dictionary.csv", replace 
...
use "ALL MODELS Qatar error.dta", clear

save "ALL MODELS Qatar error - only models across error measures.dta", replace
...
rename ///
(DDErrorDELP_Mean2 DDErrorIHME_Mean2 DDErrorIMPE_Mean2 DDErrorLANL_Mean2 DDErrorUCLA_Mean2) ///
(DDErrorrDELP_Mean2 DDErrorrIHME_Mean2 DDErrorrIMPE_Mean2 DDErrorrLANL_Mean2 DDErrorrUCLA_Mean2) 
...
save "CovidLongitudinal Qatar merge temp.dta", replace 
...
qui graph export "graph 13a Qatar ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Qatar error - only models across error measures data dictionary.csv", replace 
...
use "CovidLongitudinal Qatar merge temp.dta", clear 
...
rename (DDErrorrDELP DDErrorrIHME DDErrorrIMPE DDErrorrLANL DDErrorrUCLA) ///
...
rename (DDAbsErrDELP DDAbsErrIHME DDAbsErrIMPE DDAbsErrLANL DDAbsErrUCLA) ///
...
rename (DDPerErrDELP DDPerErrIHME DDPerErrIMPE DDPerErrLANL DDPerErrUCLA) ///
...
rename (DDAbPeErDELP DDAbPeErIHME DDAbPeErIMPE DDAbPeErLANL DDAbPeErUCLA) ///
...
qui graph export "graph 13b Qatar ALL MODELS C19 daily deaths, error measures across models.pdf", replace
...
rename (DDA1E1 DDA2E1 DDA3E1 DDA4E1 DDA5E1) ///
       (DD_DELP_Errorr DD_IHME_Errorr DD_IMPE_Errorr DD_LANL_Errorr DD_UCLA_Errorr)
...
rename (DDA1E2 DDA2E2 DDA3E2 DDA4E2 DDA5E2) ///
       (DD_DELP_AbsErr DD_IHME_AbsErr DD_IMPE_AbsErr DD_LANL_AbsErr DD_UCLA_AbsErr)
...
rename (DDA1E3 DDA2E3 DDA3E3 DDA4E3 DDA5E3) ///
       (DD_DELP_PerErr DD_IHME_PerErr DD_IMPE_PerErr DD_LANL_PerErr DD_UCLA_PerErr)
...
(DD_DELP_AbPeEr DD_IHME_AbPeEr DD_IMPE_AbPeEr DD_LANL_AbPeEr DD_UCLA_AbPeEr)
...
save "ALL MODELS Qatar error - only error measures across models.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Qatar error - only error measures across models data dictionary.csv", replace 
...
view "log CovidLongitudinal Qatar 9 Merge.smcl"
