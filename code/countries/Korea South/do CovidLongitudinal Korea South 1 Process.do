...
log using "log CovidLongitudinal Korea South 1 Process.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Korea South 1 Process.do"
...
**** "do CovidLongitudinal Korea South 1 Process.do"
...
** output data files: "`model' Korea South.dta"
**                   "ALL MODLES Korea South.dta"

** output data dictionary files: "Korea South ALL MODELS update dates data dictionary.csv"
**                               "`model' Korea South data dictionary.csv"
**                               "ALL MODLES Korea South data dictionary.csv"

** graphs:
** "graph 02 Korea South `model' C19 daily deaths all updates.pdf"
** "graph 02 Korea South ALL MODELS C19 daily deaths all updates.pdf"
...
foreach model of local list {
	...
	di in red "`model'" " Korea South absent update_date_block"
	
	qui keep if loc_grand_name == "Korea South"
	...
	save "Korea South `model' update dates.dta", replace
...
use "Korea South DELP update dates.dta", clear 

local list DELP IHME IMPE LANL YYGU

foreach model of local list {
	
	append using "Korea South `model' update dates.dta"
...
save "Korea South ALL MODELS update dates.dta", replace
	
export excel using "Korea South ALL MODELS update dates.xlsx", replace firstrow(variables) 
...
preserve
    ...
    export delimited name varlab using "Korea South ALL MODELS update dates data dictionary.csv", replace 
...
keep if loc_grand_name == "Korea South"

keep date DayDeaMeSmJOHNKOR
...
save "JOHN Korea South.dta", replace 




* graph Korea South JOHN daily deaths

twoway ///
(line DayDeaMeSmJOHNKOR date, sort lwidth(thick) lcolor(cyan)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, Korea South, JOHN", size(medium) color(black)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Korea South JOHN C19 daily deaths reported.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "DELP `update' Korea South.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "DELP `update' Korea South.dta"
...
save "DELP Korea South.dta", replace
...
merge m:m date using "JOHN Korea South.dta"
...
preserve
    ...
    export delimited name varlab using "DELP Korea South data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Korea South DELP daily deaths each update 
	...
	subtitle("Korea South, forecast only") legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Korea South DELP daily deaths update `update'.pdf", replace	
...
* graph Korea South DELP daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Korea South, DELP, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Korea South DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* graph Korea South IHME daily deaths epoch each update 
	...
	ytitle(Daily deaths) title("C19 daily deaths, Korea South, IHME, update `update'", size(medium) color(black)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	...
	*/
	...
	/* qui graph export "graph 00 Korea South IHME daily deaths epoch `update'.pdf", replace */
	...
	save "IHME `update' Korea South.dta", replace emptyok	
...
foreach update of local list {
	...
	merge m:m date using "IHME `update' Korea South.dta"
...
save "IHME Korea South.dta", replace
...
merge m:1 date using "JOHN Korea South.dta"
...
preserve
    ...
    export delimited name varlab using "IHME Korea South data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Korea South IHME daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Korea South, forecast only") legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Korea South IHME daily deaths update `update'.pdf", replace	
...
* graph Korea South IHME daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Korea South, IHME, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Korea South IHME C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only
	...
	save "IMPE `update' Korea South.dta", replace emptyok
...
foreach update of local list {
	...
	merge m:m date using "IMPE `update' Korea South.dta"
...
save "IMPE Korea South.dta", replace
...
preserve
    ...
    export delimited name varlab using "IMPE Korea South data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Korea South IMPE daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Korea South, forecast only") legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Korea South IMPE daily deaths update `update'.pdf", replace	
...
* graph Korea South IMPE daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Korea South, IMPE, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Korea South IMPE C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "LANL `update' Korea South.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "LANL `update' Korea South.dta"
...
save "LANL Korea South.dta", replace
...
preserve
    ...
    export delimited name varlab using "LANL Korea South data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Korea South LANL daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Korea South, forecast only") legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Korea South LANL daily deaths update `update'.pdf", replace	
...
* graph Korea South LANL daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Korea South, LANL, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Korea South LANL C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen FORE, that is forecast only 
	...
	save "YYGU `update' Korea South.dta", replace 
	
	/* line DayDeaMeRaYYGU`update' DayDeaMeSmYYGU`update' DayDeaMeFoYYGU`update' date

	qui graph export "YYGU `update' Korea South.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "YYGU `update' Korea South.dta"
...
save "YYGU Korea South.dta", replace
...
preserve
    ...
    export delimited name varlab using "YYGU Korea South data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Korea South YYGU daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Korea South, forecast only") legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Korea South YYGU daily deaths update `update'.pdf", replace	
...
* graph Korea South YYGU daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Korea South, YYGU, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Korea South YYGU C19 daily deaths all updates.pdf", replace
...
use "DELP Korea South.dta", clear

foreach model of local list {

	merge m:m date loc_grand_name using "`model' Korea South.dta", force
...
save "ALL MODLES Korea South.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODLES Korea South data dictionary.csv", replace 
...
* graph Korea South ALL MODELS daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Korea South, all models, all updates, forecast only", size(medium) color(black)) ///
legend(position(6) order(736 "JOHN" 1 "DELP" 9 "IHME" 260 "IMPE" 2 "LANL" 10 "YYGU") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Korea South ALL MODELS C19 daily deaths all updates.pdf", replace
...
view "log CovidLongitudinal Korea South 1 Process.smcl"
