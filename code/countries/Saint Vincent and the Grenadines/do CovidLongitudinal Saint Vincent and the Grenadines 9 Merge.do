...
log using "log CovidLongitudinal Saint Vincent and the Grenadines 9 Merge.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Saint Vincent and the Grenadines 9 Merge.do"
...
** input data files: "`model' Saint Vincent and the Grenadines error.dta"

** output data files: "ALL MODELS Saint Vincent and the Grenadines error.dta" with all date
*                     "ALL MODELS Saint Vincent and the Grenadines error - only models across error measures.dta", replace
*                     "ALL MODELS Saint Vincent and the Grenadines error - only error measures across models.dta", replace

* output data dictionary files: "ALL MODELS Saint Vincent and the Grenadines error data dictionary.csv"
*                               "ALL MODELS Saint Vincent and the Grenadines error - only models across error measures data dictionary.csv"
*                               "ALL MODELS Saint Vincent and the Grenadines error - only error measures across models data dictionary.csv"


** Graphs:
* "graph 03 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths error.pdf"
* "graph 04 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 05 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths percent error.pdf"
* "graph 06 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths absolute percent error.pdf"

* "graph 07a1 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median error.pdf"
* "graph 07a2 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 08a1 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 08a2 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 09a1 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 09a2 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10a1 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10a2 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"

****** graph each same error measure across models:
* "graph 12a Saint Vincent and the Grenadines ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 12b Saint Vincent and the Grenadines ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 12c Saint Vincent and the Grenadines ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 12d Saint Vincent and the Grenadines ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"

****** graph all models across error measures:
* "graph 13a Saint Vincent and the Grenadines ALL MODELS C19 daily deaths, models across error measures.pdf"

****** graph all error measures across models:
* "graph 13b Saint Vincent and the Grenadines ALL MODELS C19 daily deaths, error measures across models.pdf"
...
use "IMPE Saint Vincent and the Grenadines error.dta", clear 
...
subtitle("Saint Vincent and the Grenadines, all Models, all updates, forecast only", size(small)) ///
legend(position(6) order(1 "IMPE") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 03 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Saint Vincent and the Grenadines, all Models, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "IMPE") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) legend(on)

qui graph export "graph 07a1 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median error.pdf", replace 
...
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths, average median error", size(small) color(black)) /// 
subtitle("Saint Vincent and the Grenadines, all Models, forecast only; smoothed for better viewing", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "IMPE") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) legend(on)

qui graph export "graph 07a2 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 08a1 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median absolute error.pdf", replace 
...
qui graph export "graph 08a2 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 09a1 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 09a2 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10a1 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median absolute percent error.pdf", replace 
...
qui graph export "graph 10a2 Saint Vincent and the Grenadines ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
subtitle("Over updates and calendar months; forecast only; Saint Vincent and the Grenadines", size(small)) /// 
legend(region(lcolor(none))) legend(bexpand) ///
legend(position(6) order(1 "IMPE") size(small) row(1)) legend(on)

qui graph export "graph 12a Saint Vincent and the Grenadines ALL MODELS C19 daily deaths Average Mean Error.pdf", replace
...
qui graph export "graph 12b Saint Vincent and the Grenadines ALL MODELS C19 daily deaths Average Absolute Error.pdf", replace
...
qui graph export "graph 12c Saint Vincent and the Grenadines ALL MODELS C19 daily deaths Average Percent Error.pdf", replace
...
qui graph export "graph 12d Saint Vincent and the Grenadines ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf", replace
...
save "ALL MODELS Saint Vincent and the Grenadines error.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Saint Vincent and the Grenadines error data dictionary.csv", replace 
...
use "ALL MODELS Saint Vincent and the Grenadines error.dta", clear

save "ALL MODELS Saint Vincent and the Grenadines error - only models across error measures.dta", replace
...
save "CovidLongitudinal Saint Vincent and the Grenadines merge temp.dta", replace 
...
qui graph export "graph 13a Saint Vincent and the Grenadines ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Saint Vincent and the Grenadines error - only models across error measures data dictionary.csv", replace 
...
use "CovidLongitudinal Saint Vincent and the Grenadines merge temp.dta", clear 
...
qui graph export "graph 13b Saint Vincent and the Grenadines ALL MODELS C19 daily deaths, error measures across models.pdf", replace
...
gen country = "Saint Vincent and the Grenadines"
...
save "ALL MODELS Saint Vincent and the Grenadines error - only error measures across models.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Saint Vincent and the Grenadines error - only error measures across models data dictionary.csv", replace 
...
view "log CovidLongitudinal Saint Vincent and the Grenadines 9 Merge.smcl"
