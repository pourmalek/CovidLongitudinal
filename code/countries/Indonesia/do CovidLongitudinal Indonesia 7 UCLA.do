...
log using "log CovidLongitudinal Indonesia 7 UCLA.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Indonesia 7 UCLA.do"
...
* input data files: "UCLA Indonesia.dta"
* output data files: "UCLA Indonesia error.dta" (with error measures saved)

* output data dictionary files: "UCLA Indonesia error data dictionary.csv"
...
** graphs:
* "graph 03 Indonesia UCLA C19 daily deaths error.pdf"
* "graph 04 Indonesia UCLA C19 daily deaths absolute error.pdf"
* "graph 05 Indonesia UCLA C19 daily deaths percent error.pdf"
* "graph 06 Indonesia UCLA C19 daily deaths absolute percent error.pdf"

* "graph 07 Indonesia UCLA C19 daily deaths average median error.pdf"
* "graph 08 Indonesia UCLA C19 daily deaths average median absolute error.pdf"
* "graph 09 Indonesia UCLA C19 daily deaths average median percent error.pdf"
* "graph 10 Indonesia UCLA C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Indonesia UCLA C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Indonesia
                                                            // <<-- modify 3
...
qui replace DDAbsErrUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Indonesia
...
qui replace DDPerErrUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Indonesia
...
qui replace DDAbPeErUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Indonesia
...
qui replace DDErrorUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Indonesia
...
qui replace DDAbsErrUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Indonesia
...
qui replace DDPerErrUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Indonesia
...
qui replace DDAbPeErUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Indonesia
...
qui replace DDErrorUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Indonesia
...
qui replace DDAbsErrUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Indonesia
...
qui replace DDPerErrUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Indonesia
...
qui replace DDAbPeErUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Indonesia
...
subtitle("Indonesia, UCLA, all updates, forecast only", size(small)) 

qui graph export "graph 03 Indonesia UCLA C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Indonesia UCLA C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Indonesia UCLA C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Indonesia UCLA C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Indonesia, UCLA, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Indonesia UCLA C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Indonesia UCLA C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Indonesia UCLA C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Indonesia UCLA C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Indonesia, UCLA, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Indonesia UCLA C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "UCLA Indonesia error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "UCLA Indonesia error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Indonesia 7 UCLA.smcl"
