...
log using "log CovidLongitudinal Turkey 8 YYGU.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Turkey 8 YYGU.do"
...
* input data files: "YYGU Turkey.dta"
* output data files: "YYGU Turkey error.dta" (with error measures saved)

* output data dictionary files: "YYGU Turkey error data dictionary.csv"
...
** graphs:
* "graph 03 Turkey YYGU C19 daily deaths error.pdf"
* "graph 04 Turkey YYGU C19 daily deaths absolute error.pdf"
* "graph 05 Turkey YYGU C19 daily deaths percent error.pdf"
* "graph 06 Turkey YYGU C19 daily deaths absolute percent error.pdf"

* "graph 07 Turkey YYGU C19 daily deaths average median error.pdf"
* "graph 08 Turkey YYGU C19 daily deaths average median absolute error.pdf"
* "graph 09 Turkey YYGU C19 daily deaths average median percent error.pdf"
* "graph 10 Turkey YYGU C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Turkey YYGU C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorYYGU`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Turkey
                                                            // <<-- modify 3
...
qui replace DDAbsErrYYGU`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Turkey
...
qui replace DDPerErrYYGU`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Turkey
...
qui replace DDAbPeErYYGU`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Turkey
...
qui replace DDErrorYYGU`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Turkey
...
qui replace DDAbsErrYYGU`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Turkey
...
qui replace DDPerErrYYGU`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Turkey
...
qui replace DDAbPeErYYGU`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Turkey
...
qui replace DDErrorYYGU_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Turkey
...
qui replace DDAbsErrYYGU_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Turkey
...
qui replace DDPerErrYYGU_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Turkey
...
qui replace DDAbPeErYYGU_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Turkey
...
subtitle("Turkey, YYGU, all updates, forecast only", size(small)) 

qui graph export "graph 03 Turkey YYGU C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Turkey YYGU C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Turkey YYGU C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Turkey YYGU C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Turkey, YYGU, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Turkey YYGU C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Turkey YYGU C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Turkey YYGU C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Turkey YYGU C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Turkey, YYGU, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Turkey YYGU C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "YYGU Turkey error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "YYGU Turkey error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Turkey 8 YYGU.smcl"
