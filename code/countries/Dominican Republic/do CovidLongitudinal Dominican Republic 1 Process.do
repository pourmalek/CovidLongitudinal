...
log using "log CovidLongitudinal Dominican Republic 1 Process.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Dominican Republic 1 Process.do"
...
**** "do CovidLongitudinal Dominican Republic 1 Process.do"
...
** output data files: "`model' Dominican Republic.dta"
**                   "ALL MODLES Dominican Republic.dta"

** output data dictionary files: "Dominican Republic ALL MODELS update dates data dictionary.csv"
**                               "`model' Dominican Republic data dictionary.csv"
**                               "ALL MODLES Dominican Republic data dictionary.csv"

** graphs:
** "graph 02 Dominican Republic `model' C19 daily deaths all updates.pdf"
** "graph 02 Dominican Republic ALL MODELS C19 daily deaths all updates.pdf"
...
local list DELP IHME IMPE LANL YYGU

foreach model of local list {

	use "$pathCovidLongitudinal/download/`model'/`model' countries long.dta", clear 
	
	di in red "`model'" " Dominican Republic absent update_date_block"
	
	qui keep if loc_grand_name == "Dominican Republic"
	...
	save "Dominican Republic `model' update dates.dta", replace
...
use "Dominican Republic DELP update dates.dta", clear 

local list DELP IHME IMPE LANL YYGU

foreach model of local list {
	
	append using "Dominican Republic `model' update dates.dta"
...
save "Dominican Republic ALL MODELS update dates.dta", replace
	
export excel using "Dominican Republic ALL MODELS update dates.xlsx", replace firstrow(variables) 
...
preserve
    ...
    export delimited name varlab using "Dominican Republic ALL MODELS update dates data dictionary.csv", replace 
...
keep if loc_grand_name == "Dominican Republic"

keep date DayDeaMeSmJOHNDOM
...
save "JOHN Dominican Republic.dta", replace 




* graph Dominican Republic JOHN daily deaths

twoway ///
(line DayDeaMeSmJOHNDOM date, sort lwidth(thick) lcolor(cyan)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, Dominican Republic, JOHN", size(medium) color(black)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Dominican Republic JOHN C19 daily deaths reported.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "DELP `update' Dominican Republic.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "DELP `update' Dominican Republic.dta"
...
save "DELP Dominican Republic.dta", replace
...
merge m:m date using "JOHN Dominican Republic.dta"
...
preserve
    ...
    export delimited name varlab using "DELP Dominican Republic data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Dominican Republic DELP daily deaths each update 
	...
	subtitle("Dominican Republic, forecast only") legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Dominican Republic DELP daily deaths update `update'.pdf", replace	
...
* graph Dominican Republic DELP daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Dominican Republic, DELP, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Dominican Republic DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* graph Dominican Republic IHME daily deaths epoch each update 
	...
	ytitle(Daily deaths) title("C19 daily deaths, Dominican Republic, IHME, update `update'", size(medium) color(black)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	...
	*/
	...
	/* qui graph export "graph 00 Dominican Republic IHME daily deaths epoch `update'.pdf", replace */
	...
	save "IHME `update' Dominican Republic.dta", replace emptyok	
...
foreach update of local list {
	...
	merge m:m date using "IHME `update' Dominican Republic.dta"
...
save "IHME Dominican Republic.dta", replace
...
merge m:1 date using "JOHN Dominican Republic.dta"
...
preserve
    ...
    export delimited name varlab using "IHME Dominican Republic data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Dominican Republic IHME daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Dominican Republic, forecast only") legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Dominican Republic IHME daily deaths update `update'.pdf", replace	
...
* graph Dominican Republic IHME daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Dominican Republic, IHME, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Dominican Republic IHME C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only
	...
	save "IMPE `update' Dominican Republic.dta", replace emptyok
...
foreach update of local list {
	...
	merge m:m date using "IMPE `update' Dominican Republic.dta"
...
save "IMPE Dominican Republic.dta", replace
...
preserve
    ...
    export delimited name varlab using "IMPE Dominican Republic data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Dominican Republic IMPE daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Dominican Republic, forecast only") legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Dominican Republic IMPE daily deaths update `update'.pdf", replace	
...
* graph Dominican Republic IMPE daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Dominican Republic, IMPE, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Dominican Republic IMPE C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "LANL `update' Dominican Republic.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "LANL `update' Dominican Republic.dta"
...
save "LANL Dominican Republic.dta", replace
...
preserve
    ...
    export delimited name varlab using "LANL Dominican Republic data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Dominican Republic LANL daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Dominican Republic, forecast only") legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Dominican Republic LANL daily deaths update `update'.pdf", replace	
...
* graph Dominican Republic LANL daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Dominican Republic, LANL, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Dominican Republic LANL C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen FORE, that is forecast only 
	...
	save "YYGU `update' Dominican Republic.dta", replace 
	
	/* line DayDeaMeRaYYGU`update' DayDeaMeSmYYGU`update' DayDeaMeFoYYGU`update' date

	qui graph export "YYGU `update' Dominican Republic.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "YYGU `update' Dominican Republic.dta"
...
save "YYGU Dominican Republic.dta", replace
...
preserve
    ...
    export delimited name varlab using "YYGU Dominican Republic data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Dominican Republic YYGU daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Dominican Republic, forecast only") legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Dominican Republic YYGU daily deaths update `update'.pdf", replace	
...
* graph Dominican Republic YYGU daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Dominican Republic, YYGU, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Dominican Republic YYGU C19 daily deaths all updates.pdf", replace
...
local list IHME IMPE LANL YYGU

use "DELP Dominican Republic.dta", clear

foreach model of local list {

	merge m:m date loc_grand_name using "`model' Dominican Republic.dta", force
...
save "ALL MODLES Dominican Republic.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODLES Dominican Republic data dictionary.csv", replace 
...
* graph Dominican Republic ALL MODELS daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Dominican Republic, all models, all updates, forecast only", size(medium) color(black)) ///
legend(position(6) order(826 "JOHN" 1 "DELP" 24 "IHME" 4 "IMPE" 3 "LANL" 26 "YYGU") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Dominican Republic ALL MODELS C19 daily deaths all updates.pdf", replace
...
view "log CovidLongitudinal Dominican Republic 1 Process.smcl"
