...
log using "log CovidLongitudinal Luxembourg 9 Merge.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Luxembourg 9 Merge.do"
...
** input data files: "`model' Luxembourg error.dta"

** output data files: "ALL MODELS Luxembourg error.dta" with all date
*                     "ALL MODELS Luxembourg error - only models across error measures.dta", replace
*                     "ALL MODELS Luxembourg error - only error measures across models.dta", replace

* output data dictionary files: "ALL MODELS Luxembourg error data dictionary.csv"
*                               "ALL MODELS Luxembourg error - only models across error measures data dictionary.csv"
*                               "ALL MODELS Luxembourg error - only error measures across models data dictionary.csv"


** Graphs:
* "graph 03 Luxembourg ALL MODELS C19 daily deaths error.pdf"
* "graph 04 Luxembourg ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 05 Luxembourg ALL MODELS C19 daily deaths percent error.pdf"
* "graph 06 Luxembourg ALL MODELS C19 daily deaths absolute percent error.pdf"

* "graph 07a1 Luxembourg ALL MODELS C19 daily deaths average median error.pdf"
* "graph 07a2 Luxembourg ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 08a1 Luxembourg ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 08a2 Luxembourg ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 09a1 Luxembourg ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 09a2 Luxembourg ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10a1 Luxembourg ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10a2 Luxembourg ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"

****** graph each same error measure across models:
* "graph 12a Luxembourg ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 12b Luxembourg ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 12c Luxembourg ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 12d Luxembourg ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"

****** graph all models across error measures:
* "graph 13a Luxembourg ALL MODELS C19 daily deaths, models across error measures.pdf"

****** graph all error measures across models:
* "graph 13b Luxembourg ALL MODELS C19 daily deaths, error measures across models.pdf"
...
use "DELP Luxembourg error.dta", clear 

	merge m:m date using "IHME Luxembourg error.dta"

	drop _merge
	
	merge m:m date using "IMPE Luxembourg error.dta"
	
	drop _merge
	
	merge m:m date using "LANL Luxembourg error.dta"	
	
	drop _merge
	
	merge m:m date using "YYGU Luxembourg error.dta", force	
...
subtitle("Luxembourg, all Models, all updates, forecast only", size(small)) ///
legend(position(6) order(19 "DELP" 1 "IHME" 107 "IMPE" 36 "LANL" 3 "YYGU") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 03 Luxembourg ALL MODELS C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Luxembourg ALL MODELS C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Luxembourg ALL MODELS C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Luxembourg ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Luxembourg, all Models, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "YYGU") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 07a1 Luxembourg ALL MODELS C19 daily deaths average median error.pdf", replace 
...
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths, average median error", size(medium) color(black)) /// 
subtitle("Luxembourg, all Models, forecast only; smoothed for better viewing", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "YYGU") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 07a2 Luxembourg ALL MODELS C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 08a1 Luxembourg ALL MODELS C19 daily deaths average median absolute error.pdf", replace 
...
qui graph export "graph 08a2 Luxembourg ALL MODELS C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 09a1 Luxembourg ALL MODELS C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 09a2 Luxembourg ALL MODELS C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10a1 Luxembourg ALL MODELS C19 daily deaths average median absolute percent error.pdf", replace 
...
qui graph export "graph 10a2 Luxembourg ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
blabel(bar, size(vsmall) color(white) position(inside) orientation(vertical) format(%30.1fc)) ///
ytitle("Average Mean Error") yscale(titlegap(2)) ylabel(, labsize(small) angle(forty_five) format(%30.1fc)) ///
title("C19 daily deaths average of Mean Error", size(medium) color(black)) ///
subtitle("Over updates and calendar months; forecast only; Luxembourg", size(small)) /// 
legend(region(lcolor(none))) legend(bexpand) ///
legend(position(6) order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "YYGU") size(small) row(1)) 

qui graph export "graph 12a Luxembourg ALL MODELS C19 daily deaths Average Mean Error.pdf", replace
...
bar(5, fcolor(gold) lcolor(gold)) ///
blabel(bar, size(vsmall) color(white) position(inside) orientation(vertical) format(%30.1fc)) ///
ytitle("Average Absolute Error") yscale(titlegap(2)) ylabel(, labsize(small) angle(forty_five) format(%30.1fc)) ///
title("C19 daily deaths average of Absolute Error", size(medium) color(black)) ///
subtitle("Over updates and calendar months; forecast only; Luxembourg", size(small)) /// 
legend(region(lcolor(none))) legend(bexpand) ///
legend(position(6) order(1 "DELP" 2 "IHME" 3 "IMPE" 4 "LANL" 5 "YYGU") size(small) row(1)) 

qui graph export "graph 12b Luxembourg ALL MODELS C19 daily deaths Average Absolute Error.pdf", replace
...
qui graph export "graph 12c Luxembourg ALL MODELS C19 daily deaths Average Percent Error.pdf", replace
...
qui graph export "graph 12d Luxembourg ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf", replace
...
save "ALL MODELS Luxembourg error.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Luxembourg error data dictionary.csv", replace 
...
use "ALL MODELS Luxembourg error.dta", clear

save "ALL MODELS Luxembourg error - only models across error measures.dta", replace
...
save "CovidLongitudinal Luxembourg merge temp.dta", replace 
...
qui graph export "graph 13a Luxembourg ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Luxembourg error - only models across error measures data dictionary.csv", replace 
...
use "CovidLongitudinal Luxembourg merge temp.dta", clear 
...
qui graph export "graph 13b Luxembourg ALL MODELS C19 daily deaths, error measures across models.pdf", replace
...
save "ALL MODELS Luxembourg error - only error measures across models.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS Luxembourg error - only error measures across models data dictionary.csv", replace 
...
view "log CovidLongitudinal Luxembourg 9 Merge.smcl"
