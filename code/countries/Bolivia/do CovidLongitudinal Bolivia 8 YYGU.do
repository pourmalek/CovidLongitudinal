...
log using "log CovidLongitudinal Bolivia 8 YYGU.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Bolivia 8 YYGU.do"
...
* input data files: "YYGU Bolivia.dta"
* output data files: "YYGU Bolivia error.dta" (with error measures saved)

* output data dictionary files: "YYGU Bolivia error data dictionary.csv"
...
** graphs:
* "graph 03 Bolivia YYGU C19 daily deaths error.pdf"
* "graph 04 Bolivia YYGU C19 daily deaths absolute error.pdf"
* "graph 05 Bolivia YYGU C19 daily deaths percent error.pdf"
* "graph 06 Bolivia YYGU C19 daily deaths absolute percent error.pdf"

* "graph 07 Bolivia YYGU C19 daily deaths average median error.pdf"
* "graph 08 Bolivia YYGU C19 daily deaths average median absolute error.pdf"
* "graph 09 Bolivia YYGU C19 daily deaths average median percent error.pdf"
* "graph 10 Bolivia YYGU C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Bolivia YYGU C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorYYGU`update' = . if date < td(26may2020) // 26may2020 is the earliest date of YYGU forecasts for Bolivia
                                                            // <<-- modify 3
...
qui replace DDAbsErrYYGU`update' = . if date < td(26may2020) // 26may2020 is the earliest date of YYGU forecasts for Bolivia
...
qui replace DDPerErrYYGU`update' = . if date < td(26may2020) // 26may2020 is the earliest date of YYGU forecasts for Bolivia
...
qui replace DDAbPeErYYGU`update' = . if date < td(26may2020) // 26may2020 is the earliest date of YYGU forecasts for Bolivia
...
qui replace DDErrorYYGU`update'_Med1 = . if date < td(26may2020) // 26may2020 is the earliest date of YYGU forecasts for Bolivia
...
qui replace DDAbsErrYYGU`update'_Med1 = . if date < td(26may2020) // 26may2020 is the earliest date of YYGU forecasts for Bolivia
...
qui replace DDPerErrYYGU`update'_Med1 = . if date < td(26may2020) // 26may2020 is the earliest date of YYGU forecasts for Bolivia
...
qui replace DDAbPeErYYGU`update'_Med1 = . if date < td(26may2020) // 26may2020 is the earliest date of YYGU forecasts for Bolivia
...
qui replace DDErrorYYGU_Mean1 = . if date < td(26may2020) // 26may2020 is the earliest date of YYGU forecasts for Bolivia
...
qui replace DDAbsErrYYGU_Mean1 = . if date < td(26may2020) // 26may2020 is the earliest date of YYGU forecasts for Bolivia
...
qui replace DDPerErrYYGU_Mean1 = . if date < td(26may2020) // 26may2020 is the earliest date of YYGU forecasts for Bolivia
...
qui replace DDAbPeErYYGU_Mean1 = . if date < td(26may2020) // 26may2020 is the earliest date of YYGU forecasts for Bolivia
...
subtitle("Bolivia, YYGU, all updates, forecast only", size(small)) 

qui graph export "graph 03 Bolivia YYGU C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Bolivia YYGU C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Bolivia YYGU C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Bolivia YYGU C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Bolivia, YYGU, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Bolivia YYGU C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Bolivia YYGU C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Bolivia YYGU C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Bolivia YYGU C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Bolivia, YYGU, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Bolivia YYGU C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "YYGU Bolivia error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "YYGU Bolivia error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Bolivia 8 YYGU.smcl"
