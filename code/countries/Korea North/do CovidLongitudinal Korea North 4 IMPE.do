...
log using "log CovidLongitudinal Korea North 4 IMPE.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Korea North 4 IMPE.do"
...
* input data files: "IMPE Korea North.dta"
* output data files: "IMPE Korea North error.dta" (with error measures saved)

* output data dictionary files: "IMPE Korea North error data dictionary.csv"
...
** graphs:
* "graph 03 Korea North IMPE C19 daily deaths error.pdf"
* "graph 04 Korea North IMPE C19 daily deaths absolute error.pdf"
* "graph 05 Korea North IMPE C19 daily deaths percent error.pdf"
* "graph 06 Korea North IMPE C19 daily deaths absolute percent error.pdf"

* "graph 07 Korea North IMPE C19 daily deaths average median error.pdf"
* "graph 08 Korea North IMPE C19 daily deaths average median absolute error.pdf"
* "graph 09 Korea North IMPE C19 daily deaths average median percent error.pdf"
* "graph 10 Korea North IMPE C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Korea North IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
use "IMPE Korea North.dta", clear 
...
qui replace DDErrorIMPE`update' = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Korea North
                                                            // <<-- modify 3
...
qui replace DDAbsErrIMPE`update' = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Korea North
...
qui replace DDPerErrIMPE`update' = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Korea North
...
qui replace DDAbPeErIMPE`update' = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Korea North
...
qui replace DDErrorIMPE`update'_Med1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Korea North
...
qui replace DDAbsErrIMPE`update'_Med1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Korea North
...
qui replace DDPerErrIMPE`update'_Med1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Korea North
...
qui replace DDAbPeErIMPE`update'_Med1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Korea North
...
egen DDErrorIMPE_Mean1 = rowmean(DDErrorIMPE20220901_Med1-DDErrorIMPE20201025_Med1) // <<-- modify 5
...
qui replace DDErrorIMPE_Mean1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Korea North
...
egen DDAbsErrIMPE_Mean1 = rowmean(DDAbsErrIMPE20220901_Med1-DDAbsErrIMPE20201025_Med1) // <<-- modify 7
...
qui replace DDAbsErrIMPE_Mean1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Korea North
...
egen DDPerErrIMPE_Mean1 = rowmean(DDPerErrIMPE20220901_Med1-DDPerErrIMPE20201025_Med1) // <<-- modify 9
...
qui replace DDPerErrIMPE_Mean1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Korea North
...
egen DDAbPeErIMPE_Mean1 = rowmean(DDAbPeErIMPE20220901_Med1-DDAbPeErIMPE20201025_Med1) // <<-- modify 11
...
qui replace DDAbPeErIMPE_Mean1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Korea North
...
subtitle("Korea North, IMPE, all updates, forecast only", size(small)) 

qui graph export "graph 03 Korea North IMPE C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Korea North IMPE C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Korea North IMPE C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Korea North IMPE C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Korea North, IMPE, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Korea North IMPE C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Korea North IMPE C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Korea North IMPE C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Korea North IMPE C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Korea North, IMPE, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Korea North IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IMPE Korea North error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IMPE Korea North error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Korea North 4 IMPE.smcl"
