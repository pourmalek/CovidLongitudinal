...
log using "log CovidLongitudinal Germany 7 UCLA.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Germany 7 UCLA.do"
...
* input data files: "UCLA Germany.dta"
* output data files: "UCLA Germany error.dta" (with error measures saved)

* output data dictionary files: "UCLA Germany error data dictionary.csv"
...
** graphs:
* "graph 03 Germany UCLA C19 daily deaths error.pdf"
* "graph 04 Germany UCLA C19 daily deaths absolute error.pdf"
* "graph 05 Germany UCLA C19 daily deaths percent error.pdf"
* "graph 06 Germany UCLA C19 daily deaths absolute percent error.pdf"

* "graph 07 Germany UCLA C19 daily deaths average median error.pdf"
* "graph 08 Germany UCLA C19 daily deaths average median absolute error.pdf"
* "graph 09 Germany UCLA C19 daily deaths average median percent error.pdf"
* "graph 10 Germany UCLA C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Germany UCLA C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Germany
                                                            // <<-- modify 3
...
qui replace DDAbsErrUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Germany
...
qui replace DDPerErrUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Germany
...
qui replace DDAbPeErUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Germany
...
qui replace DDErrorUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Germany
...
qui replace DDAbsErrUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Germany
...
qui replace DDPerErrUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Germany
...
qui replace DDAbPeErUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Germany
...
qui replace DDErrorUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Germany
...
qui replace DDAbsErrUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Germany
...
qui replace DDPerErrUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Germany
...
qui replace DDAbPeErUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for Germany
...
subtitle("Germany, UCLA, all updates, forecast only", size(small)) 

qui graph export "graph 03 Germany UCLA C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Germany UCLA C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Germany UCLA C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Germany UCLA C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Germany, UCLA, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Germany UCLA C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Germany UCLA C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Germany UCLA C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Germany UCLA C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Germany, UCLA, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Germany UCLA C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "UCLA Germany error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "UCLA Germany error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Germany 7 UCLA.smcl"
