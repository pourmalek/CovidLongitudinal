...
log using "log CovidLongitudinal San Marino 9 Merge.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal San Marino 9 Merge.do"
...
** input data files: "`model' San Marino error.dta"

** output data files: "ALL MODELS San Marino error.dta" with all date
*                     "ALL MODELS San Marino error - only models across error measures.dta", replace
*                     "ALL MODELS San Marino error - only error measures across models.dta", replace

* output data dictionary files: "ALL MODELS San Marino error data dictionary.csv"
*                               "ALL MODELS San Marino error - only models across error measures data dictionary.csv"
*                               "ALL MODELS San Marino error - only error measures across models data dictionary.csv"


** Graphs:
* "graph 03 San Marino ALL MODELS C19 daily deaths error.pdf"
* "graph 04 San Marino ALL MODELS C19 daily deaths absolute error.pdf"
* "graph 05 San Marino ALL MODELS C19 daily deaths percent error.pdf"
* "graph 06 San Marino ALL MODELS C19 daily deaths absolute percent error.pdf"

* "graph 07a1 San Marino ALL MODELS C19 daily deaths average median error.pdf"
* "graph 07a2 San Marino ALL MODELS C19 daily deaths average median error smoothed.pdf"
* "graph 08a1 San Marino ALL MODELS C19 daily deaths average median absolute error.pdf"
* "graph 08a2 San Marino ALL MODELS C19 daily deaths average median absolute error smoothed.pdf"
* "graph 09a1 San Marino ALL MODELS C19 daily deaths average median percent error.pdf"
* "graph 09a2 San Marino ALL MODELS C19 daily deaths average median percent error smoothed.pdf"
* "graph 10a1 San Marino ALL MODELS C19 daily deaths average median absolute percent error.pdf"
* "graph 10a2 San Marino ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf"

****** graph each same error measure across models:
* "graph 12a San Marino ALL MODELS C19 daily deaths Average Mean Error.pdf"
* "graph 12b San Marino ALL MODELS C19 daily deaths Average Absolute Error.pdf"
* "graph 12c San Marino ALL MODELS C19 daily deaths Average Percent Error.pdf"
* "graph 12d San Marino ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf"

****** graph all models across error measures:
* "graph 13a San Marino ALL MODELS C19 daily deaths, models across error measures.pdf"

****** graph all error measures across models:
* "graph 13b San Marino ALL MODELS C19 daily deaths, error measures across models.pdf"
...
use "DELP San Marino error.dta", clear 

	merge m:m date using "IHME San Marino error.dta"

	drop _merge
	
	merge m:m date using "LANL San Marino error.dta"	
...
subtitle("San Marino, all Models, all updates, forecast only", size(small)) ///
legend(position(6) order(1 "DELP" 29 "IHME" 3 "LANL") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 03 San Marino ALL MODELS C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 San Marino ALL MODELS C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 San Marino ALL MODELS C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 San Marino ALL MODELS C19 daily deaths absolute percent error.pdf", replace
...
subtitle("San Marino, all Models, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "DELP" 2 "IHME" 3 "LANL") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 07a1 San Marino ALL MODELS C19 daily deaths average median error.pdf", replace 
...
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.1fc)) ///
ytitle(Daily deaths error measure) title("C19 daily deaths, average median error", size(medium) color(black)) /// 
subtitle("San Marino, all Models, forecast only; smoothed for better viewing", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) yscale(titlegap(3)) ///
legend(position(6) order(1 "DELP" 2 "IHME" 3 "LANL") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand)

qui graph export "graph 07a2 San Marino ALL MODELS C19 daily deaths average median error smoothed.pdf", replace
...
qui graph export "graph 08a1 San Marino ALL MODELS C19 daily deaths average median absolute error.pdf", replace 
...
qui graph export "graph 08a2 San Marino ALL MODELS C19 daily deaths average median absolute error smoothed.pdf", replace
...
qui graph export "graph 09a1 San Marino ALL MODELS C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 09a2 San Marino ALL MODELS C19 daily deaths average median percent error smoothed.pdf", replace
...
qui graph export "graph 10a1 San Marino ALL MODELS C19 daily deaths average median absolute percent error.pdf", replace 
...
qui graph export "graph 10a2 San Marino ALL MODELS C19 daily deaths average median absolute percent error smoothed.pdf", replace
...
subtitle("Over updates and calendar months; forecast only; San Marino", size(small)) /// 
legend(region(lcolor(none))) legend(bexpand) ///
legend(position(6) order(1 "DELP" 2 "IHME" 3 "LANL") size(small) row(1)) 

qui graph export "graph 12a San Marino ALL MODELS C19 daily deaths Average Mean Error.pdf", replace
...
qui graph export "graph 12b San Marino ALL MODELS C19 daily deaths Average Absolute Error.pdf", replace
...
qui graph export "graph 12c San Marino ALL MODELS C19 daily deaths Average Percent Error.pdf", replace
...
qui graph export "graph 12d San Marino ALL MODELS C19 daily deaths Average Absolute Percent Error.pdf", replace
...
save "ALL MODELS San Marino error.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS San Marino error data dictionary.csv", replace 
...
use "ALL MODELS San Marino error.dta", clear

save "ALL MODELS San Marino error - only models across error measures.dta", replace
...
rename ///
(DDErrorDELP_Mean2 DDErrorIHME_Mean2 DDErrorLANL_Mean2) ///
(DDErrorrDELP_Mean2 DDErrorrIHME_Mean2 DDErrorrLANL_Mean2) 
...
save "CovidLongitudinal San Marino merge temp.dta", replace 
...
qui graph export "graph 13a San Marino ALL MODELS C19 daily deaths, models across error measures.pdf", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS San Marino error - only models across error measures data dictionary.csv", replace 
...
use "CovidLongitudinal San Marino merge temp.dta", clear 
...
rename (DDErrorrDELP DDErrorrIHME DDErrorrLANL) ///
...
rename (DDAbsErrDELP DDAbsErrIHME DDAbsErrLANL) ///
...
rename (DDPerErrDELP DDPerErrIHME DDPerErrLANL) ///
...
rename (DDAbPeErDELP DDAbPeErIHME DDAbPeErLANL) ///
...
qui graph export "graph 13b San Marino ALL MODELS C19 daily deaths, error measures across models.pdf", replace
...
rename (DDA1E1 DDA2E1 DDA3E1) ///
       (DD_DELP_Errorr DD_IHME_Errorr DD_LANL_Errorr)
...
rename (DDA1E2 DDA2E2 DDA3E2) ///
       (DD_DELP_AbsErr DD_IHME_AbsErr DD_LANL_AbsErr)
...
rename (DDA1E3 DDA2E3 DDA3E3) ///
       (DD_DELP_PerErr DD_IHME_PerErr DD_LANL_PerErr)
...
(DD_DELP_AbPeEr DD_IHME_AbPeEr DD_LANL_AbPeEr)
...
save "ALL MODELS San Marino error - only error measures across models.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODELS San Marino error - only error measures across models data dictionary.csv", replace 
...
view "log CovidLongitudinal San Marino 9 Merge.smcl"
