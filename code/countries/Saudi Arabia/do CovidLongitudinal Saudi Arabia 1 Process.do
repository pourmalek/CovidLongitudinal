...
log using "log CovidLongitudinal Saudi Arabia 1 Process.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Saudi Arabia 1 Process.do"
...
**** "do CovidLongitudinal Saudi Arabia 1 Process.do"
...
** output data files: "`model' Saudi Arabia.dta"
**                   "ALL MODLES Saudi Arabia.dta"

** output data dictionary files: "Saudi Arabia ALL MODELS update dates data dictionary.csv"
**                               "`model' Saudi Arabia data dictionary.csv"
**                               "ALL MODLES Saudi Arabia data dictionary.csv"

** graphs:
** "graph 02 Saudi Arabia `model' C19 daily deaths all updates.pdf"
** "graph 02 Saudi Arabia ALL MODELS C19 daily deaths all updates.pdf"
...
foreach model of local list {
	...
	di in red "`model'" " Saudi Arabia absent update_date_block"
	
	qui keep if loc_grand_name == "Saudi Arabia"
	...
	save "Saudi Arabia `model' update dates.dta", replace
...
use "Saudi Arabia DELP update dates.dta", clear 

local list DELP IHME IMPE LANL UCLA YYGU

foreach model of local list {
	
	append using "Saudi Arabia `model' update dates.dta"
...
save "Saudi Arabia ALL MODELS update dates.dta", replace
	
export excel using "Saudi Arabia ALL MODELS update dates.xlsx", replace firstrow(variables) 
...
preserve
    ...
    export delimited name varlab using "Saudi Arabia ALL MODELS update dates data dictionary.csv", replace 
...
keep if loc_grand_name == "Saudi Arabia"

keep date DayDeaMeSmJOHNSAU
...
save "JOHN Saudi Arabia.dta", replace 




* graph Saudi Arabia JOHN daily deaths

twoway ///
(line DayDeaMeSmJOHNSAU date, sort lwidth(thick) lcolor(cyan)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, Saudi Arabia, JOHN", size(medium) color(black)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Saudi Arabia JOHN C19 daily deaths reported.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "DELP `update' Saudi Arabia.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "DELP `update' Saudi Arabia.dta"
...
save "DELP Saudi Arabia.dta", replace
...
merge m:m date using "JOHN Saudi Arabia.dta"
...
preserve
    ...
    export delimited name varlab using "DELP Saudi Arabia data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Saudi Arabia DELP daily deaths each update 
	...
	subtitle("Saudi Arabia, forecast only") legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Saudi Arabia DELP daily deaths update `update'.pdf", replace	
...
* graph Saudi Arabia DELP daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Saudi Arabia, DELP, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Saudi Arabia DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* graph Saudi Arabia IHME daily deaths epoch each update 
	...
	ytitle(Daily deaths) title("C19 daily deaths, Saudi Arabia, IHME, update `update'", size(medium) color(black)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	...
	*/
	...
	/* qui graph export "graph 00 Saudi Arabia IHME daily deaths epoch `update'.pdf", replace */
	...
	save "IHME `update' Saudi Arabia.dta", replace emptyok	
...
foreach update of local list {
	...
	merge m:m date using "IHME `update' Saudi Arabia.dta"
...
save "IHME Saudi Arabia.dta", replace
...
merge m:1 date using "JOHN Saudi Arabia.dta"
...
preserve
    ...
    export delimited name varlab using "IHME Saudi Arabia data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Saudi Arabia IHME daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Saudi Arabia, forecast only") legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Saudi Arabia IHME daily deaths update `update'.pdf", replace	
...
* graph Saudi Arabia IHME daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Saudi Arabia, IHME, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Saudi Arabia IHME C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only
	...
	save "IMPE `update' Saudi Arabia.dta", replace emptyok
...
foreach update of local list {
	...
	merge m:m date using "IMPE `update' Saudi Arabia.dta"
...
save "IMPE Saudi Arabia.dta", replace
...
preserve
    ...
    export delimited name varlab using "IMPE Saudi Arabia data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Saudi Arabia IMPE daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Saudi Arabia, forecast only") legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Saudi Arabia IMPE daily deaths update `update'.pdf", replace	
...
* graph Saudi Arabia IMPE daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Saudi Arabia, IMPE, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Saudi Arabia IMPE C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "LANL `update' Saudi Arabia.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "LANL `update' Saudi Arabia.dta"
...
save "LANL Saudi Arabia.dta", replace
...
preserve
    ...
    export delimited name varlab using "LANL Saudi Arabia data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Saudi Arabia LANL daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Saudi Arabia, forecast only") legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Saudi Arabia LANL daily deaths update `update'.pdf", replace	
...
* graph Saudi Arabia LANL daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Saudi Arabia, LANL, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Saudi Arabia LANL C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only  
	...
	save "UCLA `update' Saudi Arabia.dta", replace 
	
	/* line DayDeaMeRaUCLA`update' DayDeaMeSmUCLA`update' DayDeaMeFoUCLA`update' date

	qui graph export "UCLA `update' Saudi Arabia.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "UCLA `update' Saudi Arabia.dta"
...
save "UCLA Saudi Arabia.dta", replace
...
preserve
    ...
    export delimited name varlab using "UCLA Saudi Arabia data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Saudi Arabia UCLA daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Saudi Arabia, forecast only") legend(position(6) order(1 "JOHN" 2 "UCLA forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Saudi Arabia UCLA daily deaths update `update'.pdf", replace	

}
*/


* graph Saudi Arabia UCLA daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Saudi Arabia, UCLA, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "UCLA forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Saudi Arabia UCLA C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen FORE, that is forecast only 
	...
	save "YYGU `update' Saudi Arabia.dta", replace 
	
	/* line DayDeaMeRaYYGU`update' DayDeaMeSmYYGU`update' DayDeaMeFoYYGU`update' date

	qui graph export "YYGU `update' Saudi Arabia.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "YYGU `update' Saudi Arabia.dta"
...
save "YYGU Saudi Arabia.dta", replace
...
preserve
    ...
    export delimited name varlab using "YYGU Saudi Arabia data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Saudi Arabia YYGU daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Saudi Arabia, forecast only") legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Saudi Arabia YYGU daily deaths update `update'.pdf", replace	
...
* graph Saudi Arabia YYGU daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Saudi Arabia, YYGU, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Saudi Arabia YYGU C19 daily deaths all updates.pdf", replace
...
use "DELP Saudi Arabia.dta", clear

foreach model of local list {

	merge m:m date loc_grand_name using "`model' Saudi Arabia.dta", force
...
save "ALL MODLES Saudi Arabia.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODLES Saudi Arabia data dictionary.csv", replace 
...
* graph Saudi Arabia ALL MODELS daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Saudi Arabia, all models, all updates, forecast only", size(medium) color(black)) ///
legend(position(6) order(804 "JOHN" 1 "DELP" 79 "IHME" 38 "IMPE" 3 "LANL" 319 "UCLA" 9 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Saudi Arabia ALL MODELS C19 daily deaths all updates.pdf", replace
...
view "log CovidLongitudinal Saudi Arabia 1 Process.smcl"
