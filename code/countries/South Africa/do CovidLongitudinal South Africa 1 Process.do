...
log using "log CovidLongitudinal South Africa 1 Process.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal South Africa 1 Process.do"
...
**** "do CovidLongitudinal South Africa 1 Process.do"
...
** output data files: "`model' South Africa.dta"
**                   "ALL MODLES South Africa.dta"

** output data dictionary files: "South Africa ALL MODELS update dates data dictionary.csv"
**                               "`model' South Africa data dictionary.csv"
**                               "ALL MODLES South Africa data dictionary.csv"

** graphs:
** "graph 02 South Africa `model' C19 daily deaths all updates.pdf"
** "graph 02 South Africa ALL MODELS C19 daily deaths all updates.pdf"
...
foreach model of local list {
	...
	di in red "`model'" " South Africa absent update_date_block"
	
	qui keep if loc_grand_name == "South Africa"
	...
	save "South Africa `model' update dates.dta", replace
...
use "South Africa DELP update dates.dta", clear 

local list DELP IHME IMPE LANL UCLA YYGU

foreach model of local list {
	
	append using "South Africa `model' update dates.dta"
...
save "South Africa ALL MODELS update dates.dta", replace
	
export excel using "South Africa ALL MODELS update dates.xlsx", replace firstrow(variables) 
...
preserve
    ...
    export delimited name varlab using "South Africa ALL MODELS update dates data dictionary.csv", replace 
...
keep if loc_grand_name == "South Africa"

keep date DayDeaMeSmJOHNZAF
...
save "JOHN South Africa.dta", replace 




* graph South Africa JOHN daily deaths

twoway ///
(line DayDeaMeSmJOHNZAF date, sort lwidth(thick) lcolor(cyan)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, South Africa, JOHN", size(medium) color(black)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 South Africa JOHN C19 daily deaths reported.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "DELP `update' South Africa.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "DELP `update' South Africa.dta"
...
save "DELP South Africa.dta", replace
...
merge m:m date using "JOHN South Africa.dta"
...
preserve
    ...
    export delimited name varlab using "DELP South Africa data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph South Africa DELP daily deaths each update 
	...
	subtitle("South Africa, forecast only") legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 South Africa DELP daily deaths update `update'.pdf", replace	
...
* graph South Africa DELP daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, South Africa, DELP, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 South Africa DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* graph South Africa IHME daily deaths epoch each update 
	...
	ytitle(Daily deaths) title("C19 daily deaths, South Africa, IHME, update `update'", size(medium) color(black)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	...
	*/
	...
	/* qui graph export "graph 00 South Africa IHME daily deaths epoch `update'.pdf", replace */
	...
	save "IHME `update' South Africa.dta", replace emptyok	
...
foreach update of local list {
	...
	merge m:m date using "IHME `update' South Africa.dta"
...
save "IHME South Africa.dta", replace
...
merge m:1 date using "JOHN South Africa.dta"
...
preserve
    ...
    export delimited name varlab using "IHME South Africa data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph South Africa IHME daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("South Africa, forecast only") legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 South Africa IHME daily deaths update `update'.pdf", replace	
...
* graph South Africa IHME daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, South Africa, IHME, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 South Africa IHME C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only
	...
	save "IMPE `update' South Africa.dta", replace emptyok
...
foreach update of local list {
	...
	merge m:m date using "IMPE `update' South Africa.dta"
...
save "IMPE South Africa.dta", replace
...
preserve
    ...
    export delimited name varlab using "IMPE South Africa data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph South Africa IMPE daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("South Africa, forecast only") legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 South Africa IMPE daily deaths update `update'.pdf", replace	
...
* graph South Africa IMPE daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, South Africa, IMPE, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 South Africa IMPE C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "LANL `update' South Africa.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "LANL `update' South Africa.dta"
...
save "LANL South Africa.dta", replace
...
preserve
    ...
    export delimited name varlab using "LANL South Africa data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph South Africa LANL daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("South Africa, forecast only") legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 South Africa LANL daily deaths update `update'.pdf", replace	
...
* graph South Africa LANL daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, South Africa, LANL, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 South Africa LANL C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only  
	...
	save "UCLA `update' South Africa.dta", replace 
	
	/* line DayDeaMeRaUCLA`update' DayDeaMeSmUCLA`update' DayDeaMeFoUCLA`update' date

	qui graph export "UCLA `update' South Africa.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "UCLA `update' South Africa.dta"
...
save "UCLA South Africa.dta", replace
...
preserve
    ...
    export delimited name varlab using "UCLA South Africa data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph South Africa UCLA daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("South Africa, forecast only") legend(position(6) order(1 "JOHN" 2 "UCLA forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 South Africa UCLA daily deaths update `update'.pdf", replace	

}
*/


* graph South Africa UCLA daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, South Africa, UCLA, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "UCLA forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 South Africa UCLA C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen FORE, that is forecast only 
	...
	save "YYGU `update' South Africa.dta", replace 
	
	/* line DayDeaMeRaYYGU`update' DayDeaMeSmYYGU`update' DayDeaMeFoYYGU`update' date

	qui graph export "YYGU `update' South Africa.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "YYGU `update' South Africa.dta"
...
save "YYGU South Africa.dta", replace
...
preserve
    ...
    export delimited name varlab using "YYGU South Africa data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph South Africa YYGU daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("South Africa, forecast only") legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 South Africa YYGU daily deaths update `update'.pdf", replace	
...
* graph South Africa YYGU daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, South Africa, YYGU, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 South Africa YYGU C19 daily deaths all updates.pdf", replace
...
use "DELP South Africa.dta", clear

foreach model of local list {

	merge m:m date loc_grand_name using "`model' South Africa.dta", force
...
save "ALL MODLES South Africa.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODLES South Africa data dictionary.csv", replace 
...
* graph South Africa ALL MODELS daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, South Africa, all models, all updates, forecast only", size(medium) color(black)) ///
legend(position(6) order(842 "JOHN" 1 "DELP" 180 "IHME" 4 "IMPE" 3 "LANL" 357 "UCLA" 25 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 South Africa ALL MODELS C19 daily deaths all updates.pdf", replace
...
view "log CovidLongitudinal South Africa 1 Process.smcl"
