...
log using "log CovidLongitudinal Argentina 3 IHME.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Argentina 3 IHME.do"
...
* input data files: "IHME Argentina.dta"
* output data files: "IHME Argentina error.dta" (with error measures saved)

* output data dictionary files: "IHME Argentina error data dictionary.csv"
...
** graphs:
* "graph 03 Argentina IHME C19 daily deaths error.pdf"
* "graph 04 Argentina IHME C19 daily deaths absolute error.pdf"
* "graph 05 Argentina IHME C19 daily deaths percent error.pdf"
* "graph 06 Argentina IHME C19 daily deaths absolute percent error.pdf"

* "graph 07 Argentina IHME C19 daily deaths average median error.pdf"
* "graph 08 Argentina IHME C19 daily deaths average median absolute error.pdf"
* "graph 09 Argentina IHME C19 daily deaths average median percent error.pdf"
* "graph 10 Argentina IHME C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Argentina IHME C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
qui replace DDErrorIHME`update' = . if date < td(12may2020) // 12may2020 is the earliest date of IHME forecasts for Argentina
                                                            // <<-- modify 3
...
qui replace DDAbsErrIHME`update' = . if date < td(12may2020) // 12may2020 is the earliest date of IHME forecasts for Argentina
...
qui replace DDPerErrIHME`update' = . if date < td(12may2020) // 12may2020 is the earliest date of IHME forecasts for Argentina
...
qui replace DDAbPeErIHME`update' = . if date < td(12may2020) // 12may2020 is the earliest date of IHME forecasts for Argentina
...
qui replace DDErrorIHME`update'_Med1 = . if date < td(12may2020) // 12may2020 is the earliest date of IHME forecasts for Argentina
...
qui replace DDAbsErrIHME`update'_Med1 = . if date < td(12may2020) // 12may2020 is the earliest date of IHME forecasts for Argentina
...
qui replace DDPerErrIHME`update'_Med1 = . if date < td(12may2020) // 12may2020 is the earliest date of IHME forecasts for Argentina
...
qui replace DDAbPeErIHME`update'_Med1 = . if date < td(12may2020) // 12may2020 is the earliest date of IHME forecasts for Argentina
...
egen DDErrorIHME_Mean1 = rowmean(DDErrorIHME20221024_Med1-DDErrorIHME20200512_Med1) // <<-- modify 5
...
qui replace DDErrorIHME_Mean1 = . if date < td(12may2020) // 12may2020 is the earliest date of IHME forecasts for Argentina
...
egen DDAbsErrIHME_Mean1 = rowmean(DDAbsErrIHME20221024_Med1-DDAbsErrIHME20200512_Med1) // <<-- modify 7
...
qui replace DDAbsErrIHME_Mean1 = . if date < td(12may2020) // 12may2020 is the earliest date of IHME forecasts for Argentina
...
egen DDPerErrIHME_Mean1 = rowmean(DDPerErrIHME20221024_Med1-DDPerErrIHME20200512_Med1) // <<-- modify 9
...
qui replace DDPerErrIHME_Mean1 = . if date < td(12may2020) // 12may2020 is the earliest date of IHME forecasts for Argentina
...
egen DDAbPeErIHME_Mean1 = rowmean(DDAbPeErIHME20221024_Med1-DDAbPeErIHME20200512_Med1) // <<-- modify 11
...
qui replace DDAbPeErIHME_Mean1 = . if date < td(12may2020) // 12may2020 is the earliest date of IHME forecasts for Argentina
...
subtitle("Argentina, IHME, all updates, forecast only", size(small)) 

qui graph export "graph 03 Argentina IHME C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Argentina IHME C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Argentina IHME C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Argentina IHME C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Argentina, IHME, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Argentina IHME C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Argentina IHME C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Argentina IHME C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Argentina IHME C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Argentina, IHME, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Argentina IHME C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IHME Argentina error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IHME Argentina error data dictionary.csv", replace 
...
view "log CovidLongitudinal Argentina 3 IHME.smcl"
