...
log using "log CovidLongitudinal Bosnia and Herzegovina 1 Process.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Bosnia and Herzegovina 1 Process.do"
...
**** "do CovidLongitudinal Bosnia and Herzegovina 1 Process.do"
...
** output data files: "`model' Bosnia and Herzegovina.dta"
**                   "ALL MODLES Bosnia and Herzegovina.dta"

** output data dictionary files: "Bosnia and Herzegovina ALL MODELS update dates data dictionary.csv"
**                               "`model' Bosnia and Herzegovina data dictionary.csv"
**                               "ALL MODLES Bosnia and Herzegovina data dictionary.csv"

** graphs:
** "graph 02 Bosnia and Herzegovina `model' C19 daily deaths all updates.pdf"
** "graph 02 Bosnia and Herzegovina ALL MODELS C19 daily deaths all updates.pdf"
...
foreach model of local list {
	...
	di in red "`model'" " Bosnia and Herzegovina absent update_date_block"
	
	qui keep if loc_grand_name == "Bosnia and Herzegovina"
	...
	save "Bosnia and Herzegovina `model' update dates.dta", replace
...
use "Bosnia and Herzegovina DELP update dates.dta", clear 

local list DELP IHME IMPE LANL

foreach model of local list {
	
	append using "Bosnia and Herzegovina `model' update dates.dta"
...
save "Bosnia and Herzegovina ALL MODELS update dates.dta", replace
	
export excel using "Bosnia and Herzegovina ALL MODELS update dates.xlsx", replace firstrow(variables) 
...
preserve
    ...
    export delimited name varlab using "Bosnia and Herzegovina ALL MODELS update dates data dictionary.csv", replace 
...
keep if loc_grand_name == "Bosnia and Herzegovina"

keep date DayDeaMeSmJOHNBIH
...
save "JOHN Bosnia and Herzegovina.dta", replace 




* graph Bosnia and Herzegovina JOHN daily deaths

twoway ///
(line DayDeaMeSmJOHNBIH date, sort lwidth(thick) lcolor(cyan)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, Bosnia and Herzegovina, JOHN", size(medium) color(black)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Bosnia and Herzegovina JOHN C19 daily deaths reported.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "DELP `update' Bosnia and Herzegovina.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "DELP `update' Bosnia and Herzegovina.dta"
...
save "DELP Bosnia and Herzegovina.dta", replace
...
merge m:m date using "JOHN Bosnia and Herzegovina.dta"
...
preserve
    ...
    export delimited name varlab using "DELP Bosnia and Herzegovina data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Bosnia and Herzegovina DELP daily deaths each update 
	...
	subtitle("Bosnia and Herzegovina, forecast only") legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Bosnia and Herzegovina DELP daily deaths update `update'.pdf", replace	
...
* graph Bosnia and Herzegovina DELP daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Bosnia and Herzegovina, DELP, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Bosnia and Herzegovina DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	keep if country == "Bosnia and Herzegovina" 
	...
	* graph Bosnia and Herzegovina IHME daily deaths epoch each update 
	...
	ytitle(Daily deaths) title("C19 daily deaths, Bosnia and Herzegovina, IHME, update `update'", size(medium) color(black)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	...
	*/
	...
	/* qui graph export "graph 00 Bosnia and Herzegovina IHME daily deaths epoch `update'.pdf", replace */
	...
	save "IHME `update' Bosnia and Herzegovina.dta", replace emptyok	
...
foreach update of local list {
	...
	merge m:m date using "IHME `update' Bosnia and Herzegovina.dta"
...
save "IHME Bosnia and Herzegovina.dta", replace
...
merge m:1 date using "JOHN Bosnia and Herzegovina.dta"
...
preserve
    ...
    export delimited name varlab using "IHME Bosnia and Herzegovina data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Bosnia and Herzegovina IHME daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Bosnia and Herzegovina, forecast only") legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Bosnia and Herzegovina IHME daily deaths update `update'.pdf", replace	
...
* graph Bosnia and Herzegovina IHME daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Bosnia and Herzegovina, IHME, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Bosnia and Herzegovina IHME C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only
	...
	save "IMPE `update' Bosnia and Herzegovina.dta", replace emptyok
...
foreach update of local list {
	...
	merge m:m date using "IMPE `update' Bosnia and Herzegovina.dta"
...
save "IMPE Bosnia and Herzegovina.dta", replace
...
preserve
    ...
    export delimited name varlab using "IMPE Bosnia and Herzegovina data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Bosnia and Herzegovina IMPE daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Bosnia and Herzegovina, forecast only") legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Bosnia and Herzegovina IMPE daily deaths update `update'.pdf", replace	
...
* graph Bosnia and Herzegovina IMPE daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Bosnia and Herzegovina, IMPE, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Bosnia and Herzegovina IMPE C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "LANL `update' Bosnia and Herzegovina.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "LANL `update' Bosnia and Herzegovina.dta"
...
save "LANL Bosnia and Herzegovina.dta", replace
...
preserve
    ...
    export delimited name varlab using "LANL Bosnia and Herzegovina data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Bosnia and Herzegovina LANL daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Bosnia and Herzegovina, forecast only") legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Bosnia and Herzegovina LANL daily deaths update `update'.pdf", replace	
...
* graph Bosnia and Herzegovina LANL daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Bosnia and Herzegovina, LANL, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Bosnia and Herzegovina LANL C19 daily deaths all updates.pdf", replace
...
use "DELP Bosnia and Herzegovina.dta", clear

foreach model of local list {

	merge m:m date loc_grand_name using "`model' Bosnia and Herzegovina.dta", force
...
save "ALL MODLES Bosnia and Herzegovina.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODLES Bosnia and Herzegovina data dictionary.csv", replace 
...
* graph Bosnia and Herzegovina ALL MODELS daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Bosnia and Herzegovina, all models, all updates, forecast only", size(medium) color(black)) ///
legend(position(6) order(670 "JOHN" 1 "DELP" 73 "IHME" 4 "IMPE" 3 "LANL") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Bosnia and Herzegovina ALL MODELS C19 daily deaths all updates.pdf", replace
...
view "log CovidLongitudinal Bosnia and Herzegovina 1 Process.smcl"
