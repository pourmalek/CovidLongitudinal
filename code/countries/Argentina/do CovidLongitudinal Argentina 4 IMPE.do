...
log using "log CovidLongitudinal Argentina 4 IMPE.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Argentina 4 IMPE.do"
...
* input data files: "IMPE Argentina.dta"
* output data files: "IMPE Argentina error.dta" (with error measures saved)

* output data dictionary files: "IMPE Argentina error data dictionary.csv"
...
** graphs:
* "graph 03 Argentina IMPE C19 daily deaths error.pdf"
* "graph 04 Argentina IMPE C19 daily deaths absolute error.pdf"
* "graph 05 Argentina IMPE C19 daily deaths percent error.pdf"
* "graph 06 Argentina IMPE C19 daily deaths absolute percent error.pdf"

* "graph 07 Argentina IMPE C19 daily deaths average median error.pdf"
* "graph 08 Argentina IMPE C19 daily deaths average median absolute error.pdf"
* "graph 09 Argentina IMPE C19 daily deaths average median percent error.pdf"
* "graph 10 Argentina IMPE C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Argentina IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
Percent error = 100 * (minus (Reference minus Model)) / Reference, and zero if Error is zero

Absolute percent error = 100 * | minus (Reference minus Model) | / Reference, and zero if Absolute error is zero
...
Percent error = 100 * (- (Reference - Model)) / Reference, and zero if Error is zero

Absolute percent error = 100 * | - (Reference - Model)| / Reference, and zero if Absolute error is zero
...
qui replace DDErrorIMPE`update' = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Argentina
                                                            // <<-- modify 3
...
qui replace DDAbsErrIMPE`update' = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Argentina

capture drop DDPerErrIMPE`update'
gen DDPerErrIMPE`update' = (100 * (- (DayDeaMeSmJOHN - DayDeaMeFoIMPE`update'))) / DayDeaMeSmJOHN
replace DDPerErrIMPE`update' = 0 if DDErrorIMPE`update' == 0 // , and zero if Error is zero
...
qui replace DDPerErrIMPE`update' = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Argentina

capture drop DDAbPeErIMPE`update'
gen DDAbPeErIMPE`update' = (100 * abs(- (DayDeaMeSmJOHN - DayDeaMeFoIMPE`update'))) / DayDeaMeSmJOHN
replace DDAbPeErIMPE`update' = 0 if DDAbsErrIMPE`update' == 0 // , and zero if Absolute error is zero
...
qui replace DDAbPeErIMPE`update' = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Argentina
...
qui replace DDErrorIMPE`update'_Med1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Argentina
...
qui replace DDAbsErrIMPE`update'_Med1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Argentina
...
qui replace DDPerErrIMPE`update'_Med1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Argentina
...
qui replace DDAbPeErIMPE`update'_Med1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Argentina
...
qui replace DDErrorIMPE_Mean1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Argentina
...
qui replace DDAbsErrIMPE_Mean1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Argentina
...
qui replace DDPerErrIMPE_Mean1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Argentina
...
qui replace DDAbPeErIMPE_Mean1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Argentina
...
subtitle("Argentina, IMPE, all updates, forecast only", size(small)) 

qui graph export "graph 03 Argentina IMPE C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Argentina IMPE C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Argentina IMPE C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Argentina IMPE C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Argentina, IMPE, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Argentina IMPE C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Argentina IMPE C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Argentina IMPE C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Argentina IMPE C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Argentina, IMPE, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Argentina IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IMPE Argentina error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IMPE Argentina error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Argentina 4 IMPE.smcl"
