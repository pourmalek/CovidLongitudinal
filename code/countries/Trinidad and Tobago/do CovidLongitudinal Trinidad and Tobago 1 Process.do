...
log using "log CovidLongitudinal Trinidad and Tobago 1 Process.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Trinidad and Tobago 1 Process.do"
...
**** "do CovidLongitudinal Trinidad and Tobago 1 Process.do"
...
** output data files: "`model' Trinidad and Tobago.dta"
**                   "ALL MODLES Trinidad and Tobago.dta"

** output data dictionary files: "Trinidad and Tobago ALL MODELS update dates data dictionary.csv"
**                               "`model' Trinidad and Tobago data dictionary.csv"
**                               "ALL MODLES Trinidad and Tobago data dictionary.csv"

** graphs:
** "graph 02 Trinidad and Tobago `model' C19 daily deaths all updates.pdf"
** "graph 02 Trinidad and Tobago ALL MODELS C19 daily deaths all updates.pdf"
...
foreach model of local list {
	...
	di in red "`model'" " Trinidad and Tobago absent update_date_block"
	
	qui keep if loc_grand_name == "Trinidad and Tobago"
	...
	save "Trinidad and Tobago `model' update dates.dta", replace
...
use "Trinidad and Tobago DELP update dates.dta", clear 

local list DELP IHME IMPE LANL

foreach model of local list {
	
	append using "Trinidad and Tobago `model' update dates.dta"
...
save "Trinidad and Tobago ALL MODELS update dates.dta", replace
	
export excel using "Trinidad and Tobago ALL MODELS update dates.xlsx", replace firstrow(variables) 
...
preserve
    ...
    export delimited name varlab using "Trinidad and Tobago ALL MODELS update dates data dictionary.csv", replace 
...
keep if loc_grand_name == "Trinidad and Tobago"

keep date DayDeaMeSmJOHNTTO
...
save "JOHN Trinidad and Tobago.dta", replace 




* graph Trinidad and Tobago JOHN daily deaths

twoway ///
(line DayDeaMeSmJOHNTTO date, sort lwidth(thick) lcolor(cyan)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, Trinidad and Tobago, JOHN", size(medium) color(black)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Trinidad and Tobago JOHN C19 daily deaths reported.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "DELP `update' Trinidad and Tobago.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "DELP `update' Trinidad and Tobago.dta"
...
save "DELP Trinidad and Tobago.dta", replace
...
merge m:m date using "JOHN Trinidad and Tobago.dta"
...
preserve
    ...
    export delimited name varlab using "DELP Trinidad and Tobago data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Trinidad and Tobago DELP daily deaths each update 
	...
	subtitle("Trinidad and Tobago, forecast only") legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Trinidad and Tobago DELP daily deaths update `update'.pdf", replace	
...
* graph Trinidad and Tobago DELP daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Trinidad and Tobago, DELP, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Trinidad and Tobago DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* graph Trinidad and Tobago IHME daily deaths epoch each update 
	...
	ytitle(Daily deaths) title("C19 daily deaths, Trinidad and Tobago, IHME, update `update'", size(medium) color(black)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	...
	*/
	...
	/* qui graph export "graph 00 Trinidad and Tobago IHME daily deaths epoch `update'.pdf", replace */
	...
	save "IHME `update' Trinidad and Tobago.dta", replace emptyok	
...
foreach update of local list {
	...
	merge m:m date using "IHME `update' Trinidad and Tobago.dta"
...
save "IHME Trinidad and Tobago.dta", replace
...
merge m:1 date using "JOHN Trinidad and Tobago.dta"
...
preserve
    ...
    export delimited name varlab using "IHME Trinidad and Tobago data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Trinidad and Tobago IHME daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Trinidad and Tobago, forecast only") legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Trinidad and Tobago IHME daily deaths update `update'.pdf", replace	
...
* graph Trinidad and Tobago IHME daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Trinidad and Tobago, IHME, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Trinidad and Tobago IHME C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only
	...
	save "IMPE `update' Trinidad and Tobago.dta", replace emptyok
...
foreach update of local list {
	...
	merge m:m date using "IMPE `update' Trinidad and Tobago.dta"
...
save "IMPE Trinidad and Tobago.dta", replace
...
preserve
    ...
    export delimited name varlab using "IMPE Trinidad and Tobago data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Trinidad and Tobago IMPE daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Trinidad and Tobago, forecast only") legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Trinidad and Tobago IMPE daily deaths update `update'.pdf", replace	
...
* graph Trinidad and Tobago IMPE daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Trinidad and Tobago, IMPE, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Trinidad and Tobago IMPE C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "LANL `update' Trinidad and Tobago.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "LANL `update' Trinidad and Tobago.dta"
...
save "LANL Trinidad and Tobago.dta", replace
...
preserve
    ...
    export delimited name varlab using "LANL Trinidad and Tobago data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Trinidad and Tobago LANL daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Trinidad and Tobago, forecast only") legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Trinidad and Tobago LANL daily deaths update `update'.pdf", replace	
...
* graph Trinidad and Tobago LANL daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Trinidad and Tobago, LANL, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Trinidad and Tobago LANL C19 daily deaths all updates.pdf", replace
...
use "DELP Trinidad and Tobago.dta", clear

foreach model of local list {

	merge m:m date loc_grand_name using "`model' Trinidad and Tobago.dta", force
...
save "ALL MODLES Trinidad and Tobago.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODLES Trinidad and Tobago data dictionary.csv", replace 
...
* graph Trinidad and Tobago ALL MODELS daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Trinidad and Tobago, all models, all updates, forecast only", size(medium) color(black)) ///
legend(position(6) order(595 "JOHN" 1 "DELP" 18 "IHME" 8 "IMPE" 56 "LANL") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Trinidad and Tobago ALL MODELS C19 daily deaths all updates.pdf", replace
...
view "log CovidLongitudinal Trinidad and Tobago 1 Process.smcl"
