...
log using "log CovidLongitudinal United Kingdom 1 Process.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal United Kingdom 1 Process.do"
...
**** "do CovidLongitudinal United Kingdom 1 Process.do"
...
** output data files: "`model' United Kingdom.dta"
**                   "ALL MODLES United Kingdom.dta"

** output data dictionary files: "United Kingdom ALL MODELS update dates data dictionary.csv"
**                               "`model' United Kingdom data dictionary.csv"
**                               "ALL MODLES United Kingdom data dictionary.csv"

** graphs:
** "graph 02 United Kingdom `model' C19 daily deaths all updates.pdf"
** "graph 02 United Kingdom ALL MODELS C19 daily deaths all updates.pdf"
...
foreach model of local list {
	...
	di in red "`model'" " United Kingdom absent update_date_block"
	
	qui keep if loc_grand_name == "United Kingdom"
	...
	save "United Kingdom `model' update dates.dta", replace
...
use "United Kingdom DELP update dates.dta", clear 

local list DELP IHME IMPE LANL UCLA YYGU

foreach model of local list {
	
	append using "United Kingdom `model' update dates.dta"
...
save "United Kingdom ALL MODELS update dates.dta", replace
	
export excel using "United Kingdom ALL MODELS update dates.xlsx", replace firstrow(variables) 
...
preserve
    ...
    export delimited name varlab using "United Kingdom ALL MODELS update dates data dictionary.csv", replace 
...
keep if loc_grand_name == "United Kingdom"

keep date DayDeaMeSmJOHNGBR
...
save "JOHN United Kingdom.dta", replace 




* graph United Kingdom JOHN daily deaths

twoway ///
(line DayDeaMeSmJOHNGBR date, sort lwidth(thick) lcolor(cyan)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, United Kingdom, JOHN", size(medium) color(black)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Kingdom JOHN C19 daily deaths reported.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "DELP `update' United Kingdom.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "DELP `update' United Kingdom.dta"
...
save "DELP United Kingdom.dta", replace
...
merge m:m date using "JOHN United Kingdom.dta"
...
preserve
    ...
    export delimited name varlab using "DELP United Kingdom data dictionary.csv", replace 
...
foreach update of local list {
	...
	* graph United Kingdom DELP daily deaths each update 
	...
	subtitle("United Kingdom, forecast only") legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United Kingdom DELP daily deaths update `update'.pdf", replace	
...
* graph United Kingdom DELP daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Kingdom, DELP, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Kingdom DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* graph United Kingdom IHME daily deaths epoch each update 
	...
	ytitle(Daily deaths) title("C19 daily deaths, United Kingdom, IHME, update `update'", size(medium) color(black)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	...
	*/
	...
	/* qui graph export "graph 00 United Kingdom IHME daily deaths epoch `update'.pdf", replace */
	...
	save "IHME `update' United Kingdom.dta", replace emptyok	
...
foreach update of local list {
	...
	merge m:m date using "IHME `update' United Kingdom.dta"
...
save "IHME United Kingdom.dta", replace
...
merge m:1 date using "JOHN United Kingdom.dta"
...
preserve
    ...
    export delimited name varlab using "IHME United Kingdom data dictionary.csv", replace 
...
foreach update of local list {
	...
	* graph United Kingdom IHME daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United Kingdom, forecast only") legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United Kingdom IHME daily deaths update `update'.pdf", replace	
...
* graph United Kingdom IHME daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Kingdom, IHME, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Kingdom IHME C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only
	...
	save "IMPE `update' United Kingdom.dta", replace emptyok
...
foreach update of local list {
	...
	merge m:m date using "IMPE `update' United Kingdom.dta"
...
save "IMPE United Kingdom.dta", replace
...
preserve
    ...
    export delimited name varlab using "IMPE United Kingdom data dictionary.csv", replace 
...
foreach update of local list {
	...
	* graph United Kingdom IMPE daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United Kingdom, forecast only") legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United Kingdom IMPE daily deaths update `update'.pdf", replace	
...
* graph United Kingdom IMPE daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Kingdom, IMPE, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Kingdom IMPE C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "LANL `update' United Kingdom.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "LANL `update' United Kingdom.dta"
...
save "LANL United Kingdom.dta", replace
...
preserve
    ...
    export delimited name varlab using "LANL United Kingdom data dictionary.csv", replace 
...
foreach update of local list {
	...
	* graph United Kingdom LANL daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United Kingdom, forecast only") legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United Kingdom LANL daily deaths update `update'.pdf", replace	
...
* graph United Kingdom LANL daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Kingdom, LANL, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Kingdom LANL C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only  
	...
	save "UCLA `update' United Kingdom.dta", replace 
	
	/* line DayDeaMeRaUCLA`update' DayDeaMeSmUCLA`update' DayDeaMeFoUCLA`update' date

	qui graph export "UCLA `update' United Kingdom.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "UCLA `update' United Kingdom.dta"
...
save "UCLA United Kingdom.dta", replace
...
preserve
    ...
    export delimited name varlab using "UCLA United Kingdom data dictionary.csv", replace 
...
foreach update of local list {
	...
	* graph United Kingdom UCLA daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United Kingdom, forecast only") legend(position(6) order(1 "JOHN" 2 "UCLA forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United Kingdom UCLA daily deaths update `update'.pdf", replace	

}



* graph United Kingdom UCLA daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Kingdom, UCLA, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "UCLA forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Kingdom UCLA C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen FORE, that is forecast only 
	...
	save "YYGU `update' United Kingdom.dta", replace 
	
	/* line DayDeaMeRaYYGU`update' DayDeaMeSmYYGU`update' DayDeaMeFoYYGU`update' date

	qui graph export "YYGU `update' United Kingdom.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "YYGU `update' United Kingdom.dta"
...
save "YYGU United Kingdom.dta", replace
...
preserve
    ...
    export delimited name varlab using "YYGU United Kingdom data dictionary.csv", replace 
...
foreach update of local list {
	...
	* graph United Kingdom YYGU daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United Kingdom, forecast only") legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United Kingdom YYGU daily deaths update `update'.pdf", replace	
...
* graph United Kingdom YYGU daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Kingdom, YYGU, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Kingdom YYGU C19 daily deaths all updates.pdf", replace
...
use "DELP United Kingdom.dta", clear

foreach model of local list {

	merge m:m date loc_grand_name using "`model' United Kingdom.dta", force
...
save "ALL MODLES United Kingdom.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODLES United Kingdom data dictionary.csv", replace 
...
* graph United Kingdom ALL MODELS daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United Kingdom, all models, all updates, forecast only", size(medium) color(black)) ///
legend(position(6) order(868 "JOHN" 19 "DELP" 5 "IHME" 95 "IMPE" 33 "LANL" 383 "UCLA" 1 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United Kingdom ALL MODELS C19 daily deaths all updates.pdf", replace
...
view "log CovidLongitudinal United Kingdom 1 Process.smcl"
