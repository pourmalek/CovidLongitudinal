...
log using "log CovidLongitudinal Lesotho 5 LANL.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Lesotho 5 LANL.do"
...
* input data files: "LANL Lesotho.dta"
* output data files: "LANL Lesotho error.dta" (with error measures saved)

* output data dictionary files: "LANL Lesotho error data dictionary.csv"
...
** graphs:
* "graph 03 Lesotho LANL C19 daily deaths error.pdf"
* "graph 04 Lesotho LANL C19 daily deaths absolute error.pdf"
* "graph 05 Lesotho LANL C19 daily deaths percent error.pdf"
* "graph 06 Lesotho LANL C19 daily deaths absolute percent error.pdf"

* "graph 07 Lesotho LANL C19 daily deaths average median error.pdf"
* "graph 08 Lesotho LANL C19 daily deaths average median absolute error.pdf"
* "graph 09 Lesotho LANL C19 daily deaths average median percent error.pdf"
* "graph 10 Lesotho LANL C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Lesotho LANL C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorLANL`update' = . if date < td(05aug2020) // 05aug2020 is the earliest date of LANL forecasts for Lesotho
                                                            // <<-- modify 3
...
qui replace DDAbsErrLANL`update' = . if date < td(05aug2020) // 05aug2020 is the earliest date of LANL forecasts for Lesotho
...
qui replace DDPerErrLANL`update' = . if date < td(05aug2020) // 05aug2020 is the earliest date of LANL forecasts for Lesotho
...
qui replace DDAbPeErLANL`update' = . if date < td(05aug2020) // 05aug2020 is the earliest date of LANL forecasts for Lesotho
...
qui replace DDErrorLANL`update'_Med1 = . if date < td(05aug2020) // 05aug2020 is the earliest date of LANL forecasts for Lesotho
...
qui replace DDAbsErrLANL`update'_Med1 = . if date < td(05aug2020) // 05aug2020 is the earliest date of LANL forecasts for Lesotho
...
qui replace DDPerErrLANL`update'_Med1 = . if date < td(05aug2020) // 05aug2020 is the earliest date of LANL forecasts for Lesotho
...
qui replace DDAbPeErLANL`update'_Med1 = . if date < td(05aug2020) // 05aug2020 is the earliest date of LANL forecasts for Lesotho
...
egen DDErrorLANL_Mean1 = rowmean(DDErrorLANL20210926_Med1-DDErrorLANL20200805_Med1) // <<-- modify 5
...
qui replace DDErrorLANL_Mean1 = . if date < td(05aug2020) // 05aug2020 is the earliest date of LANL forecasts for Lesotho
...
egen DDAbsErrLANL_Mean1 = rowmean(DDAbsErrLANL20210926_Med1-DDAbsErrLANL20200805_Med1) // <<-- modify 7
...
qui replace DDAbsErrLANL_Mean1 = . if date < td(05aug2020) // 05aug2020 is the earliest date of LANL forecasts for Lesotho
...
egen DDPerErrLANL_Mean1 = rowmean(DDPerErrLANL20210926_Med1-DDPerErrLANL20200805_Med1) // <<-- modify 9
...
qui replace DDPerErrLANL_Mean1 = . if date < td(05aug2020) // 05aug2020 is the earliest date of LANL forecasts for Lesotho
...
egen DDAbPeErLANL_Mean1 = rowmean(DDAbPeErLANL20210926_Med1-DDAbPeErLANL20200805_Med1) // <<-- modify 11
...
qui replace DDAbPeErLANL_Mean1 = . if date < td(05aug2020) // 05aug2020 is the earliest date of LANL forecasts for Lesotho
...
subtitle("Lesotho, LANL, all updates, forecast only", size(small)) 

qui graph export "graph 03 Lesotho LANL C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Lesotho LANL C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Lesotho LANL C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Lesotho LANL C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Lesotho, LANL, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Lesotho LANL C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Lesotho LANL C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Lesotho LANL C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Lesotho LANL C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Lesotho, LANL, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Lesotho LANL C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "LANL Lesotho error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "LANL Lesotho error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Lesotho 5 LANL.smcl"
