...
log using "log CovidLongitudinal Argentina 8 YYGU.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Argentina 8 YYGU.do"
...
qui replace DDErrorYYGU`update' = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Argentina
                                                            // <<-- modify 3
...
qui replace DDAbsErrYYGU`update' = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Argentina
...
qui replace DDPerErrYYGU`update' = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Argentina
...
qui replace DDAbPeErYYGU`update' = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Argentina
...
qui replace DDErrorYYGU`update'_Med1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Argentina
...
qui replace DDAbsErrYYGU`update'_Med1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Argentina
...
qui replace DDPerErrYYGU`update'_Med1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Argentina
...
qui replace DDAbPeErYYGU`update'_Med1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Argentina
...
qui replace DDErrorYYGU_Mean1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Argentina
...
qui replace DDAbsErrYYGU_Mean1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Argentina
...
qui replace DDPerErrYYGU_Mean1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Argentina
...
qui replace DDAbPeErYYGU_Mean1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Argentina
...
subtitle("Argentina, YYGU, all updates, forecast only", size(small)) 

qui graph export "graph 03 Argentina YYGU C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Argentina YYGU C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Argentina YYGU C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Argentina YYGU C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Argentina, YYGU, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Argentina YYGU C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Argentina YYGU C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Argentina YYGU C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Argentina YYGU C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Argentina, YYGU, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Argentina YYGU C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "YYGU Argentina error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "YYGU Argentina error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Argentina 8 YYGU.smcl"
