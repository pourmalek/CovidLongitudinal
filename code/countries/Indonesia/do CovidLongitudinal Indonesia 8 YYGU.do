...
log using "log CovidLongitudinal Indonesia 8 YYGU.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Indonesia 8 YYGU.do"
...
* input data files: "YYGU Indonesia.dta"
* output data files: "YYGU Indonesia error.dta" (with error measures saved)

* output data dictionary files: "YYGU Indonesia error data dictionary.csv"
...
** graphs:
* "graph 03 Indonesia YYGU C19 daily deaths error.pdf"
* "graph 04 Indonesia YYGU C19 daily deaths absolute error.pdf"
* "graph 05 Indonesia YYGU C19 daily deaths percent error.pdf"
* "graph 06 Indonesia YYGU C19 daily deaths absolute percent error.pdf"

* "graph 07 Indonesia YYGU C19 daily deaths average median error.pdf"
* "graph 08 Indonesia YYGU C19 daily deaths average median absolute error.pdf"
* "graph 09 Indonesia YYGU C19 daily deaths average median percent error.pdf"
* "graph 10 Indonesia YYGU C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Indonesia YYGU C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorYYGU`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Indonesia
                                                            // <<-- modify 3
...
qui replace DDAbsErrYYGU`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Indonesia
...
qui replace DDPerErrYYGU`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Indonesia
...
qui replace DDAbPeErYYGU`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Indonesia
...
qui replace DDErrorYYGU`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Indonesia
...
qui replace DDAbsErrYYGU`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Indonesia
...
qui replace DDPerErrYYGU`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Indonesia
...
qui replace DDAbPeErYYGU`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Indonesia
...
egen DDErrorYYGU_Mean1 = rowmean(DDErrorYYGU20201005_Med1-DDErrorYYGU20200407_Med1) // <<-- modify 5
...
qui replace DDErrorYYGU_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Indonesia
...
egen DDAbsErrYYGU_Mean1 = rowmean(DDAbsErrYYGU20201005_Med1-DDAbsErrYYGU20200407_Med1) // <<-- modify 7
...
qui replace DDAbsErrYYGU_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Indonesia
...
egen DDPerErrYYGU_Mean1 = rowmean(DDPerErrYYGU20201005_Med1-DDPerErrYYGU20200407_Med1) // <<-- modify 9
...
qui replace DDPerErrYYGU_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Indonesia
...
egen DDAbPeErYYGU_Mean1 = rowmean(DDAbPeErYYGU20201005_Med1-DDAbPeErYYGU20200407_Med1) // <<-- modify 11
...
qui replace DDAbPeErYYGU_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of YYGU forecasts for Indonesia
...
subtitle("Indonesia, YYGU, all updates, forecast only", size(small)) 

qui graph export "graph 03 Indonesia YYGU C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Indonesia YYGU C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Indonesia YYGU C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Indonesia YYGU C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Indonesia, YYGU, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Indonesia YYGU C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Indonesia YYGU C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Indonesia YYGU C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Indonesia YYGU C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Indonesia, YYGU, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Indonesia YYGU C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "YYGU Indonesia error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "YYGU Indonesia error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Indonesia 8 YYGU.smcl"
