...
log using "log CovidLongitudinal United States of America 5 LANL.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal United States of America 5 LANL.do"
...
* input data files: "LANL United States of America.dta"
* output data files: "LANL United States of America error.dta" (with error measures saved)

* output data dictionary files: "LANL United States of America error data dictionary.csv"
...
** graphs:
* "graph 03 United States of America LANL C19 daily deaths error.pdf"
* "graph 04 United States of America LANL C19 daily deaths absolute error.pdf"
* "graph 05 United States of America LANL C19 daily deaths percent error.pdf"
* "graph 06 United States of America LANL C19 daily deaths absolute percent error.pdf"

* "graph 07 United States of America LANL C19 daily deaths average median error.pdf"
* "graph 08 United States of America LANL C19 daily deaths average median absolute error.pdf"
* "graph 09 United States of America LANL C19 daily deaths average median percent error.pdf"
* "graph 10 United States of America LANL C19 daily deaths average median absolute percent error.pdf"

* "graph 11 United States of America LANL C19 daily deaths Average MAPE over updates and calendar months
...
use "LANL United States of America.dta", clear 
...
qui replace DDErrorLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for United States of America
                                                            // <<-- modify 3
...
qui replace DDAbsErrLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for United States of America
...
qui replace DDPerErrLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for United States of America
...
qui replace DDAbPeErLANL`update' = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for United States of America
...
qui replace DDErrorLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for United States of America
...
qui replace DDAbsErrLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for United States of America
...
qui replace DDPerErrLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for United States of America
...
qui replace DDAbPeErLANL`update'_Med1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for United States of America
...
order DDErrorLANL20200503_Med1
...
qui replace DDErrorLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for United States of America
...
order DDAbsErrLANL20200503_Med1
...
qui replace DDAbsErrLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for United States of America
...
order DDPerErrLANL20200503_Med1
...
qui replace DDPerErrLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for United States of America
...
order DDAbPeErLANL20200503_Med1
...
qui replace DDAbPeErLANL_Mean1 = . if date < td(26apr2020) // 26apr2020 is the earliest date of LANL forecasts for United States of America
...
(line DDErrorLANL20200503 date, sort lcolor(brown) lwidth(thin)) ///
...
subtitle("United States of America, LANL, all updates, forecast only", size(small)) 

qui graph export "graph 03 United States of America LANL C19 daily deaths error.pdf", replace
...
(line DDAbsErrLANL20200503 date, sort lcolor(brown) lwidth(thin)) ///
...
qui graph export "graph 04 United States of America LANL C19 daily deaths absolute error.pdf", replace
...
(line DDPerErrLANL20200503 date, sort lcolor(brown) lwidth(thin)) ///
...
qui graph export "graph 05 United States of America LANL C19 daily deaths percent error.pdf", replace
...
(line DDAbPeErLANL20200503 date, sort lcolor(brown) lwidth(thin)) ///
...
qui graph export "graph 06 United States of America LANL C19 daily deaths absolute percent error.pdf", replace
...
subtitle("United States of America, LANL, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 United States of America LANL C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 United States of America LANL C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 United States of America LANL C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 United States of America LANL C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("United States of America, LANL, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 United States of America LANL C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "LANL United States of America error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "LANL United States of America error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal United States of America 5 LANL.smcl"
