...
log using "log CovidLongitudinal United States of America 1 Process.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal United States of America 1 Process.do"
...
**** "do CovidLongitudinal United States of America 1 Process.do"
...
** output data files: "`model' United States of America.dta"
**                   "ALL MODLES United States of America.dta"

** output data dictionary files: "United States of America ALL MODELS update dates data dictionary.csv"
**                               "`model' United States of America data dictionary.csv"
**                               "ALL MODLES United States of America data dictionary.csv"

** graphs:
** "graph 02 United States of America `model' C19 daily deaths all updates.pdf"
** "graph 02 United States of America ALL MODELS C19 daily deaths all updates.pdf"
...
foreach model of local list {
	...
	di in red "`model'" " United States of America absent update_date_block"
	
	qui keep if loc_grand_name == "United States of America"
	...
	save "United States of America `model' update dates.dta", replace
...
use "United States of America DELP update dates.dta", clear 

local list DELP IHME IMPE LANL UCLA YYGU

foreach model of local list {
	
	append using "United States of America `model' update dates.dta"
...
save "United States of America ALL MODELS update dates.dta", replace
	
export excel using "United States of America ALL MODELS update dates.xlsx", replace firstrow(variables) 
...
preserve
    ...
    export delimited name varlab using "United States of America ALL MODELS update dates data dictionary.csv", replace 
...
keep if loc_grand_name == "United States of America"

keep date DayDeaMeSmJOHNUSA
...
save "JOHN United States of America.dta", replace 




* graph United States of America JOHN daily deaths

twoway ///
(line DayDeaMeSmJOHNUSA date, sort lwidth(thick) lcolor(cyan)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, United States of America, JOHN", size(medium) color(black)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United States of America JOHN C19 daily deaths reported.pdf", replace
...
foreach update of local list {
	...
	keep if loc_grand_name == "United States of America" & provincestate == "US"
	...
	* gen Daily deaths smooth forecast only 
	...
	save "DELP `update' United States of America.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "DELP `update' United States of America.dta"
...
save "DELP United States of America.dta", replace
...
merge m:m date using "JOHN United States of America.dta"
...
preserve
    ...
    export delimited name varlab using "DELP United States of America data dictionary.csv", replace 
...
foreach update of local list {
	...
	* graph United States of America DELP daily deaths each update 
	...
	subtitle("United States of America, forecast only") legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United States of America DELP daily deaths update `update'.pdf", replace	
...
* graph United States of America DELP daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United States of America, DELP, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United States of America DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* graph United States of America IHME daily deaths epoch each update 
	...
	ytitle(Daily deaths) title("C19 daily deaths, United States of America, IHME, update `update'", size(medium) color(black)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	...
	*/
	...
	/* qui graph export "graph 00 United States of America IHME daily deaths epoch `update'.pdf", replace */
	...
	save "IHME `update' United States of America.dta", replace emptyok	
...
foreach update of local list {
	...
	merge m:m date using "IHME `update' United States of America.dta"
...
save "IHME United States of America.dta", replace
...
merge m:1 date using "JOHN United States of America.dta"
...
preserve
    ...
    export delimited name varlab using "IHME United States of America data dictionary.csv", replace 
...
foreach update of local list {
	...
	* graph United States of America IHME daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United States of America, forecast only") legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United States of America IHME daily deaths update `update'.pdf", replace	
...
* graph United States of America IHME daily deaths all updates

twoway ///
(line DayDeaMeSmJOHNUSA date, sort lwidth(thick) lcolor(cyan)) /// 
(line DayDeaMeFoIHME20200325 date, sort lwidth(thin) lcolor(black)) ///
(line DayDeaMeFoIHME20200326 date, sort lwidth(thin) lcolor(black)) ///
(line DayDeaMeFoIHME20200327 date, sort lwidth(thin) lcolor(black)) ///
(line DayDeaMeFoIHME20200329 date, sort lwidth(thin) lcolor(black)) ///
(line DayDeaMeFoIHME20200330 date, sort lwidth(thin) lcolor(black)) ///
(line DayDeaMeFoIHME20200331 date, sort lwidth(thin) lcolor(black)) ///
(line DayDeaMeFoIHME20200401 date, sort lwidth(thin) lcolor(black)) ///
(line DayDeaMeFoIHME20200405 date, sort lwidth(thin) lcolor(black)) ///
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United States of America, IHME, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United States of America IHME C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only
	...
	save "IMPE `update' United States of America.dta", replace emptyok
...
foreach update of local list {
	...
	merge m:m date using "IMPE `update' United States of America.dta"
...
save "IMPE United States of America.dta", replace
...
preserve
    ...
    export delimited name varlab using "IMPE United States of America data dictionary.csv", replace 
...
foreach update of local list {
	...
	* graph United States of America IMPE daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United States of America, forecast only") legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United States of America IMPE daily deaths update `update'.pdf", replace	
...
* graph United States of America IMPE daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United States of America, IMPE, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United States of America IMPE C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "LANL `update' United States of America.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "LANL `update' United States of America.dta"
...
save "LANL United States of America.dta", replace
...
preserve
    ...
    export delimited name varlab using "LANL United States of America data dictionary.csv", replace 
...
foreach update of local list {
	...
	* graph United States of America LANL daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United States of America, forecast only") legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United States of America LANL daily deaths update `update'.pdf", replace	
...
* graph United States of America LANL daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United States of America, LANL, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United States of America LANL C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only  
	...
	save "UCLA `update' United States of America.dta", replace 
	
	/* line DayDeaMeRaUCLA`update' DayDeaMeSmUCLA`update' DayDeaMeFoUCLA`update' date

	qui graph export "UCLA `update' United States of America.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "UCLA `update' United States of America.dta"
...
save "UCLA United States of America.dta", replace
...
preserve
    ...
    export delimited name varlab using "UCLA United States of America data dictionary.csv", replace 
...
foreach update of local list {
	...
	* graph United States of America UCLA daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United States of America, forecast only") legend(position(6) order(1 "JOHN" 2 "UCLA forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United States of America UCLA daily deaths update `update'.pdf", replace	

}



* graph United States of America UCLA daily deaths all updates
...
(line DayDeaMeFoUCLA20210228 date, sort lwidth(thin) lcolor(blue)) ///
...
(line DayDeaMeFoUCLA20210606 date, sort lwidth(thin) lcolor(blue)) ///
(line DayDeaMeFoUCLA20210614 date, sort lwidth(thin) lcolor(blue)) ///
(line DayDeaMeFoUCLA20210621 date, sort lwidth(thin) lcolor(blue)) ///
(line DayDeaMeFoUCLA20210627 date, sort lwidth(thin) lcolor(blue)) ///
(line DayDeaMeFoUCLA20210630 date, sort lwidth(thin) lcolor(blue)) ///
(line DayDeaMeFoUCLA20210706 date, sort lwidth(thin) lcolor(blue)) ///
...
(line DayDeaMeFoUCLA20211115 date, sort lwidth(thin) lcolor(blue)) ///
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United States of America, UCLA, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "UCLA forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United States of America UCLA C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen FORE, that is forecast only 
	...
	save "YYGU `update' United States of America.dta", replace 
	
	/* line DayDeaMeRaYYGU`update' DayDeaMeSmYYGU`update' DayDeaMeFoYYGU`update' date

	qui graph export "YYGU `update' United States of America.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "YYGU `update' United States of America.dta"
...
save "YYGU United States of America.dta", replace
...
preserve
    ...
    export delimited name varlab using "YYGU United States of America data dictionary.csv", replace 
...
foreach update of local list {
	...
	* graph United States of America YYGU daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("United States of America, forecast only") legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 United States of America YYGU daily deaths update `update'.pdf", replace	
...
* graph United States of America YYGU daily deaths all updates

twoway ///
(line DayDeaMeSmJOHNUSA date, sort lwidth(thick) lcolor(cyan)) /// 
(line DayDeaMeFoYYGU20200401 date, sort lwidth(thin) lcolor(gold)) ///
(line DayDeaMeFoYYGU20200402 date, sort lwidth(thin) lcolor(gold)) ///
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United States of America, YYGU, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United States of America YYGU C19 daily deaths all updates.pdf", replace
...
use "DELP United States of America.dta", clear

foreach model of local list {

	merge m:m date loc_grand_name using "`model' United States of America.dta", force
...
save "ALL MODLES United States of America.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODLES United States of America data dictionary.csv", replace 
...
* graph United States of America ALL MODELS daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, United States of America, all models, all updates, forecast only", size(medium) color(black)) ///
legend(position(6) order(883 "JOHN" 29 "DELP" 1 "IHME" 105 "IMPE" 43 "LANL" 392 "UCLA" 8 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 United States of America ALL MODELS C19 daily deaths all updates.pdf", replace
...
view "log CovidLongitudinal United States of America 1 Process.smcl"
