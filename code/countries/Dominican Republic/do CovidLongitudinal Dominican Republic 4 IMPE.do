...
log using "log CovidLongitudinal Dominican Republic 4 IMPE.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Dominican Republic 4 IMPE.do"
...
* input data files: "IMPE Dominican Republic.dta"
* output data files: "IMPE Dominican Republic error.dta" (with error measures saved)

* output data dictionary files: "IMPE Dominican Republic error data dictionary.csv"
...
** graphs:
* "graph 03 Dominican Republic IMPE C19 daily deaths error.pdf"
* "graph 04 Dominican Republic IMPE C19 daily deaths absolute error.pdf"
* "graph 05 Dominican Republic IMPE C19 daily deaths percent error.pdf"
* "graph 06 Dominican Republic IMPE C19 daily deaths absolute percent error.pdf"

* "graph 07 Dominican Republic IMPE C19 daily deaths average median error.pdf"
* "graph 08 Dominican Republic IMPE C19 daily deaths average median absolute error.pdf"
* "graph 09 Dominican Republic IMPE C19 daily deaths average median percent error.pdf"
* "graph 10 Dominican Republic IMPE C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Dominican Republic IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
use "IMPE Dominican Republic.dta", clear 
...
qui replace DDErrorIMPE`update' = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Dominican Republic
                                                            // <<-- modify 3
...
qui replace DDAbsErrIMPE`update' = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Dominican Republic
...
qui replace DDPerErrIMPE`update' = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Dominican Republic
...
qui replace DDAbPeErIMPE`update' = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Dominican Republic
...
qui replace DDErrorIMPE`update'_Med1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Dominican Republic
...
qui replace DDAbsErrIMPE`update'_Med1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Dominican Republic
...
qui replace DDPerErrIMPE`update'_Med1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Dominican Republic
...
qui replace DDAbPeErIMPE`update'_Med1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Dominican Republic
...
qui replace DDErrorIMPE_Mean1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Dominican Republic
...
qui replace DDAbsErrIMPE_Mean1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Dominican Republic
...
qui replace DDPerErrIMPE_Mean1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Dominican Republic
...
qui replace DDAbPeErIMPE_Mean1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Dominican Republic
...
subtitle("Dominican Republic, IMPE, all updates, forecast only", size(small)) 

qui graph export "graph 03 Dominican Republic IMPE C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Dominican Republic IMPE C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Dominican Republic IMPE C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Dominican Republic IMPE C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Dominican Republic, IMPE, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Dominican Republic IMPE C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Dominican Republic IMPE C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Dominican Republic IMPE C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Dominican Republic IMPE C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Dominican Republic, IMPE, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Dominican Republic IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IMPE Dominican Republic error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IMPE Dominican Republic error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Dominican Republic 4 IMPE.smcl"
