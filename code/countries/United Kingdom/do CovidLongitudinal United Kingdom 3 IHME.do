...
log using "log CovidLongitudinal United Kingdom 3 IHME.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal United Kingdom 3 IHME.do"
...
* input data files: "IHME United Kingdom.dta"
* output data files: "IHME United Kingdom error.dta" (with error measures saved)

* output data dictionary files: "IHME United Kingdom error data dictionary.csv"
...
** graphs:
* "graph 03 United Kingdom IHME C19 daily deaths error.pdf"
* "graph 04 United Kingdom IHME C19 daily deaths absolute error.pdf"
* "graph 05 United Kingdom IHME C19 daily deaths percent error.pdf"
* "graph 06 United Kingdom IHME C19 daily deaths absolute percent error.pdf"

* "graph 07 United Kingdom IHME C19 daily deaths average median error.pdf"
* "graph 08 United Kingdom IHME C19 daily deaths average median absolute error.pdf"
* "graph 09 United Kingdom IHME C19 daily deaths average median percent error.pdf"
* "graph 10 United Kingdom IHME C19 daily deaths average median absolute percent error.pdf"

* "graph 11 United Kingdom IHME C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
use "IHME United Kingdom.dta", clear 
...
qui replace DDErrorIHME`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for United Kingdom
                                                            // <<-- modify 3
...
qui replace DDAbsErrIHME`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for United Kingdom
...
qui replace DDPerErrIHME`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for United Kingdom
...
qui replace DDAbPeErIHME`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for United Kingdom
...
qui replace DDErrorIHME`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for United Kingdom
...
qui replace DDAbsErrIHME`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for United Kingdom
...
qui replace DDPerErrIHME`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for United Kingdom
...
qui replace DDAbPeErIHME`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for United Kingdom
...
egen DDErrorIHME_Mean1 = rowmean(DDErrorIHME20221216_Med1-DDErrorIHME20200407_Med1) // <<-- modify 5
...
qui replace DDErrorIHME_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for United Kingdom
...
egen DDAbsErrIHME_Mean1 = rowmean(DDAbsErrIHME20221216_Med1-DDAbsErrIHME20200407_Med1) // <<-- modify 7
...
qui replace DDAbsErrIHME_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for United Kingdom
...
egen DDPerErrIHME_Mean1 = rowmean(DDPerErrIHME20221216_Med1-DDPerErrIHME20200407_Med1) // <<-- modify 9
...
qui replace DDPerErrIHME_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for United Kingdom
...
egen DDAbPeErIHME_Mean1 = rowmean(DDAbPeErIHME20221216_Med1-DDAbPeErIHME20200407_Med1) // <<-- modify 11
...
qui replace DDAbPeErIHME_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for United Kingdom
...
subtitle("United Kingdom, IHME, all updates, forecast only", size(small)) 

qui graph export "graph 03 United Kingdom IHME C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 United Kingdom IHME C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 United Kingdom IHME C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 United Kingdom IHME C19 daily deaths absolute percent error.pdf", replace
...
subtitle("United Kingdom, IHME, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 United Kingdom IHME C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 United Kingdom IHME C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 United Kingdom IHME C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 United Kingdom IHME C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("United Kingdom, IHME, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 United Kingdom IHME C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IHME United Kingdom error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IHME United Kingdom error data dictionary.csv", replace 
...
view "log CovidLongitudinal United Kingdom 3 IHME.smcl"
