...
log using "log CovidLongitudinal Czechia 4 IMPE.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Czechia 4 IMPE.do"
...
* input data files: "IMPE Czechia.dta"
* output data files: "IMPE Czechia error.dta" (with error measures saved)

* output data dictionary files: "IMPE Czechia error data dictionary.csv"
...
** graphs:
* "graph 03 Czechia IMPE C19 daily deaths error.pdf"
* "graph 04 Czechia IMPE C19 daily deaths absolute error.pdf"
* "graph 05 Czechia IMPE C19 daily deaths percent error.pdf"
* "graph 06 Czechia IMPE C19 daily deaths absolute percent error.pdf"

* "graph 07 Czechia IMPE C19 daily deaths average median error.pdf"
* "graph 08 Czechia IMPE C19 daily deaths average median absolute error.pdf"
* "graph 09 Czechia IMPE C19 daily deaths average median percent error.pdf"
* "graph 10 Czechia IMPE C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Czechia IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
qui replace DDErrorIMPE`update' = . if date < td(31may2020) // 31may2020 is the earliest date of IMPE forecasts for Czechia
                                                            // <<-- modify 3
...
qui replace DDAbsErrIMPE`update' = . if date < td(31may2020) // 31may2020 is the earliest date of IMPE forecasts for Czechia
...
qui replace DDPerErrIMPE`update' = . if date < td(31may2020) // 31may2020 is the earliest date of IMPE forecasts for Czechia
...
qui replace DDAbPeErIMPE`update' = . if date < td(31may2020) // 31may2020 is the earliest date of IMPE forecasts for Czechia
...
qui replace DDErrorIMPE`update'_Med1 = . if date < td(31may2020) // 31may2020 is the earliest date of IMPE forecasts for Czechia
...
qui replace DDAbsErrIMPE`update'_Med1 = . if date < td(31may2020) // 31may2020 is the earliest date of IMPE forecasts for Czechia
...
qui replace DDPerErrIMPE`update'_Med1 = . if date < td(31may2020) // 31may2020 is the earliest date of IMPE forecasts for Czechia
...
qui replace DDAbPeErIMPE`update'_Med1 = . if date < td(31may2020) // 31may2020 is the earliest date of IMPE forecasts for Czechia
...
egen DDErrorIMPE_Mean1 = rowmean(DDErrorIMPE20221225_Med1-DDErrorIMPE20200531_Med1) // <<-- modify 5
...
qui replace DDErrorIMPE_Mean1 = . if date < td(31may2020) // 31may2020 is the earliest date of IMPE forecasts for Czechia
...
egen DDAbsErrIMPE_Mean1 = rowmean(DDAbsErrIMPE20221225_Med1-DDAbsErrIMPE20200531_Med1) // <<-- modify 7
...
qui replace DDAbsErrIMPE_Mean1 = . if date < td(31may2020) // 31may2020 is the earliest date of IMPE forecasts for Czechia
...
egen DDPerErrIMPE_Mean1 = rowmean(DDPerErrIMPE20221225_Med1-DDPerErrIMPE20200531_Med1) // <<-- modify 9
...
qui replace DDPerErrIMPE_Mean1 = . if date < td(31may2020) // 31may2020 is the earliest date of IMPE forecasts for Czechia
...
egen DDAbPeErIMPE_Mean1 = rowmean(DDAbPeErIMPE20221225_Med1-DDAbPeErIMPE20200531_Med1) // <<-- modify 11
...
qui replace DDAbPeErIMPE_Mean1 = . if date < td(31may2020) // 31may2020 is the earliest date of IMPE forecasts for Czechia
...
subtitle("Czechia, IMPE, all updates, forecast only", size(small)) 

qui graph export "graph 03 Czechia IMPE C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Czechia IMPE C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Czechia IMPE C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Czechia IMPE C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Czechia, IMPE, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Czechia IMPE C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Czechia IMPE C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Czechia IMPE C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Czechia IMPE C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Czechia, IMPE, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Czechia IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IMPE Czechia error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IMPE Czechia error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Czechia 4 IMPE.smcl"
