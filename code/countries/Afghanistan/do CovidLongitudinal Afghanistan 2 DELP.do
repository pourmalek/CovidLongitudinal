...
log using "log CovidLongitudinal Afghanistan 2 DELP.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Afghanistan 2 DELP.do"
...
* input data files: "DELP Afghanistan.dta"
* output data files: "DELP Afghanistan error.dta" (with error measures saved)

* output data dictionary files: "DELP Afghanistan error data dictionary.csv"
...
** graphs:
* "graph 03 Afghanistan DELP C19 daily deaths error.pdf"
* "graph 04 Afghanistan DELP C19 daily deaths absolute error.pdf"
* "graph 05 Afghanistan DELP C19 daily deaths percent error.pdf"
* "graph 06 Afghanistan DELP C19 daily deaths absolute percent error.pdf"

* "graph 07 Afghanistan DELP C19 daily deaths average median error.pdf"
* "graph 08 Afghanistan DELP C19 daily deaths average median absolute error.pdf"
* "graph 09 Afghanistan DELP C19 daily deaths average median percent error.pdf"
* "graph 10 Afghanistan DELP C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Afghanistan DELP C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
use "DELP Afghanistan.dta", clear 
...
qui replace DDErrorDELP`update' = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Afghanistan
                                                            // <<-- modify 3
...
qui replace DDAbsErrDELP`update' = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Afghanistan
...
qui replace DDPerErrDELP`update' = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Afghanistan
...
qui replace DDAbPeErDELP`update' = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Afghanistan
...
qui replace DDErrorDELP`update'_Med1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Afghanistan
...
qui replace DDAbsErrDELP`update'_Med1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Afghanistan
...
qui replace DDPerErrDELP`update'_Med1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Afghanistan
...
qui replace DDAbPeErDELP`update'_Med1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Afghanistan
...
* Make a temp _Med1 = median absolute percent error graph for:
* Description of inner works of Stata codes in CovidLongitudinal repository Text

twoway /// 
(line DDErrorDELP20200417_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200424_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200501_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200509_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200517_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200524_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200531_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200607_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200614_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200621_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200628_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200704_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200718_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200723_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200801_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200815_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200829_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200912_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20200926_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20201008_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20201022_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20201105_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20201119_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20201203_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20201217_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20201231_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210114_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210128_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210211_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210225_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210311_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210325_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210408_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210422_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210506_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210520_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210603_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210610_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210617_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210624_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210701_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210708_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210715_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210722_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210729_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210805_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210812_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210819_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210826_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210902_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210909_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210916_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210923_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20210930_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20211007_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20211014_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20211021_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20211028_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20211104_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20211111_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20211118_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20211125_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20211202_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20211209_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20211216_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20211223_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20211230_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220106_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220113_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220114_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220115_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220116_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220117_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220118_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220119_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220120_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220121_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220122_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220123_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220124_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220125_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220126_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220127_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220128_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220129_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220130_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220131_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220201_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220202_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220203_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220204_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220205_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220206_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220207_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220208_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220209_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220210_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220211_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220212_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220213_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220214_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220215_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220216_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220217_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220218_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220219_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220220_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220221_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220222_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220223_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220224_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220225_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220226_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220227_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220228_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220301_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220302_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220303_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220304_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220305_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220306_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220307_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220308_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220309_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220310_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220311_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220312_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220313_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220314_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220315_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220316_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220317_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220318_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220319_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220320_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220321_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220322_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220323_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220324_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220325_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220326_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220327_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220328_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220329_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220330_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220331_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220401_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220402_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220403_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220404_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220405_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220406_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220407_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220408_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220409_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220410_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220411_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220412_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220413_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220414_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220415_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220416_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220417_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220418_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220419_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220420_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220421_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220422_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220423_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220424_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220425_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220426_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220427_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220428_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220429_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220430_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220501_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220502_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220503_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220504_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220505_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220506_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220507_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220508_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220509_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220510_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220511_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220512_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220513_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220514_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220515_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220516_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220517_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220518_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220519_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220520_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220521_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220522_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220523_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220524_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220525_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220526_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220527_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220528_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220529_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220530_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220531_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220601_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220602_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220603_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220604_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220605_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220606_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220607_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220608_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220609_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220610_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220611_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220612_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220613_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220614_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220615_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220616_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220617_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220618_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220619_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220620_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220621_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220622_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220623_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220624_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220625_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220626_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220627_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220628_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220629_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220630_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220701_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220702_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220703_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220704_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220705_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220706_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220707_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220708_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220709_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220710_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220711_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220712_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220713_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220714_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220715_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220716_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220717_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220718_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220719_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220720_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220721_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220722_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220723_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220724_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220725_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220726_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220727_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220728_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220729_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220730_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220731_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220801_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220802_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220803_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220804_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220805_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220806_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220807_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220808_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220809_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220810_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220811_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220812_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220813_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220814_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220815_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220816_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220817_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220818_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220819_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220820_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220821_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220822_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220823_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220824_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220825_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220826_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220827_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220828_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220829_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220830_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220831_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220901_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220902_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220903_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220904_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220905_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220906_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220907_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220908_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220909_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220910_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220911_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220912_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220913_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220914_Med1 date, sort lcolor(red) lwidth(thin)) ///
(line DDErrorDELP20220915_Med1 date, sort lcolor(red) lwidth(thin)) ///
...
ytitle(Daily deaths error measure) title("C19 MEDIAN absolute % error by calendar months and updates", size(medium) color(black)) /// 
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3)) ///
subtitle("Afghanistan, DELP, all updates, forecast only", size(small)) 

qui graph export "graph 06 b Afghanistan DELP C19 daily deaths median absolute percent error.pdf", replace
...
qui replace DDErrorDELP_Mean1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Afghanistan
...
qui replace DDAbsErrDELP_Mean1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Afghanistan
...
qui replace DDPerErrDELP_Mean1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Afghanistan
...
qui replace DDAbPeErDELP_Mean1 = . if date < td(17apr2020) // 17apr2020 is the earliest date of DELP forecasts for Afghanistan
...
qui graph export "graph 03 Afghanistan DELP C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Afghanistan DELP C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Afghanistan DELP C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Afghanistan DELP C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Afghanistan, DELP, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Afghanistan DELP C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Afghanistan DELP C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Afghanistan DELP C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Afghanistan DELP C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Afghanistan, DELP, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Afghanistan DELP C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "DELP Afghanistan error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "DELP Afghanistan error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Afghanistan 2 DELP.smcl"
