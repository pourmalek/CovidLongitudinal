...
log using "log CovidLongitudinal Sao Tome and Principe 3 IHME.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Sao Tome and Principe 3 IHME.do"
...
* input data files: "IHME Sao Tome and Principe.dta"
* output data files: "IHME Sao Tome and Principe error.dta" (with error measures saved)

* output data dictionary files: "IHME Sao Tome and Principe error data dictionary.csv"
...
** graphs:
* "graph 03 Sao Tome and Principe IHME C19 daily deaths error.pdf"
* "graph 04 Sao Tome and Principe IHME C19 daily deaths absolute error.pdf"
* "graph 05 Sao Tome and Principe IHME C19 daily deaths percent error.pdf"
* "graph 06 Sao Tome and Principe IHME C19 daily deaths absolute percent error.pdf"

* "graph 07 Sao Tome and Principe IHME C19 daily deaths average median error.pdf"
* "graph 08 Sao Tome and Principe IHME C19 daily deaths average median absolute error.pdf"
* "graph 09 Sao Tome and Principe IHME C19 daily deaths average median percent error.pdf"
* "graph 10 Sao Tome and Principe IHME C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Sao Tome and Principe IHME C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
use "IHME Sao Tome and Principe.dta", clear 
...
qui replace DDErrorIHME`update' = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Sao Tome and Principe
                                                            // <<-- modify 3
...
qui replace DDAbsErrIHME`update' = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Sao Tome and Principe
...
qui replace DDPerErrIHME`update' = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Sao Tome and Principe
...
qui replace DDAbPeErIHME`update' = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Sao Tome and Principe
...
qui replace DDErrorIHME`update'_Med1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Sao Tome and Principe
...
qui replace DDAbsErrIHME`update'_Med1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Sao Tome and Principe
...
qui replace DDPerErrIHME`update'_Med1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Sao Tome and Principe
...
qui replace DDAbPeErIHME`update'_Med1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Sao Tome and Principe
...
egen DDErrorIHME_Mean1 = rowmean(DDErrorIHME20220218_Med1-DDErrorIHME20200625_Med1) // <<-- modify 5
...
qui replace DDErrorIHME_Mean1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Sao Tome and Principe
...
egen DDAbsErrIHME_Mean1 = rowmean(DDAbsErrIHME20220218_Med1-DDAbsErrIHME20200625_Med1) // <<-- modify 7
...
qui replace DDAbsErrIHME_Mean1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Sao Tome and Principe
...
egen DDPerErrIHME_Mean1 = rowmean(DDPerErrIHME20220218_Med1-DDPerErrIHME20200625_Med1) // <<-- modify 9
...
qui replace DDPerErrIHME_Mean1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Sao Tome and Principe
...
egen DDAbPeErIHME_Mean1 = rowmean(DDAbPeErIHME20220218_Med1-DDAbPeErIHME20200625_Med1) // <<-- modify 11
...
qui replace DDAbPeErIHME_Mean1 = . if date < td(25jun2020) // 25jun2020 is the earliest date of IHME forecasts for Sao Tome and Principe
...
subtitle("Sao Tome and Principe, IHME, all updates, forecast only", size(small)) 

qui graph export "graph 03 Sao Tome and Principe IHME C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Sao Tome and Principe IHME C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Sao Tome and Principe IHME C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Sao Tome and Principe IHME C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Sao Tome and Principe, IHME, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Sao Tome and Principe IHME C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Sao Tome and Principe IHME C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Sao Tome and Principe IHME C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Sao Tome and Principe IHME C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Sao Tome and Principe, IHME, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Sao Tome and Principe IHME C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IHME Sao Tome and Principe error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IHME Sao Tome and Principe error data dictionary.csv", replace 
...
view "log CovidLongitudinal Sao Tome and Principe 3 IHME.smcl"
