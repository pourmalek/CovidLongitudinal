...
cd "$pathCovidLongitudinal/countries/United Kingdom"

capture log close 

log using "log CovidLongitudinal United Kingdom 8 YYGU.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal United Kingdom 8 YYGU.do"

* Project: Longitudinal assessment of COVID-19 models 

* Objective: Run calculations for error measures
	* for each country ---->> United Kingdom <<----                                                                 
***************************************************************************
...
* input data files: "YYGU United Kingdom.dta"
* output data files: "YYGU United Kingdom error.dta" (with error measures saved)

* output data dictionary files: "YYGU United Kingdom error data dictionary.csv"
...
** graphs:
* "graph 03 United Kingdom YYGU C19 daily deaths error.pdf"
* "graph 04 United Kingdom YYGU C19 daily deaths absolute error.pdf"
* "graph 05 United Kingdom YYGU C19 daily deaths percent error.pdf"
* "graph 06 United Kingdom YYGU C19 daily deaths absolute percent error.pdf"

* "graph 07 United Kingdom YYGU C19 daily deaths average median error.pdf"
* "graph 08 United Kingdom YYGU C19 daily deaths average median absolute error.pdf"
* "graph 09 United Kingdom YYGU C19 daily deaths average median percent error.pdf"
* "graph 10 United Kingdom YYGU C19 daily deaths average median absolute percent error.pdf"

* "graph 11 United Kingdom YYGU C19 daily deaths Average MAPE over updates and calendar months
...
use "YYGU United Kingdom.dta", clear 
...
qui replace DDErrorYYGU`update' = . if date < td(03apr2020) // 03apr2020 is the earliest date of YYGU forecasts for United Kingdom
                                                            // <<-- modify 3
...
qui replace DDAbsErrYYGU`update' = . if date < td(03apr2020) // 03apr2020 is the earliest date of YYGU forecasts for United Kingdom
...
qui replace DDPerErrYYGU`update' = . if date < td(03apr2020) // 03apr2020 is the earliest date of YYGU forecasts for United Kingdom
...
qui replace DDAbPeErYYGU`update' = . if date < td(03apr2020) // 03apr2020 is the earliest date of YYGU forecasts for United Kingdom
...
qui replace DDErrorYYGU`update'_Med1 = . if date < td(03apr2020) // 03apr2020 is the earliest date of YYGU forecasts for United Kingdom
...
qui replace DDAbsErrYYGU`update'_Med1 = . if date < td(03apr2020) // 03apr2020 is the earliest date of YYGU forecasts for United Kingdom
...
qui replace DDPerErrYYGU`update'_Med1 = . if date < td(03apr2020) // 03apr2020 is the earliest date of YYGU forecasts for United Kingdom
...
qui replace DDAbPeErYYGU`update'_Med1 = . if date < td(03apr2020) // 03apr2020 is the earliest date of YYGU forecasts for United Kingdom
...
order DDErrorYYGU20201005_Med1

		
capture drop DDErrorYYGU_Mean1 // "DDErrorYYGU mean over updates of median error by calendar months"
egen DDErrorYYGU_Mean1 = rowmean(DDErrorYYGU20201005_Med1-DDErrorYYGU20200403_Med1) // <<-- modify 5
...
qui replace DDErrorYYGU_Mean1 = . if date < td(03apr2020) // 03apr2020 is the earliest date of YYGU forecasts for United Kingdom
...
order DDAbsErrYYGU20201005_Med1


capture drop DDAbsErrYYGU_Mean1 // "DDAbsErrYYGU mean over updates of median absolute error by calendar months"
egen DDAbsErrYYGU_Mean1 = rowmean(DDAbsErrYYGU20201005_Med1-DDAbsErrYYGU20200403_Med1) // <<-- modify 7
...
qui replace DDAbsErrYYGU_Mean1 = . if date < td(03apr2020) // 03apr2020 is the earliest date of YYGU forecasts for United Kingdom
...
order DDPerErrYYGU20201005_Med1


capture drop DDPerErrYYGU_Mean1 // "DDPerErrYYGU mean over updates of median absolute % error by calendar months"
egen DDPerErrYYGU_Mean1 = rowmean(DDPerErrYYGU20201005_Med1-DDPerErrYYGU20200403_Med1) // <<-- modify 9
...
qui replace DDPerErrYYGU_Mean1 = . if date < td(03apr2020) // 03apr2020 is the earliest date of YYGU forecasts for United Kingdom
...
order DDAbPeErYYGU20201005_Med1


capture drop DDAbPeErYYGU_Mean1 // "DDAbPeErYYGU mean over updates of median absolute % error by calendar months"
egen DDAbPeErYYGU_Mean1 = rowmean(DDAbPeErYYGU20201005_Med1-DDAbPeErYYGU20200403_Med1) // <<-- modify 11
...
qui replace DDAbPeErYYGU_Mean1 = . if date < td(03apr2020) // 03apr2020 is the earliest date of YYGU forecasts for United Kingdom
...
(line DDErrorYYGU20201005 date, sort lcolor(gold) lwidth(thin)) ///
...
subtitle("United Kingdom, YYGU, all updates, forecast only", size(small)) 

qui graph export "graph 03 United Kingdom YYGU C19 daily deaths error.pdf", replace
...
(line DDAbsErrYYGU20201005 date, sort lcolor(gold) lwidth(thin)) ///
if date >= td(01jan2020) & date <= td(01jan2023) ///
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
...
qui graph export "graph 04 United Kingdom YYGU C19 daily deaths absolute error.pdf", replace
...
(line DDPerErrYYGU20201005 date, sort lcolor(gold) lwidth(thin)) ///
if date >= td(01jan2020) & date <= td(01jan2023) ///
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
...
qui graph export "graph 05 United Kingdom YYGU C19 daily deaths percent error.pdf", replace
...
(line DDAbPeErYYGU20201005 date, sort lcolor(gold) lwidth(thin)) ///
if date >= td(01jan2020) & date <= td(01jan2023) ///
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
...
qui graph export "graph 06 United Kingdom YYGU C19 daily deaths absolute percent error.pdf", replace
...
subtitle("United Kingdom, YYGU, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 United Kingdom YYGU C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 United Kingdom YYGU C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 United Kingdom YYGU C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 United Kingdom YYGU C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("United Kingdom, YYGU, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 United Kingdom YYGU C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "YYGU United Kingdom error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "YYGU United Kingdom error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal United Kingdom 8 YYGU.smcl"
