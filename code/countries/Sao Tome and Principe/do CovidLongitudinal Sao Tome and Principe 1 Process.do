...
log using "log CovidLongitudinal Sao Tome and Principe 1 Process.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Sao Tome and Principe 1 Process.do"
...
**** "do CovidLongitudinal Sao Tome and Principe 1 Process.do"
...
** output data files: "`model' Sao Tome and Principe.dta"
**                   "ALL MODLES Sao Tome and Principe.dta"

** output data dictionary files: "Sao Tome and Principe ALL MODELS update dates data dictionary.csv"
**                               "`model' Sao Tome and Principe data dictionary.csv"
**                               "ALL MODLES Sao Tome and Principe data dictionary.csv"

** graphs:
** "graph 02 Sao Tome and Principe `model' C19 daily deaths all updates.pdf"
** "graph 02 Sao Tome and Principe ALL MODELS C19 daily deaths all updates.pdf"
...
foreach model of local list {
	...
	di in red "`model'" " Sao Tome and Principe absent update_date_block"
	
	qui keep if loc_grand_name == "Sao Tome and Principe"
	...
	save "Sao Tome and Principe `model' update dates.dta", replace
...
use "Sao Tome and Principe DELP update dates.dta", clear 

local list DELP IHME IMPE LANL

foreach model of local list {
	
	append using "Sao Tome and Principe `model' update dates.dta"
...
save "Sao Tome and Principe ALL MODELS update dates.dta", replace
	
export excel using "Sao Tome and Principe ALL MODELS update dates.xlsx", replace firstrow(variables) 
...
preserve
    ...
    export delimited name varlab using "Sao Tome and Principe ALL MODELS update dates data dictionary.csv", replace 
...
keep if loc_grand_name == "Sao Tome and Principe"

keep date DayDeaMeSmJOHNSTP
...
save "JOHN Sao Tome and Principe.dta", replace 




* graph Sao Tome and Principe JOHN daily deaths

twoway ///
(line DayDeaMeSmJOHNSTP date, sort lwidth(thick) lcolor(cyan)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, Sao Tome and Principe, JOHN", size(medium) color(black)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Sao Tome and Principe JOHN C19 daily deaths reported.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "DELP `update' Sao Tome and Principe.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "DELP `update' Sao Tome and Principe.dta"
...
save "DELP Sao Tome and Principe.dta", replace
...
merge m:m date using "JOHN Sao Tome and Principe.dta"
...
preserve
    ...
    export delimited name varlab using "DELP Sao Tome and Principe data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Sao Tome and Principe DELP daily deaths each update 
	...
	subtitle("Sao Tome and Principe, forecast only") legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Sao Tome and Principe DELP daily deaths update `update'.pdf", replace	
...
* graph Sao Tome and Principe DELP daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Sao Tome and Principe, DELP, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Sao Tome and Principe DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	keep if country == "Sao Tome and Principe" 
	...
	* graph Sao Tome and Principe IHME daily deaths epoch each update 
	...
	ytitle(Daily deaths) title("C19 daily deaths, Sao Tome and Principe, IHME, update `update'", size(medium) color(black)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	...
	*/
	...
	/* qui graph export "graph 00 Sao Tome and Principe IHME daily deaths epoch `update'.pdf", replace */
	...
	save "IHME `update' Sao Tome and Principe.dta", replace emptyok	
...
foreach update of local list {
	...
	merge m:m date using "IHME `update' Sao Tome and Principe.dta"
...
save "IHME Sao Tome and Principe.dta", replace
...
merge m:1 date using "JOHN Sao Tome and Principe.dta"
...
preserve
    ...
    export delimited name varlab using "IHME Sao Tome and Principe data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Sao Tome and Principe IHME daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Sao Tome and Principe, forecast only") legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Sao Tome and Principe IHME daily deaths update `update'.pdf", replace	
...
* graph Sao Tome and Principe IHME daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Sao Tome and Principe, IHME, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Sao Tome and Principe IHME C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only
	...
	save "IMPE `update' Sao Tome and Principe.dta", replace emptyok
...
foreach update of local list {
	...
	merge m:m date using "IMPE `update' Sao Tome and Principe.dta"
...
save "IMPE Sao Tome and Principe.dta", replace
...
preserve
    ...
    export delimited name varlab using "IMPE Sao Tome and Principe data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Sao Tome and Principe IMPE daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Sao Tome and Principe, forecast only") legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Sao Tome and Principe IMPE daily deaths update `update'.pdf", replace	
...
* graph Sao Tome and Principe IMPE daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Sao Tome and Principe, IMPE, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Sao Tome and Principe IMPE C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "LANL `update' Sao Tome and Principe.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "LANL `update' Sao Tome and Principe.dta"
...
save "LANL Sao Tome and Principe.dta", replace
...
preserve
    ...
    export delimited name varlab using "LANL Sao Tome and Principe data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Sao Tome and Principe LANL daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Sao Tome and Principe, forecast only") legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Sao Tome and Principe LANL daily deaths update `update'.pdf", replace	
...
* graph Sao Tome and Principe LANL daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.1fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Sao Tome and Principe, LANL, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Sao Tome and Principe LANL C19 daily deaths all updates.pdf", replace
...
use "DELP Sao Tome and Principe.dta", clear

foreach model of local list {

	merge m:m date loc_grand_name using "`model' Sao Tome and Principe.dta", force
...
save "ALL MODLES Sao Tome and Principe.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODLES Sao Tome and Principe data dictionary.csv", replace 
...
* graph Sao Tome and Principe ALL MODELS daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Sao Tome and Principe, all models, all updates, forecast only", size(medium) color(black)) ///
legend(position(6) order(568 "JOHN" 16 "DELP" 47 "IHME" 1 "IMPE" 153 "LANL") ///
rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Sao Tome and Principe ALL MODELS C19 daily deaths all updates.pdf", replace
...
view "log CovidLongitudinal Sao Tome and Principe 1 Process.smcl"
