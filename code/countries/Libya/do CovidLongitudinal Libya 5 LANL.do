...
log using "log CovidLongitudinal Libya 5 LANL.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Libya 5 LANL.do"
...
* input data files: "LANL Libya.dta"
* output data files: "LANL Libya error.dta" (with error measures saved)

* output data dictionary files: "LANL Libya error data dictionary.csv"
...
** graphs:
* "graph 03 Libya LANL C19 daily deaths error.pdf"
* "graph 04 Libya LANL C19 daily deaths absolute error.pdf"
* "graph 05 Libya LANL C19 daily deaths percent error.pdf"
* "graph 06 Libya LANL C19 daily deaths absolute percent error.pdf"

* "graph 07 Libya LANL C19 daily deaths average median error.pdf"
* "graph 08 Libya LANL C19 daily deaths average median absolute error.pdf"
* "graph 09 Libya LANL C19 daily deaths average median percent error.pdf"
* "graph 10 Libya LANL C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Libya LANL C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorLANL`update' = . if date < td(28jun2020) // 28jun2020 is the earliest date of LANL forecasts for Libya
                                                            // <<-- modify 3
...
qui replace DDAbsErrLANL`update' = . if date < td(28jun2020) // 28jun2020 is the earliest date of LANL forecasts for Libya
...
qui replace DDPerErrLANL`update' = . if date < td(28jun2020) // 28jun2020 is the earliest date of LANL forecasts for Libya
...
qui replace DDAbPeErLANL`update' = . if date < td(28jun2020) // 28jun2020 is the earliest date of LANL forecasts for Libya
...
qui replace DDErrorLANL`update'_Med1 = . if date < td(28jun2020) // 28jun2020 is the earliest date of LANL forecasts for Libya
...
qui replace DDAbsErrLANL`update'_Med1 = . if date < td(28jun2020) // 28jun2020 is the earliest date of LANL forecasts for Libya
...
qui replace DDPerErrLANL`update'_Med1 = . if date < td(28jun2020) // 28jun2020 is the earliest date of LANL forecasts for Libya
...
qui replace DDAbPeErLANL`update'_Med1 = . if date < td(28jun2020) // 28jun2020 is the earliest date of LANL forecasts for Libya
...
qui replace DDErrorLANL_Mean1 = . if date < td(28jun2020) // 28jun2020 is the earliest date of LANL forecasts for Libya
...
qui replace DDAbsErrLANL_Mean1 = . if date < td(28jun2020) // 28jun2020 is the earliest date of LANL forecasts for Libya
...
qui replace DDPerErrLANL_Mean1 = . if date < td(28jun2020) // 28jun2020 is the earliest date of LANL forecasts for Libya
...
qui replace DDAbPeErLANL_Mean1 = . if date < td(28jun2020) // 28jun2020 is the earliest date of LANL forecasts for Libya
...
subtitle("Libya, LANL, all updates, forecast only", size(small)) 

qui graph export "graph 03 Libya LANL C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Libya LANL C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Libya LANL C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Libya LANL C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Libya, LANL, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Libya LANL C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Libya LANL C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Libya LANL C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Libya LANL C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Libya, LANL, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Libya LANL C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "LANL Libya error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "LANL Libya error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Libya 5 LANL.smcl"
