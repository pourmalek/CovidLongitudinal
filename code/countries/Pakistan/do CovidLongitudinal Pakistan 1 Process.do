...
log using "log CovidLongitudinal Pakistan 1 Process.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Pakistan 1 Process.do"
...
**** "do CovidLongitudinal Pakistan 1 Process.do"
...
** output data files: "`model' Pakistan.dta"
**                   "ALL MODLES Pakistan.dta"

** output data dictionary files: "Pakistan ALL MODELS update dates data dictionary.csv"
**                               "`model' Pakistan data dictionary.csv"
**                               "ALL MODLES Pakistan data dictionary.csv"

** graphs:
** "graph 02 Pakistan `model' C19 daily deaths all updates.pdf"
** "graph 02 Pakistan ALL MODELS C19 daily deaths all updates.pdf"
...
foreach model of local list {
	...
	di in red "`model'" " Pakistan absent update_date_block"
	
	qui keep if loc_grand_name == "Pakistan"
	...
	save "Pakistan `model' update dates.dta", replace
...
use "Pakistan DELP update dates.dta", clear 

local list DELP IHME IMPE LANL UCLA YYGU

foreach model of local list {
	
	append using "Pakistan `model' update dates.dta"
...
save "Pakistan ALL MODELS update dates.dta", replace
	
export excel using "Pakistan ALL MODELS update dates.xlsx", replace firstrow(variables) 
...
preserve
    ...
    export delimited name varlab using "Pakistan ALL MODELS update dates data dictionary.csv", replace 
...
keep if loc_grand_name == "Pakistan"

keep date DayDeaMeSmJOHNPAK
...
save "JOHN Pakistan.dta", replace 




* graph Pakistan JOHN daily deaths

twoway ///
(line DayDeaMeSmJOHNPAK date, sort lwidth(thick) lcolor(cyan)) ///
...
ytitle(Daily deaths) title("C19 daily deaths, Pakistan, JOHN", size(medium) color(black)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Pakistan JOHN C19 daily deaths reported.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "DELP `update' Pakistan.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "DELP `update' Pakistan.dta"
...
save "DELP Pakistan.dta", replace
...
merge m:m date using "JOHN Pakistan.dta"
...
preserve
    ...
    export delimited name varlab using "DELP Pakistan data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Pakistan DELP daily deaths each update 
	...
	subtitle("Pakistan, forecast only") legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Pakistan DELP daily deaths update `update'.pdf", replace	
...
* graph Pakistan DELP daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Pakistan, DELP, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "DELP forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Pakistan DELP C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* graph Pakistan IHME daily deaths epoch each update 
	...
	ytitle(Daily deaths) title("C19 daily deaths, Pakistan, IHME, update `update'", size(medium) color(black)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	...
	*/
	...
	/* qui graph export "graph 00 Pakistan IHME daily deaths epoch `update'.pdf", replace */
	...
	save "IHME `update' Pakistan.dta", replace emptyok	
...
foreach update of local list {
	...
	merge m:m date using "IHME `update' Pakistan.dta"
...
save "IHME Pakistan.dta", replace
...
merge m:1 date using "JOHN Pakistan.dta"
...
preserve
    ...
    export delimited name varlab using "IHME Pakistan data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Pakistan IHME daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Pakistan, forecast only") legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Pakistan IHME daily deaths update `update'.pdf", replace	
...
* graph Pakistan IHME daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Pakistan, IHME, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IHME forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Pakistan IHME C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only
	...
	save "IMPE `update' Pakistan.dta", replace emptyok
...
foreach update of local list {
	...
	merge m:m date using "IMPE `update' Pakistan.dta"
...
save "IMPE Pakistan.dta", replace
...
preserve
    ...
    export delimited name varlab using "IMPE Pakistan data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Pakistan IMPE daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Pakistan, forecast only") legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Pakistan IMPE daily deaths update `update'.pdf", replace	
...
* graph Pakistan IMPE daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Pakistan, IMPE, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "IMPE forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Pakistan IMPE C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only 
	...
	save "LANL `update' Pakistan.dta", replace 
...
foreach update of local list {
	...
	merge m:m date using "LANL `update' Pakistan.dta"
...
save "LANL Pakistan.dta", replace
...
preserve
    ...
    export delimited name varlab using "LANL Pakistan data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Pakistan LANL daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Pakistan, forecast only") legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Pakistan LANL daily deaths update `update'.pdf", replace	
...
* graph Pakistan LANL daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Pakistan, LANL, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "LANL forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Pakistan LANL C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen Daily deaths smooth forecast only  
	...
	save "UCLA `update' Pakistan.dta", replace 
	
	/* line DayDeaMeRaUCLA`update' DayDeaMeSmUCLA`update' DayDeaMeFoUCLA`update' date

	qui graph export "UCLA `update' Pakistan.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "UCLA `update' Pakistan.dta"
...
save "UCLA Pakistan.dta", replace
...
preserve
    ...
    export delimited name varlab using "UCLA Pakistan data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Pakistan UCLA daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Pakistan, forecast only") legend(position(6) order(1 "JOHN" 2 "UCLA forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Pakistan UCLA daily deaths update `update'.pdf", replace	

}
*/


* graph Pakistan UCLA daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Pakistan, UCLA, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "UCLA forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Pakistan UCLA C19 daily deaths all updates.pdf", replace
...
foreach update of local list {
	...
	* gen FORE, that is forecast only 
	...
	save "YYGU `update' Pakistan.dta", replace 
	
	/* line DayDeaMeRaYYGU`update' DayDeaMeSmYYGU`update' DayDeaMeFoYYGU`update' date

	qui graph export "YYGU `update' Pakistan.pdf", replace */
...
foreach update of local list {
	...
	merge m:m date using "YYGU `update' Pakistan.dta"
...
save "YYGU Pakistan.dta", replace
...
preserve
    ...
    export delimited name varlab using "YYGU Pakistan data dictionary.csv", replace 
...
/* foreach update of local list {
	...
	* graph Pakistan YYGU daily deaths each update 
	...
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
	subtitle("Pakistan, forecast only") legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) ///
	xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) 
	
	qui graph export "graph 01 Pakistan YYGU daily deaths update `update'.pdf", replace	
...
* graph Pakistan YYGU daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Pakistan, YYGU, all updates", size(medium) color(black)) ///
legend(position(6) order(1 "JOHN" 2 "YYGU forecast ") rows(1) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Pakistan YYGU C19 daily deaths all updates.pdf", replace
...
use "DELP Pakistan.dta", clear

foreach model of local list {

	merge m:m date loc_grand_name using "`model' Pakistan.dta", force
...
save "ALL MODLES Pakistan.dta", replace
...
preserve
    ...
    export delimited name varlab using "ALL MODLES Pakistan data dictionary.csv", replace 
...
* graph Pakistan ALL MODELS daily deaths all updates
...
, xtitle(Date) xlabel(#12, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, labsize(small) angle(forty_five) format(%30.0fc)) ///
ytitle(Daily deaths) title("C19 daily deaths, Pakistan, all models, all updates, forecast only", size(medium) color(black)) ///
legend(position(6) order(843 "JOHN" 1 "DELP" 116 "IHME" 4 "IMPE" 3 "LANL" 358 "UCLA" 24 "YYGU") ///
rows(2) size(small)) legend(region(lcolor(none))) legend(bexpand) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2))

qui graph export "graph 02 Pakistan ALL MODELS C19 daily deaths all updates.pdf", replace
...
view "log CovidLongitudinal Pakistan 1 Process.smcl"
