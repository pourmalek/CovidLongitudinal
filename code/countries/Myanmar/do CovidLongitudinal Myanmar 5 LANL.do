...
log using "log CovidLongitudinal Myanmar 5 LANL.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Myanmar 5 LANL.do"
...
* input data files: "LANL Myanmar.dta"
* output data files: "LANL Myanmar error.dta" (with error measures saved)

* output data dictionary files: "LANL Myanmar error data dictionary.csv"
...
** graphs:
* "graph 03 Myanmar LANL C19 daily deaths error.pdf"
* "graph 04 Myanmar LANL C19 daily deaths absolute error.pdf"
* "graph 05 Myanmar LANL C19 daily deaths percent error.pdf"
* "graph 06 Myanmar LANL C19 daily deaths absolute percent error.pdf"

* "graph 07 Myanmar LANL C19 daily deaths average median error.pdf"
* "graph 08 Myanmar LANL C19 daily deaths average median absolute error.pdf"
* "graph 09 Myanmar LANL C19 daily deaths average median percent error.pdf"
* "graph 10 Myanmar LANL C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Myanmar LANL C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorLANL`update' = . if date < td(13sep2020) // 13sep2020 is the earliest date of LANL forecasts for Myanmar
                                                            // <<-- modify 3
...
qui replace DDAbsErrLANL`update' = . if date < td(13sep2020) // 13sep2020 is the earliest date of LANL forecasts for Myanmar
...
qui replace DDPerErrLANL`update' = . if date < td(13sep2020) // 13sep2020 is the earliest date of LANL forecasts for Myanmar
...
qui replace DDAbPeErLANL`update' = . if date < td(13sep2020) // 13sep2020 is the earliest date of LANL forecasts for Myanmar
...
qui replace DDErrorLANL`update'_Med1 = . if date < td(13sep2020) // 13sep2020 is the earliest date of LANL forecasts for Myanmar
...
qui replace DDAbsErrLANL`update'_Med1 = . if date < td(13sep2020) // 13sep2020 is the earliest date of LANL forecasts for Myanmar
...
qui replace DDPerErrLANL`update'_Med1 = . if date < td(13sep2020) // 13sep2020 is the earliest date of LANL forecasts for Myanmar
...
qui replace DDAbPeErLANL`update'_Med1 = . if date < td(13sep2020) // 13sep2020 is the earliest date of LANL forecasts for Myanmar
...
egen DDErrorLANL_Mean1 = rowmean(DDErrorLANL20210926_Med1-DDErrorLANL20200913_Med1) // <<-- modify 5
...
qui replace DDErrorLANL_Mean1 = . if date < td(13sep2020) // 13sep2020 is the earliest date of LANL forecasts for Myanmar
...
egen DDAbsErrLANL_Mean1 = rowmean(DDAbsErrLANL20210926_Med1-DDAbsErrLANL20200913_Med1) // <<-- modify 7
...
qui replace DDAbsErrLANL_Mean1 = . if date < td(13sep2020) // 13sep2020 is the earliest date of LANL forecasts for Myanmar
...
egen DDPerErrLANL_Mean1 = rowmean(DDPerErrLANL20210926_Med1-DDPerErrLANL20200913_Med1) // <<-- modify 9
...
qui replace DDPerErrLANL_Mean1 = . if date < td(13sep2020) // 13sep2020 is the earliest date of LANL forecasts for Myanmar
...
egen DDAbPeErLANL_Mean1 = rowmean(DDAbPeErLANL20210926_Med1-DDAbPeErLANL20200913_Med1) // <<-- modify 11
...
qui replace DDAbPeErLANL_Mean1 = . if date < td(13sep2020) // 13sep2020 is the earliest date of LANL forecasts for Myanmar
...
subtitle("Myanmar, LANL, all updates, forecast only", size(small)) 

qui graph export "graph 03 Myanmar LANL C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Myanmar LANL C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Myanmar LANL C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Myanmar LANL C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Myanmar, LANL, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Myanmar LANL C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Myanmar LANL C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Myanmar LANL C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Myanmar LANL C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Myanmar, LANL, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Myanmar LANL C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "LANL Myanmar error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "LANL Myanmar error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Myanmar 5 LANL.smcl"
