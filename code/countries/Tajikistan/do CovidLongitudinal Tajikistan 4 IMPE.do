...
log using "log CovidLongitudinal Tajikistan 4 IMPE.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Tajikistan 4 IMPE.do"
...
* input data files: "IMPE Tajikistan.dta"
* output data files: "IMPE Tajikistan error.dta" (with error measures saved)

* output data dictionary files: "IMPE Tajikistan error data dictionary.csv"
...
** graphs:
* "graph 03 Tajikistan IMPE C19 daily deaths error.pdf"
* "graph 04 Tajikistan IMPE C19 daily deaths absolute error.pdf"
* "graph 05 Tajikistan IMPE C19 daily deaths percent error.pdf"
* "graph 06 Tajikistan IMPE C19 daily deaths absolute percent error.pdf"

* "graph 07 Tajikistan IMPE C19 daily deaths average median error.pdf"
* "graph 08 Tajikistan IMPE C19 daily deaths average median absolute error.pdf"
* "graph 09 Tajikistan IMPE C19 daily deaths average median percent error.pdf"
* "graph 10 Tajikistan IMPE C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Tajikistan IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
qui replace DDErrorIMPE`update' = . if date < td(04may2020) // 04may2020 is the earliest date of IMPE forecasts for Tajikistan
                                                            // <<-- modify 3
...
qui replace DDAbsErrIMPE`update' = . if date < td(04may2020) // 04may2020 is the earliest date of IMPE forecasts for Tajikistan
...
qui replace DDPerErrIMPE`update' = . if date < td(04may2020) // 04may2020 is the earliest date of IMPE forecasts for Tajikistan
...
qui replace DDAbPeErIMPE`update' = . if date < td(04may2020) // 04may2020 is the earliest date of IMPE forecasts for Tajikistan
...
qui replace DDErrorIMPE`update'_Med1 = . if date < td(04may2020) // 04may2020 is the earliest date of IMPE forecasts for Tajikistan
...
qui replace DDAbsErrIMPE`update'_Med1 = . if date < td(04may2020) // 04may2020 is the earliest date of IMPE forecasts for Tajikistan
...
qui replace DDPerErrIMPE`update'_Med1 = . if date < td(04may2020) // 04may2020 is the earliest date of IMPE forecasts for Tajikistan
...
qui replace DDAbPeErIMPE`update'_Med1 = . if date < td(04may2020) // 04may2020 is the earliest date of IMPE forecasts for Tajikistan
...
egen DDErrorIMPE_Mean1 = rowmean(DDErrorIMPE20221225_Med1-DDErrorIMPE20200504_Med1) // <<-- modify 5
...
qui replace DDErrorIMPE_Mean1 = . if date < td(04may2020) // 04may2020 is the earliest date of IMPE forecasts for Tajikistan
...
egen DDAbsErrIMPE_Mean1 = rowmean(DDAbsErrIMPE20221225_Med1-DDAbsErrIMPE20200504_Med1) // <<-- modify 7
...
qui replace DDAbsErrIMPE_Mean1 = . if date < td(04may2020) // 04may2020 is the earliest date of IMPE forecasts for Tajikistan
...
egen DDPerErrIMPE_Mean1 = rowmean(DDPerErrIMPE20221225_Med1-DDPerErrIMPE20200504_Med1) // <<-- modify 9
...
qui replace DDPerErrIMPE_Mean1 = . if date < td(04may2020) // 04may2020 is the earliest date of IMPE forecasts for Tajikistan
...
egen DDAbPeErIMPE_Mean1 = rowmean(DDAbPeErIMPE20221225_Med1-DDAbPeErIMPE20200504_Med1) // <<-- modify 11
...
qui replace DDAbPeErIMPE_Mean1 = . if date < td(04may2020) // 04may2020 is the earliest date of IMPE forecasts for Tajikistan
...
subtitle("Tajikistan, IMPE, all updates, forecast only", size(small)) 

qui graph export "graph 03 Tajikistan IMPE C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Tajikistan IMPE C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Tajikistan IMPE C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Tajikistan IMPE C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Tajikistan, IMPE, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Tajikistan IMPE C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Tajikistan IMPE C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Tajikistan IMPE C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Tajikistan IMPE C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Tajikistan, IMPE, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Tajikistan IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IMPE Tajikistan error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IMPE Tajikistan error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Tajikistan 4 IMPE.smcl"
