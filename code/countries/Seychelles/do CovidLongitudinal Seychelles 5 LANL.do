...
log using "log CovidLongitudinal Seychelles 5 LANL.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Seychelles 5 LANL.do"
...
* input data files: "LANL Seychelles.dta"
* output data files: "LANL Seychelles error.dta" (with error measures saved)

* output data dictionary files: "LANL Seychelles error data dictionary.csv"
...
** graphs:
* "graph 03 Seychelles LANL C19 daily deaths error.pdf"
* "graph 04 Seychelles LANL C19 daily deaths absolute error.pdf"
* "graph 05 Seychelles LANL C19 daily deaths percent error.pdf"
* "graph 06 Seychelles LANL C19 daily deaths absolute percent error.pdf"

* "graph 07 Seychelles LANL C19 daily deaths average median error.pdf"
* "graph 08 Seychelles LANL C19 daily deaths average median absolute error.pdf"
* "graph 09 Seychelles LANL C19 daily deaths average median percent error.pdf"
* "graph 10 Seychelles LANL C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Seychelles LANL C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorLANL`update' = . if date < td(28mar2021) // 28mar2021 is the earliest date of LANL forecasts for Seychelles
                                                            // <<-- modify 3
...
qui replace DDAbsErrLANL`update' = . if date < td(28mar2021) // 28mar2021 is the earliest date of LANL forecasts for Seychelles
...
qui replace DDPerErrLANL`update' = . if date < td(28mar2021) // 28mar2021 is the earliest date of LANL forecasts for Seychelles
...
qui replace DDAbPeErLANL`update' = . if date < td(28mar2021) // 28mar2021 is the earliest date of LANL forecasts for Seychelles
...
qui replace DDErrorLANL`update'_Med1 = . if date < td(28mar2021) // 28mar2021 is the earliest date of LANL forecasts for Seychelles
...
qui replace DDAbsErrLANL`update'_Med1 = . if date < td(28mar2021) // 28mar2021 is the earliest date of LANL forecasts for Seychelles
...
qui replace DDPerErrLANL`update'_Med1 = . if date < td(28mar2021) // 28mar2021 is the earliest date of LANL forecasts for Seychelles
...
qui replace DDAbPeErLANL`update'_Med1 = . if date < td(28mar2021) // 28mar2021 is the earliest date of LANL forecasts for Seychelles
...
egen DDErrorLANL_Mean1 = rowmean(DDErrorLANL20210926_Med1-DDErrorLANL20210328_Med1) // <<-- modify 5
...
qui replace DDErrorLANL_Mean1 = . if date < td(28mar2021) // 28mar2021 is the earliest date of LANL forecasts for Seychelles
...
egen DDAbsErrLANL_Mean1 = rowmean(DDAbsErrLANL20210926_Med1-DDAbsErrLANL20210328_Med1) // <<-- modify 7
...
qui replace DDAbsErrLANL_Mean1 = . if date < td(28mar2021) // 28mar2021 is the earliest date of LANL forecasts for Seychelles
...
egen DDPerErrLANL_Mean1 = rowmean(DDPerErrLANL20210926_Med1-DDPerErrLANL20210328_Med1) // <<-- modify 9
...
qui replace DDPerErrLANL_Mean1 = . if date < td(28mar2021) // 28mar2021 is the earliest date of LANL forecasts for Seychelles
...
egen DDAbPeErLANL_Mean1 = rowmean(DDAbPeErLANL20210926_Med1-DDAbPeErLANL20210328_Med1) // <<-- modify 11
...
qui replace DDAbPeErLANL_Mean1 = . if date < td(28mar2021) // 28mar2021 is the earliest date of LANL forecasts for Seychelles
...
subtitle("Seychelles, LANL, all updates, forecast only", size(small)) 

qui graph export "graph 03 Seychelles LANL C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Seychelles LANL C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Seychelles LANL C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Seychelles LANL C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Seychelles, LANL, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Seychelles LANL C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Seychelles LANL C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Seychelles LANL C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Seychelles LANL C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Seychelles, LANL, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Seychelles LANL C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "LANL Seychelles error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "LANL Seychelles error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Seychelles 5 LANL.smcl"
