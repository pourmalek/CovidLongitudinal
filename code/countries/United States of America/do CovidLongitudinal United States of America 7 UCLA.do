...
log using "log CovidLongitudinal United States of America 7 UCLA.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal United States of America 7 UCLA.do"
...
* input data files: "UCLA United States of America.dta"
* output data files: "UCLA United States of America error.dta" (with error measures saved)

* output data dictionary files: "UCLA United States of America error data dictionary.csv"
...
** graphs:
* "graph 03 United States of America UCLA C19 daily deaths error.pdf"
* "graph 04 United States of America UCLA C19 daily deaths absolute error.pdf"
* "graph 05 United States of America UCLA C19 daily deaths percent error.pdf"
* "graph 06 United States of America UCLA C19 daily deaths absolute percent error.pdf"

* "graph 07 United States of America UCLA C19 daily deaths average median error.pdf"
* "graph 08 United States of America UCLA C19 daily deaths average median absolute error.pdf"
* "graph 09 United States of America UCLA C19 daily deaths average median percent error.pdf"
* "graph 10 United States of America UCLA C19 daily deaths average median absolute percent error.pdf"

* "graph 11 United States of America UCLA C19 daily deaths Average MAPE over updates and calendar months
...
use "UCLA United States of America.dta", clear 
...
qui replace DDErrorUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for United States of America
                                                            // <<-- modify 3
...
qui replace DDAbsErrUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for United States of America

capture drop DDPerErrUCLA`update'
gen DDPerErrUCLA`update' = (100 * (- (DayDeaMeSmJOHN - DayDeaMeFoUCLA`update'))) / DayDeaMeSmJOHN
replace DDPerErrUCLA`update' = 0 if DDErrorUCLA`update' == 0
...
qui replace DDPerErrUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for United States of America

capture drop DDAbPeErUCLA`update'
gen DDAbPeErUCLA`update' = (100 * abs(- (DayDeaMeSmJOHN - DayDeaMeFoUCLA`update'))) / DayDeaMeSmJOHN
replace DDAbPeErUCLA`update' = 0 if DDAbsErrUCLA`update' == 0
...
qui replace DDAbPeErUCLA`update' = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for United States of America
...
qui replace DDErrorUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for United States of America
...
qui replace DDAbsErrUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for United States of America
...
qui replace DDPerErrUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for United States of America
...
qui replace DDAbPeErUCLA`update'_Med1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for United States of America
...
order DDErrorUCLA20210228_Med1
order DDErrorUCLA20210307_Med1
order DDErrorUCLA20210315_Med1
order DDErrorUCLA20210328_Med1
order DDErrorUCLA20210404_Med1
order DDErrorUCLA20210606_Med1
order DDErrorUCLA20210614_Med1
order DDErrorUCLA20210621_Med1
order DDErrorUCLA20210627_Med1
order DDErrorUCLA20210630_Med1
order DDErrorUCLA20210706_Med1
...
order DDErrorUCLA20211115_Med1
...
qui replace DDErrorUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for United States of America
...
order DDAbsErrUCLA20210228_Med1
...
order DDAbsErrUCLA20210606_Med1
order DDAbsErrUCLA20210614_Med1
order DDAbsErrUCLA20210621_Med1
order DDAbsErrUCLA20210627_Med1
order DDAbsErrUCLA20210630_Med1
order DDAbsErrUCLA20210706_Med1
...
order DDAbsErrUCLA20211115_Med1
...
qui replace DDAbsErrUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for United States of America
...
order DDPerErrUCLA20210228_Med1
...
order DDPerErrUCLA20210606_Med1
order DDPerErrUCLA20210614_Med1
order DDPerErrUCLA20210621_Med1
order DDPerErrUCLA20210627_Med1
order DDPerErrUCLA20210630_Med1
order DDPerErrUCLA20210706_Med1
...
order DDPerErrUCLA20211115_Med1
...
qui replace DDPerErrUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for United States of America
...
order DDAbPeErUCLA20210228_Med1
...
order DDAbPeErUCLA20210606_Med1
order DDAbPeErUCLA20210614_Med1
order DDAbPeErUCLA20210621_Med1
order DDAbPeErUCLA20210627_Med1
order DDAbPeErUCLA20210630_Med1
order DDAbPeErUCLA20210706_Med1
...
order DDAbPeErUCLA20211115_Med1
...
qui replace DDAbPeErUCLA_Mean1 = . if date < td(03jan2021) // 03jan2021 is the earliest date of UCLA forecasts for United States of America
...
(line DDErrorUCLA20210228 date, sort lcolor(blue) lwidth(thin)) ///
...
(line DDErrorUCLA20210606 date, sort lcolor(blue) lwidth(thin)) ///
(line DDErrorUCLA20210614 date, sort lcolor(blue) lwidth(thin)) ///
(line DDErrorUCLA20210621 date, sort lcolor(blue) lwidth(thin)) ///
(line DDErrorUCLA20210627 date, sort lcolor(blue) lwidth(thin)) ///
(line DDErrorUCLA20210630 date, sort lcolor(blue) lwidth(thin)) ///
(line DDErrorUCLA20210706 date, sort lcolor(blue) lwidth(thin)) ///
...
(line DDErrorUCLA20211115 date, sort lcolor(blue) lwidth(thin)) ///
...
subtitle("United States of America, UCLA, all updates, forecast only", size(small)) 

qui graph export "graph 03 United States of America UCLA C19 daily deaths error.pdf", replace
...
(line DDAbsErrUCLA20210228 date, sort lcolor(blue) lwidth(thin)) ///
...
(line DDAbsErrUCLA20210606 date, sort lcolor(blue) lwidth(thin)) ///
(line DDAbsErrUCLA20210614 date, sort lcolor(blue) lwidth(thin)) ///
(line DDAbsErrUCLA20210621 date, sort lcolor(blue) lwidth(thin)) ///
(line DDAbsErrUCLA20210627 date, sort lcolor(blue) lwidth(thin)) ///
(line DDAbsErrUCLA20210630 date, sort lcolor(blue) lwidth(thin)) ///
(line DDAbsErrUCLA20210706 date, sort lcolor(blue) lwidth(thin)) ///
...
(line DDAbsErrUCLA20211115 date, sort lcolor(blue) lwidth(thin)) ///
...
qui graph export "graph 04 United States of America UCLA C19 daily deaths absolute error.pdf", replace
...
(line DDPerErrUCLA20210228 date, sort lcolor(blue) lwidth(thin)) ///
...
(line DDPerErrUCLA20210606 date, sort lcolor(blue) lwidth(thin)) ///
(line DDPerErrUCLA20210614 date, sort lcolor(blue) lwidth(thin)) ///
(line DDPerErrUCLA20210621 date, sort lcolor(blue) lwidth(thin)) ///
(line DDPerErrUCLA20210627 date, sort lcolor(blue) lwidth(thin)) ///
(line DDPerErrUCLA20210630 date, sort lcolor(blue) lwidth(thin)) ///
(line DDPerErrUCLA20210706 date, sort lcolor(blue) lwidth(thin)) ///
...
(line DDPerErrUCLA20211115 date, sort lcolor(blue) lwidth(thin)) ///
...
qui graph export "graph 05 United States of America UCLA C19 daily deaths percent error.pdf", replace
...
(line DDAbPeErUCLA20210228 date, sort lcolor(blue) lwidth(thin)) ///
...
(line DDAbPeErUCLA20210606 date, sort lcolor(blue) lwidth(thin)) ///
(line DDAbPeErUCLA20210614 date, sort lcolor(blue) lwidth(thin)) ///
(line DDAbPeErUCLA20210621 date, sort lcolor(blue) lwidth(thin)) ///
(line DDAbPeErUCLA20210627 date, sort lcolor(blue) lwidth(thin)) ///
(line DDAbPeErUCLA20210630 date, sort lcolor(blue) lwidth(thin)) ///
(line DDAbPeErUCLA20210706 date, sort lcolor(blue) lwidth(thin)) ///
...
(line DDAbPeErUCLA20211115 date, sort lcolor(blue) lwidth(thin)) ///
...
qui graph export "graph 06 United States of America UCLA C19 daily deaths absolute percent error.pdf", replace
...
subtitle("United States of America, UCLA, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 United States of America UCLA C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 United States of America UCLA C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 United States of America UCLA C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 United States of America UCLA C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("United States of America, UCLA, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 United States of America UCLA C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "UCLA United States of America error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "UCLA United States of America error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal United States of America 7 UCLA.smcl"
