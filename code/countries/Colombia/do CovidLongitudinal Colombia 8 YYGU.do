...
log using "log CovidLongitudinal Colombia 8 YYGU.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Colombia 8 YYGU.do"
...
* input data files: "YYGU Colombia.dta"
* output data files: "YYGU Colombia error.dta" (with error measures saved)

* output data dictionary files: "YYGU Colombia error data dictionary.csv"
...
** graphs:
* "graph 03 Colombia YYGU C19 daily deaths error.pdf"
* "graph 04 Colombia YYGU C19 daily deaths absolute error.pdf"
* "graph 05 Colombia YYGU C19 daily deaths percent error.pdf"
* "graph 06 Colombia YYGU C19 daily deaths absolute percent error.pdf"

* "graph 07 Colombia YYGU C19 daily deaths average median error.pdf"
* "graph 08 Colombia YYGU C19 daily deaths average median absolute error.pdf"
* "graph 09 Colombia YYGU C19 daily deaths average median percent error.pdf"
* "graph 10 Colombia YYGU C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Colombia YYGU C19 daily deaths Average MAPE over updates and calendar months
...
qui replace DDErrorYYGU`update' = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Colombia
                                                            // <<-- modify 3
...
qui replace DDAbsErrYYGU`update' = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Colombia
...
qui replace DDPerErrYYGU`update' = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Colombia
...
qui replace DDAbPeErYYGU`update' = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Colombia
...
qui replace DDErrorYYGU`update'_Med1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Colombia
...
qui replace DDAbsErrYYGU`update'_Med1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Colombia
...
qui replace DDPerErrYYGU`update'_Med1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Colombia
...
qui replace DDAbPeErYYGU`update'_Med1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Colombia
...
qui replace DDErrorYYGU_Mean1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Colombia
...
qui replace DDAbsErrYYGU_Mean1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Colombia
...
qui replace DDPerErrYYGU_Mean1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Colombia
...
qui replace DDAbPeErYYGU_Mean1 = . if date < td(12may2020) // 12may2020 is the earliest date of YYGU forecasts for Colombia
...
subtitle("Colombia, YYGU, all updates, forecast only", size(small)) 

qui graph export "graph 03 Colombia YYGU C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Colombia YYGU C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Colombia YYGU C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Colombia YYGU C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Colombia, YYGU, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Colombia YYGU C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Colombia YYGU C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Colombia YYGU C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Colombia YYGU C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Colombia, YYGU, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Colombia YYGU C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "YYGU Colombia error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "YYGU Colombia error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Colombia 8 YYGU.smcl"
