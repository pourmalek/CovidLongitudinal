...
log using "log CovidLongitudinal Estonia 3 IHME.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Estonia 3 IHME.do"
...
* input data files: "IHME Estonia.dta"
* output data files: "IHME Estonia error.dta" (with error measures saved)

* output data dictionary files: "IHME Estonia error data dictionary.csv"
...
** graphs:
* "graph 03 Estonia IHME C19 daily deaths error.pdf"
* "graph 04 Estonia IHME C19 daily deaths absolute error.pdf"
* "graph 05 Estonia IHME C19 daily deaths percent error.pdf"
* "graph 06 Estonia IHME C19 daily deaths absolute percent error.pdf"

* "graph 07 Estonia IHME C19 daily deaths average median error.pdf"
* "graph 08 Estonia IHME C19 daily deaths average median absolute error.pdf"
* "graph 09 Estonia IHME C19 daily deaths average median percent error.pdf"
* "graph 10 Estonia IHME C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Estonia IHME C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
qui replace DDErrorIHME`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for Estonia
                                                            // <<-- modify 3
...
qui replace DDAbsErrIHME`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for Estonia
...
qui replace DDPerErrIHME`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for Estonia

capture drop DDAbPeErIHME`update'
gen DDAbPeErIHME`update' = (100 * abs(- (DayDeaMeSmJOHN - DayDeaMeFoIHME`update'))) / DayDeaMeSmJOHN
replace DDAbPeErIHME`update' = 0 if DDAbsErrIHME`update' == 0 // , and zero if Absolute error is zero
...
qui replace DDAbPeErIHME`update' = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for Estonia
...
qui replace DDErrorIHME`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for Estonia
...
qui replace DDAbsErrIHME`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for Estonia
...
qui replace DDPerErrIHME`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for Estonia
...
qui replace DDAbPeErIHME`update'_Med1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for Estonia
...
qui replace DDErrorIHME_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for Estonia
...
qui replace DDAbsErrIHME_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for Estonia
...
qui replace DDPerErrIHME_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for Estonia
...
qui replace DDAbPeErIHME_Mean1 = . if date < td(07apr2020) // 07apr2020 is the earliest date of IHME forecasts for Estonia
...
subtitle("Estonia, IHME, all updates, forecast only", size(small)) 

qui graph export "graph 03 Estonia IHME C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Estonia IHME C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Estonia IHME C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Estonia IHME C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Estonia, IHME, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Estonia IHME C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Estonia IHME C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Estonia IHME C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Estonia IHME C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Estonia, IHME, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Estonia IHME C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IHME Estonia error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IHME Estonia error data dictionary.csv", replace 
...
view "log CovidLongitudinal Estonia 3 IHME.smcl"
