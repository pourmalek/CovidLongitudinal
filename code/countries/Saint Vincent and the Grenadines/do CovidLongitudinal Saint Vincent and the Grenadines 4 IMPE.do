...
log using "log CovidLongitudinal Saint Vincent and the Grenadines 4 IMPE.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Saint Vincent and the Grenadines 4 IMPE.do"
...
* input data files: "IMPE Saint Vincent and the Grenadines.dta"
* output data files: "IMPE Saint Vincent and the Grenadines error.dta" (with error measures saved)

* output data dictionary files: "IMPE Saint Vincent and the Grenadines error data dictionary.csv"
...
** graphs:
* "graph 03 Saint Vincent and the Grenadines IMPE C19 daily deaths error.pdf"
* "graph 04 Saint Vincent and the Grenadines IMPE C19 daily deaths absolute error.pdf"
* "graph 05 Saint Vincent and the Grenadines IMPE C19 daily deaths percent error.pdf"
* "graph 06 Saint Vincent and the Grenadines IMPE C19 daily deaths absolute percent error.pdf"

* "graph 07 Saint Vincent and the Grenadines IMPE C19 daily deaths average median error.pdf"
* "graph 08 Saint Vincent and the Grenadines IMPE C19 daily deaths average median absolute error.pdf"
* "graph 09 Saint Vincent and the Grenadines IMPE C19 daily deaths average median percent error.pdf"
* "graph 10 Saint Vincent and the Grenadines IMPE C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Saint Vincent and the Grenadines IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
use "IMPE Saint Vincent and the Grenadines.dta", clear 
...
qui replace DDErrorIMPE`update' = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Saint Vincent and the Grenadines
                                                            // <<-- modify 3
...
qui replace DDAbsErrIMPE`update' = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Saint Vincent and the Grenadines
...
qui replace DDPerErrIMPE`update' = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Saint Vincent and the Grenadines
...
qui replace DDAbPeErIMPE`update' = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Saint Vincent and the Grenadines
...
qui replace DDErrorIMPE`update'_Med1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Saint Vincent and the Grenadines
...
qui replace DDAbsErrIMPE`update'_Med1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Saint Vincent and the Grenadines
...
qui replace DDPerErrIMPE`update'_Med1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Saint Vincent and the Grenadines
...
qui replace DDAbPeErIMPE`update'_Med1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Saint Vincent and the Grenadines
...
qui replace DDErrorIMPE_Mean1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Saint Vincent and the Grenadines
...
qui replace DDAbsErrIMPE_Mean1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Saint Vincent and the Grenadines
...
qui replace DDPerErrIMPE_Mean1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Saint Vincent and the Grenadines
...
qui replace DDAbPeErIMPE_Mean1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Saint Vincent and the Grenadines
...
qui graph export "graph 03 Saint Vincent and the Grenadines IMPE C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Saint Vincent and the Grenadines IMPE C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Saint Vincent and the Grenadines IMPE C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Saint Vincent and the Grenadines IMPE C19 daily deaths absolute percent error.pdf", replace
...
qui graph export "graph 07 Saint Vincent and the Grenadines IMPE C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Saint Vincent and the Grenadines IMPE C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Saint Vincent and the Grenadines IMPE C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Saint Vincent and the Grenadines IMPE C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Saint Vincent and the Grenadines, IMPE, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Saint Vincent and the Grenadines IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IMPE Saint Vincent and the Grenadines error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IMPE Saint Vincent and the Grenadines error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Saint Vincent and the Grenadines 4 IMPE.smcl"
