...
cd "$pathCovidLongitudinal/countries/Brazil"

capture log close 

log using "log CovidLongitudinal Brazil 4 IMPE.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Brazil 4 IMPE.do"

* Project: Longitudinal assessment of COVID-19 models 

* Objective: Run calculations for error measures
	* for each country ---->> Brazil <<----                                                                 
***************************************************************************
...
* input data files: "IMPE Brazil.dta"
* output data files: "IMPE Brazil error.dta" (with error measures saved)

* output data dictionary files: "IMPE Brazil error data dictionary.csv"
...
** graphs:
* "graph 03 Brazil IMPE C19 daily deaths error.pdf"
* "graph 04 Brazil IMPE C19 daily deaths absolute error.pdf"
* "graph 05 Brazil IMPE C19 daily deaths percent error.pdf"
* "graph 06 Brazil IMPE C19 daily deaths absolute percent error.pdf"

* "graph 07 Brazil IMPE C19 daily deaths average median error.pdf"
* "graph 08 Brazil IMPE C19 daily deaths average median absolute error.pdf"
* "graph 09 Brazil IMPE C19 daily deaths average median percent error.pdf"
* "graph 10 Brazil IMPE C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Brazil IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
qui replace DDErrorIMPE`update' = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Brazil
                                                            // <<-- modify 3
...
qui replace DDAbsErrIMPE`update' = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Brazil
...
qui replace DDPerErrIMPE`update' = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Brazil
...
qui replace DDAbPeErIMPE`update' = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Brazil
...
qui replace DDErrorIMPE`update'_Med1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Brazil
...
qui replace DDAbsErrIMPE`update'_Med1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Brazil
...
qui replace DDPerErrIMPE`update'_Med1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Brazil
...
qui replace DDAbPeErIMPE`update'_Med1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Brazil
...
qui replace DDErrorIMPE_Mean1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Brazil
...
qui replace DDAbsErrIMPE_Mean1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Brazil
...
qui replace DDPerErrIMPE_Mean1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Brazil
...
qui replace DDAbPeErIMPE_Mean1 = . if date < td(28apr2020) // 28apr2020 is the earliest date of IMPE forecasts for Brazil
...
subtitle("Brazil, IMPE, all updates, forecast only", size(small)) 

qui graph export "graph 03 Brazil IMPE C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Brazil IMPE C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Brazil IMPE C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Brazil IMPE C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Brazil, IMPE, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Brazil IMPE C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Brazil IMPE C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Brazil IMPE C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Brazil IMPE C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Brazil, IMPE, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Brazil IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IMPE Brazil error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IMPE Brazil error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Brazil 4 IMPE.smcl"
