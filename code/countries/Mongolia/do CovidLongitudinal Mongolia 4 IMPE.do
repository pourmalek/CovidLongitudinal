...
log using "log CovidLongitudinal Mongolia 4 IMPE.smcl", replace

***************************************************************************
* This is "do CovidLongitudinal Mongolia 4 IMPE.do"
...
* input data files: "IMPE Mongolia.dta"
* output data files: "IMPE Mongolia error.dta" (with error measures saved)

* output data dictionary files: "IMPE Mongolia error data dictionary.csv"
...
** graphs:
* "graph 03 Mongolia IMPE C19 daily deaths error.pdf"
* "graph 04 Mongolia IMPE C19 daily deaths absolute error.pdf"
* "graph 05 Mongolia IMPE C19 daily deaths percent error.pdf"
* "graph 06 Mongolia IMPE C19 daily deaths absolute percent error.pdf"

* "graph 07 Mongolia IMPE C19 daily deaths average median error.pdf"
* "graph 08 Mongolia IMPE C19 daily deaths average median absolute error.pdf"
* "graph 09 Mongolia IMPE C19 daily deaths average median percent error.pdf"
* "graph 10 Mongolia IMPE C19 daily deaths average median absolute percent error.pdf"

* "graph 11 Mongolia IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf"
...
qui replace DDErrorIMPE`update' = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Mongolia
                                                            // <<-- modify 3
...
qui replace DDAbsErrIMPE`update' = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Mongolia
...
qui replace DDPerErrIMPE`update' = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Mongolia
...
qui replace DDAbPeErIMPE`update' = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Mongolia
...
qui replace DDErrorIMPE`update'_Med1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Mongolia
...
qui replace DDAbsErrIMPE`update'_Med1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Mongolia
...
qui replace DDPerErrIMPE`update'_Med1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Mongolia
...
qui replace DDAbPeErIMPE`update'_Med1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Mongolia
...
qui replace DDErrorIMPE_Mean1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Mongolia
...
qui replace DDAbsErrIMPE_Mean1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Mongolia
...
qui replace DDPerErrIMPE_Mean1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Mongolia
...
qui replace DDAbPeErIMPE_Mean1 = . if date < td(25oct2020) // 25oct2020 is the earliest date of IMPE forecasts for Mongolia
...
subtitle("Mongolia, IMPE, all updates, forecast only", size(small)) 

qui graph export "graph 03 Mongolia IMPE C19 daily deaths error.pdf", replace
...
qui graph export "graph 04 Mongolia IMPE C19 daily deaths absolute error.pdf", replace
...
qui graph export "graph 05 Mongolia IMPE C19 daily deaths percent error.pdf", replace
...
qui graph export "graph 06 Mongolia IMPE C19 daily deaths absolute percent error.pdf", replace
...
subtitle("Mongolia, IMPE, forecast only", size(small)) xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off) yscale(titlegap(3))

qui graph export "graph 07 Mongolia IMPE C19 daily deaths average median error.pdf", replace
...
qui graph export "graph 08 Mongolia IMPE C19 daily deaths average median absolute error.pdf", replace
...
qui graph export "graph 09 Mongolia IMPE C19 daily deaths average median percent error.pdf", replace
...
qui graph export "graph 10 Mongolia IMPE C19 daily deaths average median absolute percent error.pdf", replace
...
subtitle("Mongolia, IMPE, forecast only. MAPE: Median Absolute Percent Error", size(small)) /// 
legend(off) ylabel(, labsize(small) angle(forty_five) format(%30.0fc))

qui graph export "graph 11 Mongolia IMPE C19 daily deaths Average MAPE over updates and calendar months.pdf", replace
...
save "IMPE Mongolia error.dta", replace 
...
preserve
    ...
    export delimited name varlab using "IMPE Mongolia error data dictionary.csv", replace 
	
restore



view "log CovidLongitudinal Mongolia 4 IMPE.smcl"
